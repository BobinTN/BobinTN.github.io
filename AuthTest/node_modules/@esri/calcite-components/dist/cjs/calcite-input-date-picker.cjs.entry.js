...
const utils = require('./utils-baea4844.js');
const dom = require('./dom-6172ed4c.js');
const floatingUi = require('./floating-ui-38753771.js');
...
const locale = require('./locale-786ce6b3.js');
...
require('./debounce-94fa0a04.js');
require('./browser-bc2f2efb.js');
require('./observers-c825c70d.js');
...
const InputDatePicker = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onBlur: this.deactivate, onKeyDown: this.keyDownHandler }, this.localeData && (index.h("div", { class: "input-container" }, index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick,
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setDatePickerRef }))), this.range && this.layout === "horizontal" && (index.h("div", { class: "horizontal-arrow-container" }, index.h("calcite-icon", { flipRtl: true, icon: "arrow-right", scale: component.getIconScale(this.scale) }))), this.range && this.layout === "vertical" && this.scale !== "s" && (index.h("div", { class: "vertical-arrow-container" }, index.h("calcite-icon", { icon: "arrow-down", scale: component.getIconScale(this.scale) }))), this.range && (index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
