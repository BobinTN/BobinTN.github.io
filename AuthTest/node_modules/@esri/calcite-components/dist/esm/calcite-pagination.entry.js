 ...
 * v1.10.0
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, a as getElement } from './index-89cd0584.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-1917c524.js';
import { n as numberStringFormatter, c as connectLocalized, d as disconnectLocalized } from './locale-07424fa5.js';
...
import { g as getBreakpoints } from './responsive-0a8f63c5.js';
import { g as getIconScale } from './component-d6d13dbf.js';
import './dom-9ac56900.js';
...
const Pagination = class {
  ...
  render() {
    ...
    return (h(Fragment, null, h("button", { "aria-label": messages.previous, class: {
      ...
      }, disabled: prevDisabled, onClick: this.previousClicked }, h("calcite-icon", { flipRtl: true, icon: ICONS.previous, scale: getIconScale(this.scale) })), this.renderItems(), h("button", { "aria-label": messages.next, class: {
        [CSS.next]: true,
        [CSS.disabled]: nextDisabled,
      }, disabled: nextDisabled, onClick: this.nextClicked }, h("calcite-icon", { flipRtl: true, icon: ICONS.next, scale: getIconScale(this.scale) }))));
  }
