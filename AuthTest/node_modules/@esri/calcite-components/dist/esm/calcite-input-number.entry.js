...
import { e as getSlotted, i as isPrimaryPointerButton, h as setRequestedIcon, g as getElementDir } from './dom-9ac56900.js';
...
import { a as setComponentLoaded, s as setUpLoadableComponent, c as componentFocusable } from './loadable-1917c524.js';
import { n as numberStringFormatter, i as isValidNumber, p as parseNumberString, s as sanitizeNumberString, a as addLocalizedTrailingDecimalZeros, c as connectLocalized, d as disconnectLocalized, B as BigDecimal } from './locale-07424fa5.js';
import { c as createObserver } from './observers-469c8c46.js';
import { C as CSS_UTILITY } from './resources-6ed27057.js';
import { u as updateMessages, c as connectMessages, d as disconnectMessages, s as setUpMessages } from './t9n-0cedcbfc.js';
import { g as getIconScale } from './component-d6d13dbf.js';
import './guid-805a73d1.js';
import './browser-6b1c93d7.js';
...
const InputNumber = class {
  ...
  render() {
    ...
    const numberButtonsHorizontalUp = (h("button", { "aria-hidden": "true", class: {
      ...
      }, "data-adjustment": "up", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerUpAndOutHandler, onPointerUp: this.nudgeButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { icon: "chevron-up", scale: getIconScale(this.scale) })));
    const numberButtonsHorizontalDown = (h("button", { "aria-hidden": "true", class: {
        [CSS.numberButtonItem]: true,
        [CSS.buttonItemHorizontal]: isHorizontalNumberButton,
      }, "data-adjustment": "down", disabled: this.disabled || this.readOnly, onPointerDown: this.nudgeButtonPointerDownHandler, onPointerOut: this.nudgeButtonPointerUpAndOutHandler, onPointerUp: this.nudgeButtonPointerUpAndOutHandler, tabIndex: -1, type: "button" }, h("calcite-icon", { icon: "chevron-down", scale: getIconScale(this.scale) })));
