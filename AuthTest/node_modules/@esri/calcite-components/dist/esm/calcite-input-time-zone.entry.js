...
import { u as updateHostInteraction } from './interactive-2b2de863.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-07424fa5.js';
  ...
  if (mode === "offset") {
    if (!timeZoneGroups) {
      timeZoneGroups = Promise.all([
        import('./index-4c97cc37.js'),
        import('./index-8f3f586a.js'),
      ]);
    }
