...
async function i2(e, t, i3, r2) {
  ...
  if ("cim" === e.type)
    return a(e, t, i3);
  if ("web-style" === e.type) {
    const { fetchCIMSymbolReference: n } = await import("./webStyleUtils-6GBTTPAT.js"), l2 = { type: "cim", data: await n(e, null, r2) ?? void 0, rendererKey: e.rendererKey, maxVVSize: e.maxVVSize };
    return a(l2, t, i3);
  }
  return e;
}
...
//# sourceMappingURL=chunk-3XN3CFM5.js.map
