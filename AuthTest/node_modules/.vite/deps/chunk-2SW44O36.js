...
function l(t, n, r = 1e3) {
  switch (t.toLowerCase()) {
    ...
    case "mean":
      return s(me(n));
    case "min":
      return Math.min.apply(Math, me(n));
    case "sum":
      return u(me(n));
    case "max":
      return Math.max.apply(Math, me(n));
    case "stdev":
    case "stddev":
      return Math.sqrt(c(me(n)));
    case "var":
    case "variance":
      return c(me(n));
    case "count":
...
//# sourceMappingURL=chunk-2SW44O36.js.map
