...
async function n(e) {
  const t2 = new Blob([e]), r2 = await t2.text();
  return JSON.parse(r2);
}
async function o(r2, n2) {
  if (n2 === u.KTX2_ENCODING)
    return new t(r2);
  const o2 = new Blob([r2], { type: n2 }), c = URL.createObjectURL(o2), s = new Image();
  if (has("esri-iPhone"))
...
//# sourceMappingURL=chunk-PRZWMTUS.js.map
