...
var i;
var o2 = { exports: {} };
o2.exports, e = o2, o2.exports, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, "undefined" != typeof __filename && (r = r || __filename), i = function(t) {
  var n2, e2;
  (t = void 0 !== (t = t || {}) ? t : {}).ready = new Promise(function(t2, r2) {
    n2 = t2, e2 = r2;
  });
  var i2, o3, u2, s2, a, c, f = Object.assign({}, t), p = "object" == typeof window, l = "function" == typeof importScripts, h = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, d = "";
  function m(n3) {
    ...
    for (var o4 = ""; n3 < i3; ) {
      ...
      if (128 & u3) {
        ...
        if (192 != (224 & u3)) {
          ...
          o4 += String.fromCharCode((31 & u3) << 6 | s3);
      } else
        o4 += String.fromCharCode(u3);
    }
    return o4;
  ...
  function at(t2) {
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o4 = n3 * (1 + 0.2 / i3);
      if (o4 = Math.min(o4, t2 + 100663296), st(Math.min(e3, r2(Math.max(t2, o4), 65536))))
        return true;
    }
    return false;
  }
...
var u = o2.exports;
var s = n({ __proto__: null, default: o(u) }, [u]);
export {
  s as l
};
//# sourceMappingURL=lerc-wasm-JHODVQEO.js.map
