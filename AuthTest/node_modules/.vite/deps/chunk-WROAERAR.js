...
async function E(r, a, u, l = {}, s2 = {}) {
  const m2 = "string" == typeof r ? I(r) : r, c2 = a.geometry ? [a.geometry] : [], f2 = await R(c2, null, { signal: l.signal }), d2 = f2 == null ? void 0 : f2[0];
  null != d2 && ((a = a.clone()).geometry = d2);
  const p2 = t({ ...m2.query, f: u, ...s2, ...y(a, s2) });
  return j(V(m2.path, g(a, s2) ? "query3d" : "query"), { ...l, responseType: "pbf" === u ? "array-buffer" : "json", query: { ...p2, ...l.query } });
}
function g(t4, e) {
...
//# sourceMappingURL=chunk-WROAERAR.js.map
