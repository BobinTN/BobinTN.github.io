...
function t(n2, t2) {
  return null != d(t2.name, (n2 == null ? void 0 : n2.supportedFormats) ?? []);
}
function r(n2, t2) {
  if (!n2)
    return false;
...
function l(n2) {
  return n2 == null ? void 0 : n2[1].toLowerCase();
}
function w(n2) {
  return (n2 == null ? void 0 : n2[2].split(",").map((n3) => n3.toLowerCase())) ?? [];
}
function F(n2) {
  var _a;
...
//# sourceMappingURL=chunk-OJ65P3EQ.js.map
