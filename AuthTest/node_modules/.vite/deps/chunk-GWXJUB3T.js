...
var r = class _r {
  ...
  setDataUniforms(t7, e3, n2, o2, s) {
    ...
    for (const i5 of r3) {
      const { name: r4, type: a5, getValue: c4 } = i5, u3 = c4(n2, e3, o2, s);
      if (null !== u3)
        switch (a5) {
          case "float":
            t7.setUniform1f(r4, u3);
            break;
          case "vec2":
            t7.setUniform2fv(r4, u3);
            break;
          case "vec4":
            t7.setUniform4fv(r4, u3);
        }
    }
  }
  encodeAttributes(t7, n2, o2, s) {
    ...
    for (const f4 of Object.keys(i5)) {
      const _3 = i5[f4], { type: h3, precisionFactor: l5, isLayout: d4 } = r3[f4], y3 = d4 ? o2.getLayoutProperty(f4) : o2.getPaintProperty(f4), I2 = (_a = y3.interpolator) == null ? void 0 : _a.getInterpolationRange(n2);
      let m2 = 0;
      for (const o3 of _3) {
        ...
        if (i6 > 0) {
          for (let t8 = 0; t8 < i6; t8++)
            a5.push(0);
          c4 += u3, u3 = o3.bufferElementsToAdd;
        }
        const f5 = s ?? y3.getValue(I2 ? I2[m2] : n2, t7);
        switch (h3) {
          case N.R8_SIGNED:
          case N.R8_UNSIGNED:
  ...
  _buildAttributesInfo() {
    ...
    for (const o2 of c4) {
      u3++;
      const c5 = this.getAtributeState(u3);
      ...
      for (let e4 = 0; e4 < c5; e4++) {
        const { dataType: e5, bytesPerElement: n2, count: o3, normalized: a6 } = _r._encodingInfo[h4], c6 = n2 * o3, u4 = `${e5}-${true === a6}`;
        let f6 = s[u4], l5 = 0;
        if (!f6 || f6.count + o3 > 4)
          i5++, f6 = { dataIndex: i5, count: 0, offset: 0 }, 4 !== o3 && (s[u4] = f6), t7.push({ location: -1, name: "a_data_" + i5, count: o3, type: e5, normalized: a6 }), l5 = Math.ceil(Math.max(c6 / 4, 1));
        else {
...
`;
    const u3 = this.attributes(), f4 = this.attributesInfo();
    let _3 = -1;
    for (const h3 of u3) {
      _3++;
      const { name: t8, type: u4, precisionFactor: l5, isLayout: d4 } = f4[h3], y3 = l5 && 1 !== l5 ? " * " + 1 / l5 : "", { bytesPerElement: I2, count: m2 } = _r._encodingInfo[u4], E2 = (t9) => `a_data_${t9.dataIndex}${a2(m2, t9.offset, I2)}`;
      switch (this.getAtributeState(_3)) {
        case R.UNIFORM:
          {
            const n2 = this._getType(m2), o3 = `u_${t8}`;
            c4.push({ name: o3, type: n2, getValue: (t9, n3, o4, s2) => {
              const r3 = d4 ? t9.getLayoutValue(h3, n3) : t9.getPaintValue(h3, n3);
              if (u4 === N.R16G16B16A16_DASHARRAY) {
              ...
              if (u4 === N.R16G16B16A16_PATTERN) {
                const t10 = s2.getMosaicItemPosition(r3, !h3.includes("line-"));
                if (null == t10)
                  return null;
                const { tl: e3, br: n4 } = t10;
                return [e3[0], n4[1], n4[0], e3[1]];
              }
              if (u4 === N.R8G8B8A8_COLOR) {
                const t10 = r3[3];
...
`;
        ...
        case R.DATA_DRIVEN:
          {
            const e3 = E2(o2[h3][0]);
            i5 += `${this._getType(m2)} ${t8} = ${e3}${y3};
`;
          }
          break;
        case R.INTERPOLATED_DATA_DRIVEN: {
          const e3 = `u_t_${t8}`;
          c4.push({ name: e3, type: "float", getValue: (t9, e4, n3, o3) => (d4 ? t9.getLayoutProperty(h3) : t9.getPaintProperty(h3)).interpolator.interpolationUniformValue(n3, e4) }), s += `uniform float ${e3};
`;
          const n2 = E2(o2[h3][0]), r3 = E2(o2[h3][1]);
          i5 += `${this._getType(m2)} ${t8} = mix(${n2}${y3}, ${r3}${y3}, ${e3});
`;
        }
      }
    }
...
var P = class _P {
  ...
  evaluate(n2, a5) {
    ...
    let u3 = 0;
    for (; ++u3 < i5.length && !(l5 < i5[u3][0]); )
      ;
    const c4 = i5[u3 - 1][0], h3 = i5[u3][0], p = _P.interpolationRatio(this.interpolation, l5, c4, h3), f4 = i5[u3 - 1][1].evaluate(n2, a5), w = i5[u3][1].evaluate(n2, a5);
    if ("interpolate" === this._operator) {
      if ("array" === this.type.kind && Array.isArray(f4) && Array.isArray(w))
        return f4.map((t7, e3) => h(t7, w[e3], p));
      if ("color" === this.type.kind && f4 instanceof u && w instanceof u) {
        const e3 = new u(f4), r3 = new u(w);
        return new u([h(e3.r, r3.r, p), h(e3.g, r3.g, p), h(e3.b, r3.b, p), h(e3.a, r3.a, p)]);
      }
    ...
    if ("interpolate-hcl" === this._operator) {
      const s = j(f4), n3 = j(w), a6 = n3.h - s.h, i6 = y({ h: s.h + p * (a6 > 180 || a6 < -180 ? a6 - 360 * Math.round(a6 / 360) : a6), c: h(s.c, n3.c, p), l: h(s.l, n3.l, p) });
      return new u({ a: h(f4.a, w.a, p), ...i6 });
    }
    if ("interpolate-lab" === this._operator) {
      const e3 = A(f4), n3 = A(w), a6 = y({ l: h(e3.l, n3.l, p), a: h(e3.a, n3.a, p), b: h(e3.b, n3.b, p) });
      return new u({ a: h(f4.a, w.a, p), ...a6 });
    }
...
var F = class _F {
  constructor(t7, e3) {
    this._key = t7, this._obj = e3, this.type = u2;
  }
  static parse(t7, e3) {
    let r3, s;
    switch (t7.length) {
...
var K = class _K {
  ...
  evaluate(t7, e3) {
    return void 0 !== (t7 == null ? void 0 : t7.id);
  }
};
var Q = class _Q {
  constructor(t7, e3) {
...
var ot = class _ot {
  ...
  evaluate(e3, r3) {
    ...
    return new u({ r: s, g: n2, b: a5, a: o2 });
  }
  _validate(t7) {
    if ("number" != typeof t7 || t7 < 0 || t7 > 255)
      throw new Error(`${t7}: invalid color component`);
...
var h2 = class _h {
  constructor(t7, e3) {
    ...
    if (null == e3 && (e3 = t7.default), Array.isArray(e3) && e3.length > 0 && gt[e3[0]]) {
      ...
      try {
        const o3 = "array" === t7.type ? a4(r3[t7.value] || u2, t7.length) : r3[t7.type], u3 = pt(e3, null, o3);
        this.getValue = this._buildExpression(u3, t7), this.isDataDriven = true, u3 instanceof P && u3.input instanceof x && (this.interpolator = u3);
      } catch (m2) {
    ...
    if (this.isDataDriven = !!e3 && !!e3.property, this.isDataDriven)
      if (void 0 !== e3.default && (e3.default = this._validate(e3.default, t7)), h3)
        switch (e3.type) {
          case "identity":
      ...
      h3 ? this.getValue = o2 ? this._buildZoomInterpolate(e3) : this._buildZoomInterval(e3) : (e3 = this._validate(e3, t7), this.getValue = this._buildSimple(e3));
  }
  _validate(t7, e3) {
    if ("number" === e3.type) {
    ...
    if (l5 && a5) {
      ...
      if (Array.isArray(l5[1])) {
        ...
        for (let l6 = 0; l6 < t8.length; l6++)
          i6.push(h(t8[l6], r5[l6], n2));
        return i6;
      }
      return h(l5[1], a5[1], n2);
    }
...
var f3 = class extends P2 {
  constructor(i5, e3, r3, s) {
    super(i5, e3, r3, s);
    const n2 = this.getPaintProperty("fill-color"), h3 = this.getPaintProperty("fill-opacity"), l5 = this.getPaintProperty("fill-pattern");
    this.hasDataDrivenColor = n2 == null ? void 0 : n2.isDataDriven, this.hasDataDrivenOpacity = h3 == null ? void 0 : h3.isDataDriven, this.hasDataDrivenFill = this.hasDataDrivenColor || this.hasDataDrivenOpacity || (l5 == null ? void 0 : l5.isDataDriven);
    const p = this.getPaintProperty("fill-outline-color");
    this.outlineUsesFillColor = !p, this.hasDataDrivenOutlineColor = p == null ? void 0 : p.isDataDriven, this.hasDataDrivenOutline = p ? p.isDataDriven : !!n2 && n2.isDataDriven, this.hasDataDrivenOutline = (p ? this.hasDataDrivenOutlineColor : this.hasDataDrivenColor) || this.hasDataDrivenOpacity, this.fillMaterial = new l2(this.computeAttributesKey(L.FILL, l2.ATTRIBUTES, l2.ATTRIBUTES_INFO)), this.outlineMaterial = new T2(this.computeAttributesKey(L.OUTLINE, this.outlineUsesFillColor ? T2.ATTRIBUTES_FILL : T2.ATTRIBUTES_OUTLINE, this.outlineUsesFillColor ? T2.ATTRIBUTES_INFO_FILL : T2.ATTRIBUTES_INFO_OUTLINE), this.outlineUsesFillColor);
  }
};
...
var l4 = class _l {
  ...
  setStyleLayer(e3, t7) {
    ...
    if (a5) {
      const y3 = this.layers.indexOf(a5);
      t7 || (t7 = y3), t7 === y3 ? (s = false, i5 = _l._recreateLayer(e3, a5), this.layers[t7] = i5, r3.layers[t7] = e3) : (this.layers.splice(y3, 1), r3.layers.splice(y3, 1), i5 = this._create(e3, t7, this.layers), this.layers.splice(t7, 0, i5), r3.layers.splice(t7, 0, e3));
    } else
  ...
  setStyleLayerVisibility(e3, t7) {
    ...
    const i5 = r3.layout || {};
    i5.visibility = t7;
    const s = { type: r3.typeName, id: r3.id, source: r3.source, "source-layer": r3.sourceLayer, minzoom: r3.minzoom, maxzoom: r3.maxzoom, filter: r3.filter, layout: i5, paint: r3.paint }, a5 = _l._recreateLayer(s, r3), y3 = this.layers.indexOf(r3);
    this.layers[y3] = a5, this._style.layers[y3].layout = i5, this._layerByName[r3.id] = a5, this._uidToLayer.set(r3.uid, a5);
  }
  ...
  _identifyRefLayers() {
    ...
    for (const s of this.layers) {
      ...
      if (s.type === a.FILL) {
        ...
        let y3 = s.source + "|" + s.sourceLayer;
        y3 += "|" + ((a5 == null ? void 0 : a5.visibility) ?? ""), y3 += "|" + s.minzoom, y3 += "|" + s.maxzoom, y3 += "|" + JSON.stringify(s.filter), y3 += "|" + (void 0 !== a5 ? a5["line-cap"] : ""), y3 += "|" + (void 0 !== a5 ? a5["line-join"] : ""), (e3.hasDataDrivenLine || l5) && (y3 += "|" + i5), r3.push({ key: y3, layer: s });
      }
      ++i5;
    }
  ...
  _assignRefLayers(t7) {
    ...
    for (let a5 = 0; a5 < s; a5++) {
      ...
      if (l5.key === r3)
        ...
        let e3 = l5.layer;
        for (let y3 = a5 + 1; y3 < s; y3++) {
          const s2 = t7[y3];
          if (s2.key !== r3)
            break;
          const n2 = s2.layer;
          (e3.canUseThinTessellation && !n2.canUseThinTessellation || !e3.canUseThinTessellation && (n2.getPaintProperty("line-pattern") || n2.getPaintProperty("line-dasharray"))) && (e3 = n2, t7[a5] = s2, t7[y3] = l5, i5 = s2.layer.id);
        }
      }
    }
  }
  _create(l5, y3, n2) {
    ...
    switch (l5.type) {
      case "background":
        return new c3(a.BACKGROUND, l5, o2, u3);
      case "fill":
        return new f3(a.FILL, l5, o2, u3);
      case "line":
        return new _2(a.LINE, l5, o2, u3);
      case "symbol":
        return new L3(a.SYMBOL, l5, o2, u3);
      case "raster":
        return console.warn(`Unsupported vector tile raster layer ${l5.id}`), null;
      case "circle":
        return new d3(a.CIRCLE, l5, o2, u3);
    }
    return null;
  }
  static _recreateLayer(l5, y3) {
    switch (l5.type) {
      case "background":
        return new c3(a.BACKGROUND, l5, y3.z, y3.uid);
      case "fill":
        return new f3(a.FILL, l5, y3.z, y3.uid);
      case "line":
        return new _2(a.LINE, l5, y3.z, y3.uid);
      case "symbol":
        return new L3(a.SYMBOL, l5, y3.z, y3.uid);
      case "raster":
        return console.warn(`Unsupported vector tile raster layer ${l5.id}`), null;
      case "circle":
        return new d3(a.CIRCLE, l5, y3.z, y3.uid);
    }
    return null;
  }
};
...
//# sourceMappingURL=chunk-GWXJUB3T.js.map
