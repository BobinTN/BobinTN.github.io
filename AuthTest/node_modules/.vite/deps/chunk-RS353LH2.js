...
var a2;
var n = a2 = class extends f {
  constructor(e2) {
    super(e2), this.variableName = null, this.dimensionName = null, this.values = [], this.isSlice = false;
  }
  clone() {
    return new a2({ variableName: this.variableName, dimensionName: this.dimensionName, values: a(this.values), isSlice: this.isSlice });
  }
};
e([y({ type: String, json: { write: true } })], n.prototype, "variableName", void 0), e([y({ type: String, json: { write: true } })], n.prototype, "dimensionName", void 0), e([y({ type: N.array(N.oneOf([N.native(Number), N.array(N.native(Number))])), json: { write: true } })], n.prototype, "values", void 0), e([y({ type: Boolean, json: { write: true } })], n.prototype, "isSlice", void 0), n = a2 = e([c("esri.layers.support.DimensionalDefinition")], n);
var p = n;
...
function t(e2, n2, i2) {
  ...
  for (let t2 = 0; t2 < s2; t2++) {
    ...
    (_a = a4.values) == null ? void 0 : _a.forEach((t3) => {
      i2.push({ sliceId: -1, multidimensionalDefinition: [...n3, { variableName: e2, dimensionName: a4.name, values: [t3] }] });
    });
  }
...
function i(e2, n2) {
  ...
  return (n2 ? e2.variables.filter((e3) => e3.name.toLowerCase() === n2.toLowerCase()) : [...e2.variables].sort((e3, n3) => e3.name > n3.name ? 1 : -1)).forEach((e3) => {
    ...
    t(e3.name, s2, n3), n3.forEach((e4) => {
      i2.push({ ...e4, sliceId: a4++ });
    });
  }), i2;
}
function a3(e2, n2, t2) {
  let i2 = e2;
  if (n2 && (n2 = [...n2].sort((e3, n3) => e3.dimensionName < n3.dimensionName ? -1 : 1)).forEach(({ dimensionName: e3, values: n3, isSlice: t3 }) => {
    n3.length && (i2 = i2.filter((i3) => {
      const a4 = i3.multidimensionalDefinition.find((n4) => n4.dimensionName === e3);
      if (null == a4)
        return false;
      const s2 = a4.values[0];
    ...
    const e3 = t2.start.getTime(), n3 = t2.end.getTime(), a4 = i2[0].multidimensionalDefinition.findIndex((e4) => "StdTime" === e4.dimensionName);
    a4 > -1 && (i2 = i2.filter((t3) => {
      const i3 = t3.multidimensionalDefinition[a4].values[0];
      return e3 <= i3 && n3 >= i3;
    }));
  }
...
function u(e2, n2, t2) {
  ...
  const a4 = i2;
  if (!(a4 == null ? void 0 : a4.length))
    return e2;
  const r2 = e2.values.filter((e3) => s(e3, a4));
  return { ...e2, extent: [...a4], values: r2 };
}
function o(e2, n2, t2) {
  var _a;
  if (!((_a = n2 == null ? void 0 : n2.subsetDefinitions) == null ? void 0 : _a.length))
  ...
  for (let a4 = 0; a4 < e2.length; a4++) {
    const i3 = e2[a4], u2 = n2.subsetDefinitions.find((e3) => ("" === i3.variableName || e3.variableName === i3.variableName) && e3.dimensionName === i3.dimensionName);
...
function m(e2, n2) {
  ...
  const { geometry: t2, timeExtent: i2, multidimensionalDefinition: a4 } = n2;
  let s2 = null;
  if (null != i2 && (s2 = c2(e2, i2), null == s2))
  ...
  return null != a4 && a4.length && o(a4, e2, true) ? { isOutside: true } : { isOutside: false, intersection: { geometry: t2, timeExtent: s2, multidimensionalDefinition: a4 } };
}
function c2(e2, t2) {
  ...
  if (null == i2 || null == t2.start && null == t2.end)
    return t2;
  t2 = t2.clone();
  const { start: a4, end: s2 } = t2.toJSON(), r2 = a4 === s2 ? [a4] : null != a4 && null != s2 ? [a4, s2] : [a4 ?? s2];
...
function f2(e2, n2 = {}) {
  ...
  if (null == t2)
    return null;
  const { variableName: a4, multidimensionalSubset: s2, multidimensionalDefinition: r2 } = n2, l2 = null != r2 ? (_a = r2[0]) == null ? void 0 : _a.variableName : null, u2 = a4 || l2 || (i2 == null ? void 0 : i2.DefaultVariable);
  let { variables: o2 } = t2;
...
function d(e2, t2 = {}) {
  ...
  if (!i2)
    return null;
  const a4 = [], { dimensions: s2, name: r2 } = i2;
  if (0 === s2.length)
  ...
  for (let l2 = 0; l2 < s2.length; l2++) {
    ...
    "stdz" === e3.name.toLowerCase() && !e3.hasRanges && Math.abs(o2[1]) <= Math.abs(o2[0]) && (m2 = (i3 == null ? void 0 : i3.length) ? i3[i3.length - 1] : o2[1]), a4.push(new p({ variableName: r2, dimensionName: e3.name, values: [m2], isSlice: !t2.useRangeForRangedDimensionInfo || !!e3.hasRanges }));
  }
  return a4;
}
function h(e2) {
...
function v(e2, n2) {
  ...
  switch (((_a = n2.intervalUnit) == null ? void 0 : _a.toLowerCase()) || "seconds") {
    case "seconds":
      r2 = Math.round((e2 - s2) / 1e3 / a4);
      break;
    case "minutes":
      r2 = Math.round((e2 - s2) / 6e4 / a4);
      break;
    case "hours":
      r2 = Math.round((e2 - s2) / 36e5 / a4);
      break;
    case "days":
      r2 = Math.round((e2 - s2) / 864e5 / a4);
      break;
    case "months":
      {
      ...
      break;
    case "years":
      r2 = Math.round((new Date(e2).getUTCFullYear() - new Date(s2).getUTCFullYear()) / a4);
      break;
    case "decades":
      r2 = Math.round((new Date(e2).getUTCFullYear() - new Date(s2).getUTCFullYear()) / 10 / a4);
  }
  return r2;
}
function b(e2) {
  ...
  switch (((_b = e2.intervalUnit) == null ? void 0 : _b.toLowerCase()) ?? "seconds") {
    ...
    case "months":
      {
        const e3 = new Date(t2[1]).getUTCFullYear() - new Date(t2[0]).getUTCFullYear(), i3 = new Date(t2[0]).getUTCMonth(), a5 = new Date(t2[1]).getUTCMonth();
...
function D(e2, n2) {
  ...
  for (let s2 = 0; s2 < a4.length; s2++) {
    const n3 = a4[s2], r2 = [...n3.dimensions].sort((e3, n4) => e3.name > n4.name ? -1 : 1);
    if (n3.name !== i2) {
    ...
    for (let i3 = 0; i3 < u2; i3++) {
      ...
      if (null == n4)
        return null;
      const a5 = v(n4.values[0], r2[i3]);
      if (-1 === a5)
        return null;
      l2.shift(), t2 += i3 === u2 - 1 ? a5 : a5 * l2.reduce((e3, n5) => e3 * n5);
    }
    break;
  }
  return t2;
...
//# sourceMappingURL=chunk-RS353LH2.js.map
