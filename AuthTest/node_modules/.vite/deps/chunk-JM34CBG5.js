...
var F = class extends g {
  ...
  async featureSetFromJSON(e2, t, r) {
    if (!this._queryIs3DObjectFormat(e2) || null == this.infoFor3D || !t.features)
      return d.fromJSON(t);
    const { meshFeatureSetFromJSON: s3 } = await h(import("./meshFeatureSet-FSPM7QBU.js"), r);
  ...
  async executeRelationshipQuery(e2, t) {
    const [{ default: r }, { executeRelationshipQuery: s3 }] = await h(Promise.all([import("./RelationshipQuery-SXTJN3XF.js"), import("./executeRelationshipQuery-NB7EMWHX.js")]), t);
  ...
  async executeRelationshipQueryForCount(e2, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: s3 }] = await h(Promise.all([import("./RelationshipQuery-SXTJN3XF.js"), import("./executeRelationshipQuery-NB7EMWHX.js")]), t);
    return e2 = r.from(e2), (this.gdbVersion || this.dynamicDataSource) && ((e2 = e2.clone()).gdbVersion = e2.gdbVersion || this.gdbVersion, e2.dynamicDataSource = e2.dynamicDataSource || this.dynamicDataSource), s3(this.url, e2, t);
  }
  ...
  async executeTopFeaturesQuery(e2, t) {
    const { executeTopFeaturesQuery: r } = await h(import("./executeTopFeaturesQuery-IXSVU5LJ.js"), t);
    return r(this.parsedUrl, e2, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e2, t) {
    const { executeForTopIds: r } = await h(import("./executeForTopIds-4N4AYZMZ.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  async executeForTopExtents(e2, t) {
    const { executeForTopExtents: r } = await h(import("./executeForTopExtents-6HA6ML2Q.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  async executeForTopCount(e2, t) {
    const { executeForTopCount: r } = await h(import("./executeForTopCount-KNWFS2NP.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  _normalizeQuery(e2) {
    let t = b.from(e2);
...
//# sourceMappingURL=chunk-JM34CBG5.js.map
