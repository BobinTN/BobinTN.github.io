...
function g2(e2, r3, t3 = "AND") {
  return x.create("((" + f3(e2, l.Standardised) + ")" + t3 + "(" + f3(r3, l.Standardised) + "))", e2.fieldsIndex, e2.timeZone);
}
function h2(e2, l2, u4, d3 = null, f6 = null) {
  let p5, m5, g4, I3;
  switch (e2.type) {
    case "interval":
      return F3(h2(e2.value, l2, u4, d3, f6), e2.qualifier, e2.op);
    case "case-expression": {
      let r3 = " CASE ";
      "simple" === e2.format && (r3 += h2(e2.operand, l2, u4, d3, f6));
      for (let t3 = 0; t3 < e2.clauses.length; t3++)
        r3 += " WHEN " + h2(e2.clauses[t3].operand, l2, u4, d3, f6) + " THEN " + h2(e2.clauses[t3].value, l2, u4, d3, f6);
      return null !== e2.else && (r3 += " ELSE " + h2(e2.else, l2, u4, d3, f6)), r3 += " END ", r3;
    }
    case "parameter": {
      ...
      if (r3 instanceof Array) {
        ...
        for (let t3 = 0; t3 < r3.length; t3++)
          "string" == typeof r3[t3] ? e3.push("'" + r3[t3].toString().replaceAll("'", "''") + "'") : f2(r3[t3]) || d(r3[t3]) ? e3.push(w(r3[t3], l2)) : g(r3[t3]) ? e3.push(E3(r3[t3], l2)) : T(r3[t3]) ? e3.push(T2(r3[t3], l2)) : F(r3[t3]) ? e3.push(S2(r3[t3], l2)) : e3.push(r3[t3].toString());
        return e3;
      }
      return r3.toString();
    }
    case "expression-list":
      ...
      for (const r3 of e2.value)
        m5.push(h2(r3, l2, u4, d3, f6));
      return m5;
    case "unary-expression":
      return " ( NOT " + h2(e2.expr, l2, u4, d3, f6) + " ) ";
    case "binary-expression":
      switch (e2.operator) {
        case "AND":
          return " (" + h2(e2.left, l2, u4, d3, f6) + " AND " + h2(e2.right, l2, u4, d3, f6) + ") ";
        case "OR":
          return " (" + h2(e2.left, l2, u4, d3, f6) + " OR " + h2(e2.right, l2, u4, d3, f6) + ") ";
        case "IS":
          if ("null" !== e2.right.type)
            throw new n(t.UnsupportedIsRhs);
          return " (" + h2(e2.left, l2, u4, d3, f6) + " IS NULL )";
        case "ISNOT":
          if ("null" !== e2.right.type)
            throw new n(t.UnsupportedIsRhs);
          return " (" + h2(e2.left, l2, u4, d3, f6) + " IS NOT NULL )";
        case "IN":
          return p5 = [], "expression-list" === e2.right.type ? (p5 = h2(e2.right, l2, u4, d3, f6), " (" + h2(e2.left, l2, u4, d3, f6) + " IN (" + p5.join(",") + ")) ") : (I3 = h2(e2.right, l2, u4, d3, f6), I3 instanceof Array ? " (" + h2(e2.left, l2, u4, d3, f6) + " IN (" + I3.join(",") + ")) " : " (" + h2(e2.left, l2, u4, d3, f6) + " IN (" + I3 + ")) ");
        case "NOT IN":
          return p5 = [], "expression-list" === e2.right.type ? (p5 = h2(e2.right, l2, u4, d3, f6), " (" + h2(e2.left, l2, u4, d3, f6) + " NOT IN (" + p5.join(",") + ")) ") : (I3 = h2(e2.right, l2, u4, d3, f6), I3 instanceof Array ? " (" + h2(e2.left, l2, u4, d3, f6) + " NOT IN (" + I3.join(",") + ")) " : " (" + h2(e2.left, l2, u4, d3, f6) + " NOT IN (" + I3 + ")) ");
        case "BETWEEN":
          return g4 = h2(e2.right, l2, u4, d3, f6), " (" + h2(e2.left, l2, u4, d3, f6) + " BETWEEN " + g4[0] + " AND " + g4[1] + " ) ";
        case "NOTBETWEEN":
          return g4 = h2(e2.right, l2, u4, d3, f6), " (" + h2(e2.left, l2, u4, d3, f6) + " NOT BETWEEN " + g4[0] + " AND " + g4[1] + " ) ";
        case "LIKE":
          return "" !== e2.escape ? " (" + h2(e2.left, l2, u4, d3, f6) + " LIKE " + h2(e2.right, l2, u4, d3, f6) + " ESCAPE '" + e2.escape + "') " : " (" + h2(e2.left, l2, u4, d3, f6) + " LIKE " + h2(e2.right, l2, u4, d3, f6) + ") ";
        case "NOT LIKE":
          return "" !== e2.escape ? " (" + h2(e2.left, l2, u4, d3, f6) + " NOT LIKE " + h2(e2.right, l2, u4, d3, f6) + " ESCAPE '" + e2.escape + "') " : " (" + h2(e2.left, l2, u4, d3, f6) + " NOT LIKE " + h2(e2.right, l2, u4, d3, f6) + ") ";
        case "<>":
        case "<":
        case ">":
        case ">=":
        ...
        case "+":
        case "/":
          return " (" + h2(e2.left, l2, u4, d3, f6) + " " + e2.operator + " " + h2(e2.right, l2, u4, d3, f6) + ") ";
        case "||":
          return " (" + h2(e2.left, l2, u4, d3, f6) + " " + (l2 === l.SqlServer ? "+" : e2.operator) + " " + h2(e2.right, l2, u4, d3, f6) + ") ";
      }
    ...
    case "current-time":
      return L("date" === e2.mode, l2);
    case "column-reference":
      return d3 ? d3.toLowerCase() === e2.column.toLowerCase() ? "(" + f6 + ")" : true === e2.delimited ? `"${e2.column.split('"').join('""')}"` : e2.column : e2.column;
    case "data-type":
      return e2.value;
    case "function": {
      const r3 = h2(e2.args, l2, u4, d3, f6);
...
function I2(e2, r3, t3 = {}) {
  ...
  switch (A(a3, e2.parseTree, e2.parameters, s3)) {
    case "double":
      return "double";
    case "integer":
      return "integer";
  ...
  switch (a3.type) {
    ...
    case "case-expression": {
      ...
      if ("simple" === a3.format) {
        for (let t3 = 0; t3 < a3.clauses.length; t3++)
          r3.push(A(e2, a3.clauses[t3].value, n4, l2));
        null !== a3.else && r3.push(A(e2, a3.else, n4, l2));
      } else {
        for (let t3 = 0; t3 < a3.clauses.length; t3++)
          r3.push(A(e2, a3.else, n4, l2));
        null !== a3.else && r3.push(A(e2, a3.else, n4, l2));
      }
      return b2(r3);
    }
    ...
    case "binary-expression":
      switch (a3.operator) {
        ...
        case "+":
        case "/":
          return b2([A(e2, a3.left, n4, l2), A(e2, a3.right, n4, l2)]);
        case "||":
          return "string";
        default:
    ...
    case "function":
      switch (a3.name.toLowerCase()) {
        ...
        case "mod":
          return "integer";
        case "round":
          if (u4 = A(e2, a3.args, n4, l2), u4 instanceof Array) {
            if (u4.length <= 0)
              return "double";
            u4 = u4[0];
          }
        ...
        case "floor":
        case "abs":
          return u4 = A(e2, a3.args, n4, l2), u4 instanceof Array && (u4 = b2(u4)), "integer" === u4 || "double" === u4 ? u4 : "double";
        case "area":
        case "length":
        case "log":
        case "log10":
        ...
        case "nullif":
        case "coalesce":
          return u4 = A(e2, a3.args, n4, l2), u4 instanceof Array ? u4.length > 0 ? u4[0] : "" : u4;
      }
      return "";
  }
...
async function S3(e2, r3, a3 = 1e3, c = null) {
...
var x4 = class _x {
  ...
  async _manualStat(e2, t3, s3, n4) {
    ...
    switch (e2.toLowerCase()) {
      ...
      case "distinct":
        return i = await S3(this, t3, s3, n4), { calculated: true, result: i };
      case "avg":
      case "mean":
  ...
  async distinct(e2, t3 = 1e3, s3 = null, n4) {
    ...
    return this._substituteVars(i, s3), this.calculateStatistic("distinct", i, t3, this._defaultTracker(n4));
  }
  async min(e2, t3 = null, s3) {
    await this.load();
    const n4 = x.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n4, t3), this.calculateStatistic("min", n4, -1, this._defaultTracker(s3));
  }
  async max(e2, t3 = null, s3) {
    await this.load();
    const n4 = x.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n4, t3), this.calculateStatistic("max", n4, -1, this._defaultTracker(s3));
  }
  async avg(e2, t3 = null, s3) {
    await this.load();
    const n4 = x.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n4, t3), this.calculateStatistic("avg", n4, -1, this._defaultTracker(s3));
  }
  async sum(e2, t3 = null, s3) {
    await this.load();
    const n4 = x.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n4, t3), this.calculateStatistic("sum", n4, -1, this._defaultTracker(s3));
  }
  async stdev(e2, t3 = null, s3) {
    await this.load();
    const n4 = x.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n4, t3), this.calculateStatistic("stdev", n4, -1, this._defaultTracker(s3));
  }
  async variance(e2, t3 = null, s3) {
    await this.load();
    const n4 = x.create(e2, this.getFieldsIndex(), this.dateFieldsTimeZoneDefaultUTC);
    return this._substituteVars(n4, t3), this.calculateStatistic("variance", n4, -1, this._defaultTracker(s3));
  }
  async count(e2) {
      ...
      e2.next().then((r3) => {
        try {
          if (null === r3)
            ...
            const l2 = t3(r3);
            null == l2 ? this._forEachImpl(e2, t3, s3, n4, i, a3) : E(l2) ? l2.then(() => {
              try {
  ...
  schema() {
    ...
    for (const t3 of this.fields)
      e2.push(p(t3));
    return { objectIdField: this.objectIdField, globalIdField: this.globalIdField, geometryType: void 0 === E2[this.geometryType] ? "esriGeometryNull" : E2[this.geometryType], fields: e2 };
  }
...
//# sourceMappingURL=chunk-RMCLR6LF.js.map
