...
import {
  ...
  setUpMessages,
  updateMessages
} from "./chunk-4BYSNIUA.js";
import {
  componentFocusable,
  setComponentLoaded,
  setUpLoadableComponent
} from "./chunk-KUWT63LZ.js";
import {
  defineCustomElement
} from "./chunk-IXCTC75G.js";
import {
...
var ActionGroup = proxyCustomElement(class extends H {
  ...
  renderMenu() {
    ...
    return h("calcite-action-menu", { expanded, flipPlacements: ["left", "right"], hidden: !hasMenuActions, label: messages.more, onCalciteActionMenuOpen: this.setMenuOpen, open: menuOpen, overlayPositioning, placement: layout === "horizontal" ? "bottom-start" : "leading-start", scale }, h("calcite-action", { icon: ICONS.menu, scale, slot: SLOTS.trigger, text: messages.more, textEnabled: expanded }), h("slot", { name: SLOTS2.menuActions, onSlotchange: this.handleMenuActionsSlotChange }), h("slot", { name: SLOTS2.menuTooltip, slot: SLOTS.tooltip }));
  }
  render() {
...
@esri/calcite-components/dist/components/action-group.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RFAEZDLP.js.map
