...
var i;
var o2 = { exports: {} };
o2.exports, e = o2, o2.exports, t = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, i = function(n = {}) {
  var r2, e2, i2 = void 0 !== n ? n : {};
  i2.ready = new Promise((n2, t2) => {
    r2 = n2, e2 = t2;
  });
  var o3 = Object.assign({}, i2), a2 = "object" == typeof window, u2 = "function" == typeof importScripts;
  ...
  Object.assign(i2, o3), o3 = null, i2.arguments && i2.arguments, i2.thisProgram && i2.thisProgram, i2.quit && i2.quit, i2.wasmBinary && (l = i2.wasmBinary), i2.noExitRuntime, "object" != typeof WebAssembly && z("no native wasm support detected");
  ...
  function vn(n2, r3, e3) {
    ...
    r3.forEach((n3, r4) => {
      on.hasOwnProperty(n3) ? i3[r4] = on[n3] : (o4.push(n3), tn.hasOwnProperty(n3) || (tn[n3] = []), tn[n3].push(() => {
        i3[r4] = on[n3], ++a3 === o4.length && t2(i3);
      }));
    }), 0 === o4.length && t2(i3);
  }
  function hn(n2) {
    ...
    vn([n2], i3.map((n3) => n3.getterReturnType).concat(i3.map((n3) => n3.setterArgumentType)), (n3) => {
      ...
      return i3.forEach((r4, e4) => {
        ...
        o4[t3] = { read: (n4) => a3.fromWireType(u3(c2, n4)), write: (n4, r5) => {
          var e5 = [];
  ...
  function Cn(n2, r3, e3, t2, i3) {
    ...
    Tn(n2, { name: r3 = wn(r3), fromWireType: function(n3) {
      ...
      return this.fromWireType(t3[n3 >> o4]);
  ...
  function Gn(n2, r3, e3, t2, i3, o4, a3) {
    var u3 = Hn(r3, e3);
    n2 = wn(n2), i3 = Bn(t2, i3), On(n2, function() {
      ...
      return Dn(n2, Un(n2, t3, null, i3, o4), r3 - 1), [];
    });
  }
  function Xn(n2, r3, e3) {
    switch (r3) {
  ...
  function Zn(n2, r3, e3, t2, i3) {
    ...
    }, argPackAdvance: 8, readValueFromPointer: Xn(r3, o4, 0 !== t2), destructorFunction: null });
  }
  function $n(n2, r3, e3) {
  ...
  function Jn(n2, r3, e3, t2) {
    if (!(t2 > 0))
      return 0;
    for (var i3 = e3, o4 = e3 + t2 - 1, a3 = 0; a3 < n2.length; ++a3) {
  ...
  function er(n2, r3) {
    ...
    Tn(n2, { name: r3, fromWireType: function(n3) {
      ...
      if (e3)
        for (var o4 = i3, a3 = 0; a3 <= t2; ++a3) {
          var u3 = i3 + a3;
          if (a3 == t2 || 0 == m[u3]) {
            var c2 = rr(o4, u3 - o4);
            void 0 === r4 ? r4 = c2 : (r4 += String.fromCharCode(0), r4 += c2), o4 = u3 + 1;
          }
        }
      else {
        var f2 = new Array(t2);
  ...
  function or(n2, r3, e3) {
    if (void 0 === e3 && (e3 = 2147483647), e3 < 2)
      return 0;
    for (var t2 = r3, i3 = (e3 -= 2) < 2 * n2.length ? e3 / 2 : n2.length, o4 = 0; o4 < i3; ++o4) {
  ...
  function ur(n2, r3) {
    for (var e3 = 0, t2 = ""; !(e3 >= r3 / 4); ) {
      ...
      if (++e3, i3 >= 65536) {
        var o4 = i3 - 65536;
        t2 += String.fromCharCode(55296 | o4 >> 10, 56320 | 1023 & o4);
      } else
  ...
  function cr(n2, r3, e3) {
    if (void 0 === e3 && (e3 = 2147483647), e3 < 4)
      return 0;
    for (var t2 = r3, i3 = t2 + e3 - 4, o4 = 0; o4 < n2.length; ++o4) {
      var a3 = n2.charCodeAt(o4);
  ...
  function sr(n2, r3, e3) {
    var t2, i3, o4, a3, u3;
    e3 = wn(e3), 2 === r3 ? (t2 = ir, i3 = or, a3 = ar, o4 = () => y, u3 = 1) : 4 === r3 && (t2 = ur, i3 = cr, a3 = fr, o4 = () => w, u3 = 2), Tn(n2, { name: e3, fromWireType: function(n3) {
      for (var e4, i4 = w[n3 >> 2], a4 = o4(), c2 = n3 + 4, f2 = 0; f2 <= i4; ++f2) {
        var s2 = n3 + 4 + f2 * r3;
        if (f2 == i4 || 0 == a4[s2 >> u3]) {
          var l2 = t2(c2, s2 - c2);
      ...
      var o5 = a3(t3), c2 = Rr(4 + o5 + r3);
      return w[c2 >> 2] = o5 >> u3, i3(t3, c2 + 4, o5 + r3), null !== n3 && n3.push(Sr, c2), c2;
    }, argPackAdvance: 8, readValueFromPointer: en, destructorFunction: function(n3) {
      Sr(n3);
    } });
  }
  function lr(n2, r3, e3, t2, i3, o4) {
    nn[n2] = { name: wn(r3), rawConstructor: Bn(e3, t2), rawDestructor: Bn(i3, o4), fields: [] };
  }
  function dr(n2, r3, e3, t2, i3, o4, a3, u3, c2, f2) {
    nn[n2].fields.push({ fieldName: wn(r3), getterReturnType: e3, getter: Bn(t2, i3), getterContext: o4, setterArgumentType: a3, setter: Bn(u3, c2), setterContext: f2 });
  }
  function pr(n2, r3) {
  ...
  function Cr(n2) {
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o4 = r3 * (1 + 0.2 / i3);
      if (o4 = Math.min(o4, n2 + 100663296), Tr(Math.min(e3, t2(Math.max(n2, o4), 65536))))
        return true;
    }
    return false;
  }
...
var a = o2.exports;
var u = r({ __proto__: null, default: o(a) }, [a]);
export {
  u as i
};
//# sourceMappingURL=i3s-7PAK5RXB.js.map
