...
var n = class _n {
  ...
  toFormat(t2 = null) {
    ...
    if (!(t2 = o2(t2)))
      return "";
    const r3 = this.toDateTime("unknown");
    return m.dateTimeToArcadeDate(r3).toFormat(t2, { locale: c(), numberingSystem: "latn" });
  }
  toArcadeDate() {
...
function s(r3) {
  ...
  switch (r3.type) {
    ...
    case "polyline":
      return r3.extent;
    case "point":
      return new M({ xmin: r3.x, ymin: r3.y, xmax: r3.x, ymax: r3.y, spatialReference: r3.spatialReference });
    case "extent":
      return r3;
  }
  return null;
...
//# sourceMappingURL=chunk-W4QVNWBV.js.map
