...
var f = s.getLogger("esri.views.2d.engine.webgl.Utils");
var m = "geometry";
var d = [{ name: m, strideInBytes: 12 }];
var p = [{ name: m, strideInBytes: 36 }];
var y = [{ name: m, strideInBytes: 24 }];
var I2 = [{ name: m, strideInBytes: 12 }];
var S2 = [{ name: m, strideInBytes: 40 }];
var T = [{ name: m, strideInBytes: 36 }];
var g = [{ name: m, strideInBytes: 36 }];
function w(e2) {
  const t3 = {};
  for (const n2 of e2)
...
var E2 = w([{ name: m, strideInBytes: 36 }]);
var h = w(d);
var L = w(p);
var N = w(y);
var D = w(I2);
...
function k(t3) {
  switch (t3) {
    ...
    case "square":
      return e.SQUARE;
    default:
      return f.error(new s2("mapview-invalid-type", `Cap type ${t3} is not a valid option. Defaulting to round`)), e.ROUND;
  }
}
function G(t3) {
  switch (t3) {
    ...
    case "round":
      return n.ROUND;
    default:
      return f.error(new s2("mapview-invalid-type", `Join type ${t3} is not a valid option. Defaulting to round`)), n.ROUND;
  }
}
function V(e2) {
  switch (e2) {
    ...
    case "size":
      return I.SIZE;
    default:
      return f.error(`Cannot interpret unknown vv: ${e2}`), null;
  }
}
function j(e2, t3, n2, r2, s3, a, i) {
  for (const c in a) {
    ...
    if (null == i2 || null == o2)
      continue;
    const u2 = t4 * s3.vertexCount / r3, l = t4 * e2 / r3, f2 = t4 * s3.vertexFrom / r3;
...
function K(t3) {
  switch (t3) {
    ...
    case U.FLOAT:
      return 4;
    default:
      return void f.error(new s2("webgl-utils", `Unable to handle type ${t3}`));
  }
}
function W(t3) {
  switch (t3) {
...
var ne = (e2) => "path" in e2 && pe(e2.path);
...
var pe = (e2) => !!e2 && (e2 = e2.trim(), !!(/^[mzlhvcsqta]\s*[-+.0-9][^mlhvzcsqta]+/i.test(e2) && /[\dz]$/i.test(e2) && e2.length > 4));
var ye = (e2) => {
  var _a, _b;
...
//# sourceMappingURL=chunk-UMP4LYVN.js.map
