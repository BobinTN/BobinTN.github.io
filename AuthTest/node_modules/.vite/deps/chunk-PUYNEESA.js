...
var s = class {
  constructor(t = 9, i) {
    this._compareMinX = o, this._compareMinY = l2, this._toBBox = (t2) => t2, this._maxEntries = Math.max(4, t || 9), this._minEntries = Math.max(2, Math.ceil(0.4 * this._maxEntries)), i && ("function" == typeof i ? this._toBBox = i : this._initFormat(i)), this.clear();
  }
  destroy() {
  ...
  _build(t, i, n, e) {
    ...
    const r2 = new b([]);
    r2.height = e;
    const o2 = Math.ceil(s2 / a2), l3 = o2 * Math.ceil(Math.sqrt(a2));
    f2(t, i, n, l3, this._compareMinX);
    for (let h2 = i; h2 <= n; h2 += l3) {
      const i2 = Math.min(h2 + l3 - 1, n);
      f2(t, h2, i2, o2, this._compareMinY);
  ...
  _chooseSplitIndex(t, i, n) {
    ...
    for (let r2 = i; r2 <= n - i; r2++) {
      const i2 = a(t, 0, r2, this._toBBox), o2 = a(t, r2, n, this._toBBox), l3 = u(i2, o2), m2 = c(i2) + c(o2);
      l3 < e ? (e = l3, h2 = r2, s2 = m2 < s2 ? m2 : s2) : l3 === e && m2 < s2 && (s2 = m2, h2 = r2);
    }
    return h2;
  }
  _chooseSplitAxis(t, i, n) {
    const e = t.leaf ? this._compareMinX : o, s2 = t.leaf ? this._compareMinY : l2;
  ...
  _allDistMargin(t, i, n, e) {
    ...
    for (let a2 = i; a2 < n - i; a2++) {
      ...
      r(h2, t.leaf ? s2(i2) : i2), l3 += m(h2);
    }
    for (let a2 = n - i - 1; a2 >= i; a2--) {
      const i2 = t.children[a2];
      r(o2, t.leaf ? s2(i2) : i2), l3 += m(o2);
    }
    return l3;
  }
...
function f2(t, i, n, s2, h2) {
  ...
  for (; a2.length; ) {
    ...
    f(t, r2, n2, i2, h2), a2.push(n2, r2, r2, i2);
  }
}
var p = new l();
var g = new l();
var M = new l();
var X = new l({ deallocator: void 0 });
var Y = class {
  constructor() {
...
//# sourceMappingURL=chunk-PUYNEESA.js.map
