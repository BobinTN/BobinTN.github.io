...
import "./chunk-C3SC6JFX.js";
import "./chunk-NGG2MNIR.js";
...
async function r6(l10, e14, o10) {
  ...
  return (await Promise.all(a10.map(async (o11, n13) => ({ value: o11, color: "opacity" === l10.type ? await t5(o11, l10, e14) : (await import("./visualVariableUtils-GWAVSSR2.js")).getColor(l10, o11), label: r9 ? u11[n13] : (c21 == null ? void 0 : c21[n13]) ?? "" })))).reverse();
}
async function t5(e14, n13, r9) {
  const t12 = new u3(r9 ?? o6), a10 = (await import("./visualVariableUtils-GWAVSSR2.js")).getOpacity(n13, e14);
...
var b7 = class extends O {
  constructor(e14, t12) {
    super(e14, t12), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new M3(), this.messages = null, this._disposeChart = (e15) => {
      ...
      if (t13 || !i16 || !e15)
        return;
      const { createRoot: r9 } = await import("./chartUtilsAm5-RNRFMQUT.js"), a10 = await r9(e15);
...
function f4() {
  return import("./arcadeUtils-UYNHIB6Y.js");
}
function g8(e14) {
...
var I9 = class extends O {
  ...
  loadDependencies() {
    return r3({ icon: () => import("./calcite-icon-XJ35OAWQ.js"), list: () => import("./calcite-list-EL6XYP7K.js"), "list-item": () => import("./calcite-list-item-ZRJCR4PL.js"), notice: () => import("./calcite-notice-BMEFLJ33.js") });
  }
  destroy() {
...
var n10 = class extends O {
  ...
  loadDependencies() {
    return r3({ action: () => import("./calcite-action-AW5ALFBA.js"), "flow-item": () => import("./calcite-flow-item-RESAYLTP.js") });
  }
  render() {
...
async function L3(t12, l10) {
  ...
  const { getColor: p14, getOpacity: h13, getAllSizes: y11, getRotationAngle: d11 } = await import("./visualVariableUtils-GWAVSSR2.js"), m10 = [], b10 = [], g12 = [], w11 = [];
...
var O4 = class extends i12(O) {
  ...
  loadDependencies() {
    return r3({ action: () => import("./calcite-action-AW5ALFBA.js"), "action-bar": () => import("./calcite-action-bar-N2CMF3ZE.js"), "action-group": () => import("./calcite-action-group-VAZX7UEE.js"), button: () => import("./calcite-button-EKBJ2D7K.js"), flow: () => import("./calcite-flow-C45QE5EW.js"), "flow-item": () => import("./calcite-flow-item-RESAYLTP.js"), list: () => import("./calcite-list-EL6XYP7K.js"), "list-item": () => import("./calcite-list-item-ZRJCR4PL.js"), "list-item-group": () => import("./calcite-list-item-group-E7XTEONW.js"), loader: () => import("./calcite-loader-N4MEBG4W.js") });
  }
  destroy() {
    var _a, _b;
...
//# sourceMappingURL=Popup-3GV6DMGN.js.map
