...
function ie(e2, t2) {
  var i = k(true), s2 = null, a = $2, o2 = null, n2 = V2(r);
  function r(r2) {
    var l3, h, d, c = (r2 = J2(r2)).length, u2 = false;
    for (null == s2 && (o2 = a(d = n2())), l3 = 0; l3 <= c; ++l3)
      !(l3 < c && i(h = r2[l3], l3, r2)) === u2 && ((u2 = !u2) ? o2.lineStart() : o2.lineEnd()), u2 && o2.point(+e2(h, l3, r2), +t2(h, l3, r2));
    if (d)
...
function se(e2, t2, i) {
  var s2 = null, a = k(true), o2 = null, n2 = $2, r = null, l3 = V2(h);
  function h(h2) {
    var d2, c, u2, g2, p, m2 = (h2 = J2(h2)).length, _3 = false, b = new Array(m2), x2 = new Array(m2);
    for (null == o2 && (r = n2(p = l3())), d2 = 0; d2 <= m2; ++d2) {
      if (!(d2 < m2 && a(g2 = h2[d2], d2, h2)) === _3)
        if (_3 = !_3)
      ...
      _3 && (b[d2] = +e2(g2, d2, h2), x2[d2] = +t2(g2, d2, h2), r.point(s2 ? +s2(g2, d2, h2) : b[d2], i ? +i(g2, d2, h2) : x2[d2]));
    }
    if (p)
...
var ae2 = class extends ii {
  setupDefaultRules() {
    super.setupDefaultRules();
    const e2 = this._root.interfaceColors, l3 = this._root.language, h = this.rule.bind(this);
    h("XYChart").setAll({ colors: s.new(this._root, {}), paddingLeft: 20, paddingRight: 20, paddingTop: 16, paddingBottom: 16, panX: false, panY: false, wheelStep: 0.25, arrangeTooltips: true, pinchZoomX: false, pinchZoomY: false }), h("XYSeries").setAll({ legendLabelText: "{name}" }), h("XYChart", ["scrollbar", "chart"]).setAll({ paddingBottom: 0, paddingLeft: 0, paddingTop: 0, paddingRight: 0, colors: s.new(this._root, { saturation: 0 }) });
    {
      ...
      t2.setAll({ fillOpacity: 0.5 }), l2(t2, "fill", e2, "background");
    }
    h("RoundedRectangle", ["xy", "scrollbar", "thumb"]).setAll({ cornerRadiusTR: 0, cornerRadiusTL: 0, cornerRadiusBR: 0, cornerRadiusBL: 0, fillOpacity: 0, focusable: true }), h("RoundedRectangle", ["xy", "scrollbar", "thumb"]).states.create("hover", { fillOpacity: 0.4 }), h("RoundedRectangle", ["xy", "scrollbar", "chart", "background"]).setAll({ cornerRadiusTL: 0, cornerRadiusBL: 0, cornerRadiusTR: 0, cornerRadiusBR: 0 }), h("RoundedRectangle", ["xy", "scrollbar", "chart", "background", "resize", "button"]).setAll({ cornerRadiusBL: 40, cornerRadiusBR: 40, cornerRadiusTL: 40, cornerRadiusTR: 40 }), h("AxisRendererX", ["xy", "chart", "scrollbar"]).setAll({ strokeOpacity: 0, inside: true }), h("AxisRendererY", ["xy", "chart", "scrollbar"]).setAll({ strokeOpacity: 0, inside: true, minGridDistance: 5 }), h("AxisLabel", ["xy", "scrollbar", "x"]).setAll({ opacity: 0.5, centerY: Y, minPosition: 0.01, maxPosition: 0.99, fontSize: "0.8em" }), h("AxisLabel", ["category"]).setAll({ text: "{category}", populateText: true }), h("AxisLabel", ["x"]).setAll({ centerY: 0 }), h("AxisLabel", ["x", "inside"]).setAll({ centerY: Y }), h("AxisLabel", ["x", "inside", "opposite"]).setAll({ centerY: 0 }), h("AxisLabel", ["x", "opposite"]).setAll({ centerY: Y }), h("AxisLabel", ["y"]).setAll({ centerX: Y }), h("AxisLabel", ["y", "inside"]).setAll({ centerX: 0 }), h("AxisLabel", ["y", "inside", "opposite"]).setAll({ centerX: Y }), h("AxisLabel", ["y", "opposite"]).setAll({ centerX: 0 }), h("AxisLabel", ["xy", "scrollbar", "y"]).setAll({ visible: false }), h("Grid", ["xy", "scrollbar", "y"]).setAll({ visible: false }), h("Grid", ["xy", "scrollbar", "x"]).setAll({ opacity: 0.5 }), h("XYCursor").setAll({ behavior: "none", layer: 30, exportable: false, snapToSeriesBy: "xy", moveThreshold: 1 });
    {
      ...
      t2.setAll({ strokeOpacity: 0.8, strokeDasharray: [2, 2], ariaLabel: l3.translate("Use left and right arrows to move selection") }), l2(t2, "stroke", e2, "alternativeBackground");
    }
    {
      const t2 = h("Grid", ["cursor", "y"]);
      t2.setAll({ strokeOpacity: 0.8, strokeDasharray: [2, 2], ariaLabel: l3.translate("Use up and down arrows to move selection") }), l2(t2, "stroke", e2, "alternativeBackground");
    }
    {
      const t2 = h("Graphics", ["cursor", "selection"]);
      t2.setAll({ fillOpacity: 0.15 }), l2(t2, "fill", e2, "alternativeBackground");
    }
    h("Axis").setAll({ start: 0, end: 1, minZoomCount: 1, maxZoomCount: 1 / 0, maxZoomFactor: 1e3, maxDeviation: 0.1, snapTooltip: true, tooltipLocation: 0.5, panX: true, panY: true, zoomX: true, zoomY: true, fixAxisSize: true }), h("AxisLabel").setAll({ location: 0.5, multiLocation: 0, centerX: X, centerY: X, paddingTop: 3, paddingBottom: 3, paddingLeft: 5, paddingRight: 5 }), h("Container", ["axis", "header"]).setAll({ layer: 30 }), h("Rectangle", ["axis", "header", "background"]).setAll({ crisp: true });
    {
      ...
      t2.setAll({ crisp: true, strokeOpacity: 0 }), l2(t2, "stroke", e2, "grid");
    }
    h("AxisRendererX").setAll({ minGridDistance: 120, opposite: false, inversed: false, cellStartLocation: 0, cellEndLocation: 1, width: Y }), h("AxisRendererY").setAll({ minGridDistance: 40, opposite: false, inversed: false, cellStartLocation: 0, cellEndLocation: 1, height: Y });
    {
      ...
      t2.setAll({ fillOpacity: 0 }), l2(t2, "fill", e2, "alternativeBackground"), t2.states.create("hover", { fillOpacity: 0.1 });
    }
    h("Rectangle", ["axis", "thumb", "x"]).setAll({ cursorOverStyle: "ew-resize" }), h("Rectangle", ["axis", "thumb", "y"]).setAll({ cursorOverStyle: "ns-resize" });
    {
      const t2 = h("Grid");
      t2.setAll({ location: 0, strokeOpacity: 0.15, crisp: true }), l2(t2, "stroke", e2, "grid");
    }
    h("Grid", ["base"]).setAll({ strokeOpacity: 0.3 });
    {
      const t2 = h("Graphics", ["axis", "fill"]);
      t2.setAll({ visible: false, isMeasured: false, position: "absolute", fillOpacity: 0.05 }), l2(t2, "fill", e2, "alternativeBackground");
    }
    ...
    {
      const t2 = h("AxisTick");
      t2.setAll({ location: 0.5, multiLocation: 0, strokeOpacity: 1, isMeasured: false, position: "absolute", visible: false }), l2(t2, "stroke", e2, "grid");
    }
    ...
    const d = [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 5 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 50 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "millisecond", count: 500 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 5 }, { timeUnit: "second", count: 10 }, { timeUnit: "second", count: 30 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 5 }, { timeUnit: "minute", count: 10 }, { timeUnit: "minute", count: 15 }, { timeUnit: "minute", count: 30 }, { timeUnit: "hour", count: 1 }, { timeUnit: "hour", count: 3 }, { timeUnit: "hour", count: 6 }, { timeUnit: "hour", count: 12 }, { timeUnit: "day", count: 1 }, { timeUnit: "day", count: 2 }, { timeUnit: "day", count: 3 }, { timeUnit: "day", count: 4 }, { timeUnit: "day", count: 5 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "month", count: 2 }, { timeUnit: "month", count: 3 }, { timeUnit: "month", count: 6 }, { timeUnit: "year", count: 1 }, { timeUnit: "year", count: 2 }, { timeUnit: "year", count: 5 }, { timeUnit: "year", count: 10 }, { timeUnit: "year", count: 50 }, { timeUnit: "year", count: 100 }, { timeUnit: "year", count: 200 }, { timeUnit: "year", count: 500 }, { timeUnit: "year", count: 1e3 }, { timeUnit: "year", count: 2e3 }, { timeUnit: "year", count: 5e3 }, { timeUnit: "year", count: 1e4 }, { timeUnit: "year", count: 1e5 }], c = { millisecond: l3.translate("_date_millisecond"), second: l3.translate("_date_second"), minute: l3.translate("_date_minute"), hour: l3.translate("_date_hour"), day: l3.translate("_date_day"), week: l3.translate("_date_day"), month: l3.translate("_date_month"), year: l3.translate("_date_year") }, u2 = { millisecond: l3.translate("_date_millisecond"), second: l3.translate("_date_second"), minute: l3.translate("_date_minute"), hour: l3.translate("_date_day"), day: l3.translate("_date_day"), week: l3.translate("_date_day"), month: l3.translate("_date_month") + " " + l3.translate("_date_year"), year: l3.translate("_date_year") }, g2 = { millisecond: l3.translate("_date_millisecond_full"), second: l3.translate("_date_second_full"), minute: l3.translate("_date_minute_full"), hour: l3.translate("_date_hour_full"), day: l3.translate("_date_day_full"), week: l3.translate("_date_week_full"), month: l3.translate("_date_month_full"), year: l3.translate("_date_year") };
    h("CategoryDateAxis").setAll({ markUnitChange: true, gridIntervals: D(d), dateFormats: J(c), periodChangeDateFormats: J(u2) }), h("DateAxis").setAll({ maxZoomFactor: null, strictMinMax: true, startLocation: 0, endLocation: 1, markUnitChange: true, groupData: false, groupCount: 500, gridIntervals: D(d), dateFormats: J(c), periodChangeDateFormats: J(u2), tooltipDateFormats: g2, groupIntervals: [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 10 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 10 }, { timeUnit: "hour", count: 1 }, { timeUnit: "day", count: 1 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "year", count: 1 }], fillRule: (e3) => {
      ...
      if (t2) {
        ...
        if (l4 = I(new Date(l4), r.timeUnit, r.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(), null != s2 && null != a) {
          const e4 = Math.round(Math.round((s2 - l4) / o2)) / 2;
      ...
      if (t2) {
        ...
        l(a) && l(o2) && (ae(a / o2 / 2, 5) == Math.round(a / o2 / 2) ? t2.setPrivate("visible", false) : t2.setPrivate("visible", true));
      }
    ...
    h("SmoothedXYLineSeries").setAll({ tension: 0.5 }), h("SmoothedXLineSeries").setAll({ tension: 0.5 }), h("SmoothedYLineSeries").setAll({ tension: 0.5 }), h("Candlestick").setAll({ position: "absolute", isMeasured: false, width: z(50), height: z(50), strokeWidth: 1, strokeOpacity: 1, cornerRadiusBL: 0, cornerRadiusTL: 0, cornerRadiusBR: 0, cornerRadiusTR: 0, fillOpacity: 1, role: "figure" }), h("OHLC").setAll({ width: z(80), height: z(80) }), h("CandlestickSeries").setAll({ lowValueXGrouped: "low", lowValueYGrouped: "low", highValueXGrouped: "high", highValueYGrouped: "high", openValueXGrouped: "open", openValueYGrouped: "open", valueXGrouped: "close", valueYGrouped: "close" });
    {
      ...
      l2(t2, "fill", e2, "positive"), l2(t2, "stroke", e2, "positive");
    }
    {
      const t2 = h("Rectangle", ["column", "autocolor"]).states.create("dropFromOpen", {});
      l2(t2, "fill", e2, "negative"), l2(t2, "stroke", e2, "negative");
    }
...
var oe2 = class extends U {
  ...
  _afterNew() {
    this._defaultThemes.push(ae2.new(this._root)), super._afterNew(), this._disposers.push(this.xAxes), this._disposers.push(this.yAxes);
    const e2 = this._root;
  ...
  handleWheel(e2) {
    ...
    if (!gt(a, this))
      return;
    a.preventDefault();
    const o2 = s2.toLocal(e2.point), n2 = this.get("wheelStep", 0.2), r = a.deltaY / 100, l3 = a.deltaX / 100, h = this.get("wheelZoomPositionX"), d = this.get("wheelZoomPositionY");
    "zoomX" !== t2 && "zoomXY" !== t2 || 0 == l3 || this.xAxes.each((e3) => {
      if (e3.get("zoomX")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), a2 = e3.fixPosition(o2.x / s2.width());
        null != h && (a2 = h);
        let r2 = t3 - n2 * (i2 - t3) * l3 * a2, d2 = i2 + n2 * (i2 - t3) * l3 * (1 - a2);
      ...
      if (e3.get("zoomX")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), a2 = e3.fixPosition(o2.x / s2.width());
        null != h && (a2 = h);
        let l4 = t3 - n2 * (i2 - t3) * r * a2, d2 = i2 + n2 * (i2 - t3) * r * (1 - a2);
        1 / (d2 - l4) < e3.getPrivate("maxZoomFactor", 1 / 0) / e3.get("minZoomCount", 1) && this._handleWheelAnimation(e3.zoom(l4, d2));
      }
    }), "zoomY" !== t2 && "zoomXY" !== t2 || 0 == l3 || this.yAxes.each((e3) => {
      if (e3.get("zoomY")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), a2 = e3.fixPosition(o2.y / s2.height());
        null != d && (a2 = d);
        let r2 = t3 - n2 * (i2 - t3) * l3 * a2, h2 = i2 + n2 * (i2 - t3) * l3 * (1 - a2);
      ...
      if (e3.get("zoomY")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), a2 = e3.fixPosition(o2.y / s2.height());
        null != d && (a2 = d);
        let l4 = t3 - n2 * (i2 - t3) * r * a2, h2 = i2 + n2 * (i2 - t3) * r * (1 - a2);
        1 / (h2 - l4) < e3.getPrivate("maxZoomFactor", 1 / 0) / e3.get("minZoomCount", 1) && this._handleWheelAnimation(e3.zoom(l4, h2));
      }
    }), "panX" !== t2 && "panXY" !== t2 || 0 == l3 || this.xAxes.each((e3) => {
      if (e3.get("panX")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), s3 = this._getWheelSign(e3) * n2 * (i2 - t3) * l3, a2 = t3 + s3, o3 = i2 + s3, r2 = this._fixWheel(a2, o3);
        a2 = r2[0], o3 = r2[1], this._handleWheelAnimation(e3.zoom(a2, o3));
      }
    }), "panX" !== i && "panXY" !== i || 0 == r || this.xAxes.each((e3) => {
      if (e3.get("panX")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), s3 = this._getWheelSign(e3) * n2 * (i2 - t3) * r, a2 = t3 + s3, o3 = i2 + s3, l4 = this._fixWheel(a2, o3);
        a2 = l4[0], o3 = l4[1], this._handleWheelAnimation(e3.zoom(a2, o3));
      }
    }), "panY" !== t2 && "panXY" !== t2 || 0 == l3 || this.yAxes.each((e3) => {
      if (e3.get("panY")) {
        let t3 = e3.get("start"), i2 = e3.get("end"), s3 = this._getWheelSign(e3) * n2 * (i2 - t3) * l3, a2 = t3 + s3, o3 = i2 + s3, r2 = this._fixWheel(a2, o3);
        a2 = r2[0], o3 = r2[1], this._handleWheelAnimation(e3.zoom(a2, o3));
      }
  ...
  _handlePlotDown(e2) {
    ...
    if (this.get("pinchZoomX") || this.get("pinchZoomY")) {
      if (t2.pointerId && $(i._downPoints).length > 0) {
  ...
  _handlePlotMove(e2) {
    ...
    if (this.get("pinchZoomX") || this.get("pinchZoomY")) {
      ...
      if (i2 && (this._movePoints[i2] = e2.point, $(t2._downPoints).length > 1))
      ...
      if (a) {
        ...
        e3 && e3.events.disableType("rangechanged"), this.xAxes.each((e4) => {
          if (e4.get("panX")) {
            ...
            l3 - r < 1 + 2 * e4.get("maxDeviation", 1) && (e4.set("start", r), e4.set("end", l3));
          }
  ...
  _handlePinch() {
    ...
    if (q(e2._downPoints, (e3, a) => {
      ...
      if (o2 && n2 && r && l3) {
        if (r = e2.toLocal(r), l3 = e2.toLocal(l3), o2 = e2.toLocal(o2), n2 = e2.toLocal(n2), this.get("pinchZoomX")) {
          const e3 = this._downStartX, i2 = this._downEndX;
          if (null != e3 && null != i2) {
            o2.x > n2.x && ([o2, n2] = [n2, o2], [r, l3] = [l3, r]);
            let s3 = e3 + o2.x / t3 * (i2 - e3), a2 = e3 + n2.x / t3 * (i2 - e3), h = e3 + r.x / t3 * (i2 - e3), d = e3 + l3.x / t3 * (i2 - e3), c = Math.max(1e-3, a2 - s3) / Math.max(1e-3, d - h), u2 = e3 * c + s3 - h * c, g2 = i2 * c + a2 - d * c;
            this.xAxes.each((e4) => {
        ...
        if (this.get("pinchZoomY")) {
          ...
          if (null != e3 && null != t4) {
            ...
            let i2 = e3 + (1 - o2.y / a) * (t4 - e3), s3 = e3 + (1 - n2.y / a) * (t4 - e3), h = e3 + (1 - r.y / a) * (t4 - e3), d = e3 + (1 - l3.y / a) * (t4 - e3), c = Math.max(1e-3, s3 - i2) / Math.max(1e-3, d - h), u2 = e3 * c + i2 - h * c, g2 = t4 * c + s3 - d * c;
            this.yAxes.each((e4) => {
  ...
  arrangeTooltips() {
    ...
    const r = [];
    let l3, h, d = 0, c = 1 / 0, u2 = this._movePoint, g2 = this.get("maxTooltipDistance"), p = this.get("maxTooltipDistanceBy", "xy");
      ...
      if (!e3.isHidden()) {
        ...
        if (t3) {
          ...
          if (i2) {
            ...
            "x" == p ? t4 = Math.abs(u2.x - i2.x) : "y" == p && (t4 = Math.abs(u2.y - i2.y)), t4 < c && (c = t4, l3 = e3, h = i2);
          }
        }
      }
    });
      ...
      if (t3) {
        ...
        if (s2) {
          if (g2 >= 0) {
            ...
            -1 == g2 && e3 != l3 && (i2 = true);
          this.inPlot(this._tooltipToLocal(s2)) && t3.dataItem ? i2 || (d += s2.y) : i2 = true, i2 || e3.isHidden() || e3.isHiding() ? t3.hide(0) : (t3.show(), r.push(t3), m2.push(e3));
        }
      }
...
Object.defineProperty(oe2, "className", { enumerable: true, configurable: true, writable: true, value: "XYChart" }), Object.defineProperty(oe2, "classNames", { enumerable: true, configurable: true, writable: true, value: U.classNames.concat([oe2.className]) });
...
var re = class extends Qe {
  ...
  _updateXLine(e2) {
    let t2 = ae(this._display.toLocal(e2.get("pointTo", { x: 0, y: 0 })).x, 2);
  ...
  _updateYLine(e2) {
    let t2 = ae(this._display.toLocal(e2.get("pointTo", { x: 0, y: 0 })).y, 2);
  ...
  _setChart(e2) {
    ...
    this.events.on("boundschanged", () => {
      ...
      (this.get("syncWith") || 0 != $(t2._downPoints).length || e3.native || !this.isHidden()) && this._handleMove(e3);
    }));
    const i = this.parent;
  ...
  _handleMove(e2) {
    if (this.getPrivate("visible")) {
      const t2 = this.chart;
      if (t2 && $(t2.plotContainer._downPoints).length > 1)
  ...
  handleMove(e2, t2, i) {
    ...
    if (n2 && (this._inPlot(o2) || this._downPoint)) {
      ...
      let r = o2.x, l3 = o2.y, h = this._getPosition(o2);
      ...
      if (r = m2.x, l3 = m2.y, n2.xAxes.each((e3) => {
      ...
      this._updateLines(r, l3), n2.arrangeTooltips();
...
var de = class extends D2 {
  ...
  _max(e2, t2) {
    let i = he2(this.getPrivate(e2), t2);
    this.setPrivate(e2, i);
  }
  ...
  _makeFieldNames() {
    const e2 = this.get("xAxis"), t2 = this.get("yAxis"), i = e2.getPrivate("name"), s2 = Ht(i), a = t2.getPrivate("name"), o2 = Ht(a), n2 = e2.get("renderer").getPrivate("letter"), r = t2.get("renderer").getPrivate("letter"), l3 = "open", h = "low", d = "high", c = "Show";
    "ValueAxis" === e2.className ? (this._xField = this.get(i + n2 + c), this._xOpenField = this.get(l3 + s2 + n2 + c), this._xLowField = this.get(h + s2 + n2 + c), this._xHighField = this.get(d + s2 + n2 + c)) : (this._xField = i + n2, this._xOpenField = l3 + s2 + n2, this._xLowField = h + s2 + n2, this._xHighField = d + s2 + n2), "ValueAxis" === t2.className ? (this._yField = this.get(a + r + c), this._yOpenField = this.get(l3 + o2 + r + c), this._yLowField = this.get(h + o2 + r + c), this._yHighField = this.get(d + o2 + r + c)) : (this._yField = a + r, this._yOpenField = l3 + o2 + r, this._yLowField = h + o2 + r, this._yHighField = d + o2 + r);
  }
  _fixVC() {
  ...
  _prepareChildren() {
    ...
    if (this.isDirty("stacked") && (o2 ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()), this._valuesDirty && !this._dataProcessed && (this._dataProcessed = true, o2 && this._stack(), m(this.dataItems, (i2) => {
      ...
      if (o3 > 0 && i && (i.get("renderer").axisLength() / (a2 - s3) > o3 ? this._showBullets = true : this._showBullets = false), (this._psi != s3 || this._pei != a2 || this.isDirty("vcx") || this.isDirty("vcy") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
        ...
        if (i === e2 || !i)
          if (t2._calculateTotals(), this.setPrivateRaw("selectionMinY", void 0), this.setPrivateRaw("selectionMaxY", void 0), l3)
            t2.markDirtySelectionExtremes();
          else
            for (let e3 = s3; e3 < a2; e3++)
              this.processYSelectionDataItem(this.dataItems[e3], n2, r);
        if (i === t2 || !i)
          if (e2._calculateTotals(), this.setPrivateRaw("selectionMinX", void 0), this.setPrivateRaw("selectionMaxX", void 0), l3)
            t2.markDirtySelectionExtremes();
          else
            for (let e3 = s3; e3 < a2; e3++)
  ...
  _positionBullet(e2) {
    ...
    if (t2) {
      ...
      let h = this.getPoint(r, l3), d = i.get("left", h.x), c = i.get("right", h.x), u2 = i.get("top", h.y), g2 = i.get("bottom", h.y);
  ...
  show(e2) {
    const t2 = Object.create(null, { show: { get: () => super.show } });
    return t(this, void 0, void 0, function* () {
      this._fixVC();
      let i = [];
      i.push(t2.show.call(this, e2).then(() => {
        this._isShowing = false;
        let e3 = this.get("xAxis"), t3 = this.get("yAxis"), i2 = this.get("baseAxis");
        t3 !== i2 && t3.markDirtySelectionExtremes(), e3 !== i2 && e3.markDirtySelectionExtremes();
      })), i.push(this.bulletsContainer.show(e2)), i.push(this._sequencedShowHide(true, e2)), yield Promise.all(i);
    });
  }
  hide(e2) {
    const t2 = Object.create(null, { hide: { get: () => super.hide } });
    return t(this, void 0, void 0, function* () {
      this._fixVC();
      let i = [];
      i.push(t2.hide.call(this, e2).then(() => {
  ...
  showDataItem(e2, t2) {
    ...
    return t(this, void 0, void 0, function* () {
      const a = [i.showDataItem.call(this, e2, t2)];
      l(t2) || (t2 = this.get("stateAnimationDuration", 0));
      const o2 = this.get("stateAnimationEasing");
      m(this._valueFields, (i2) => {
        a.push(e2.animate({ key: i2 + "Working", to: e2.get(i2), duration: t2, easing: o2 }).waitForStop());
      }), yield Promise.all(a);
    });
  }
  hideDataItem(e2, t2) {
    ...
    return t(this, void 0, void 0, function* () {
      const a = [i.hideDataItem.call(this, e2, t2)], o2 = this.states.create("hidden", {});
      l(t2) || (t2 = o2.get("stateAnimationDuration", this.get("stateAnimationDuration", 0)));
      const n2 = o2.get("stateAnimationEasing", this.get("stateAnimationEasing")), r = this.get("xAxis"), l3 = this.get("yAxis"), h = this.get("baseAxis"), d = this.get("stacked");
      if (h !== r && h || m(this._valueYFields, (i2) => {
        let o3 = l3.getPrivate("min"), r2 = l3.baseValue();
        l(o3) && o3 > r2 && (r2 = o3), d && (r2 = 0), null != e2.get(i2) && a.push(e2.animate({ key: i2 + "Working", to: r2, duration: t2, easing: n2 }).waitForStop());
      }), h === l3 || !h) {
        let i2 = r.getPrivate("min"), o3 = r.baseValue();
        l(i2) && i2 > o3 && (o3 = i2), d && (o3 = 0), m(this._valueXFields, (i3) => {
          null != e2.get(i3) && a.push(e2.animate({ key: i3 + "Working", to: o3, duration: t2, easing: n2 }).waitForStop());
        });
      }
      yield Promise.all(a);
    });
  ...
  showDataItemTooltip(e2) {
    ...
    if (t2) {
      if (this.isHidden())
        ...
        const n2 = this.get("xAxis"), r = this.get("yAxis"), l3 = this.get("vcx", 1), h = this.get("vcy", 1), d = n2.getDataItemPositionX(e2, this._tooltipFieldX, this._aLocationX0 + (this._aLocationX1 - this._aLocationX0) * a, l3), c = r.getDataItemPositionY(e2, this._tooltipFieldY, this._aLocationY0 + (this._aLocationY1 - this._aLocationY0) * o2, h), u2 = this.getPoint(d, c);
        let g2 = true;
...
Object.defineProperty(de, "className", { enumerable: true, configurable: true, writable: true, value: "XYSeries" }), Object.defineProperty(de, "classNames", { enumerable: true, configurable: true, writable: true, value: D2.classNames.concat([de.className]) });
var ce = class extends _ {
  ...
  zoom(e2, t2, i, a) {
    if (this._updateFinals(e2, t2), this.get("start") !== e2 || this.get("end") != t2) {
      ...
      l(d) && (l3 = h / d);
      let u2 = 1;
      if (l(c) && (u2 = h / c), "start" === a ? (c > 0 && 1 / (t2 - e2) < u2 && (t2 = e2 + 1 / u2), 1 / (t2 - e2) > l3 && (t2 = e2 + 1 / l3), t2 > 1 && t2 - e2 < 1 / l3 && (e2 = t2 - 1 / l3)) : (c > 0 && 1 / (t2 - e2) < u2 && (e2 = t2 - 1 / u2), 1 / (t2 - e2) > l3 && (e2 = t2 - 1 / l3), e2 < 0 && t2 - e2 < 1 / l3 && (t2 = e2 + 1 / l3)), 1 / (t2 - e2) > l3 && (t2 = e2 + 1 / l3), 1 / (t2 - e2) > l3 && (e2 = t2 - 1 / l3), null != c && null != d && e2 == this.get("start") && t2 == this.get("end")) {
        const e3 = this.chart;
  ...
  updateTooltip() {
    ...
    l(t2) && (m(this.series, (i2) => {
      if (i2.get("baseAxis") === this) {
        ...
        i2.setRaw("tooltipDataItem", s2), e2 && -1 != e2.indexOf(i2) ? (i2.updateLegendMarker(s2), i2.updateLegendValue(s2)) : i2.showDataItemTooltip(s2);
      }
...
var ue = class extends ce {
  ...
  _prepareAxisItems() {
    ...
    if (l(e2) && l(t2)) {
      ...
      for (; o2 < a; ) {
        ...
        if (s3 && s3.set("text", this._formatText(o2)), this._prepareDataItem(e3), t3 && l3 > 2 ? o2 = Math.pow(10, Math.log(h) * Math.LOG10E + r - 5) : o2 += i, d == o2)
          break;
  ...
  _prepareDataItem(e2, t2) {
    let i = this.get("renderer"), a = e2.get("value"), o2 = e2.get("endValue"), n2 = this.valueToPosition(a), r = n2, l3 = this.valueToPosition(a + this.getPrivate("step"));
    l(o2) && (r = this.valueToPosition(o2), l3 = r), e2.get("isRange") && null == o2 && (l3 = n2), i.updateLabel(e2.get("label"), n2, r, t2);
    const h = e2.get("grid");
    if (i.updateGrid(h, n2, r), h && (a == this.get("baseValue", 0) ? (h.addTag("base"), h._applyThemes()) : h.hasTag("base") && (h.removeTag("base"), h._applyThemes())), i.updateTick(e2.get("tick"), n2, r, t2), i.updateFill(e2.get("axisFill"), n2, l3), this._processBullet(e2), i.updateBullet(e2.get("bullet"), n2, r), !e2.get("isRange")) {
  ...
  _handleRangeChange() {
    ...
    this.setPrivateRaw("stepDecimalPlaces", a), e2 = ae(e2, a), t2 = ae(t2, a), s2 = this._adjustMinMax(e2, t2, i, true);
    let o2 = s2.step;
  ...
  _calculateTotals() {
    if (this.get("calculateTotals")) {
      ...
      if (e2) {
        let t2 = e2.startIndex();
        if (e2.dataItems.length > 0) {
          t2 > 0 && t2--;
          let i, s2, a = e2.endIndex();
          a < e2.dataItems.length && a++, e2.get("yAxis") == this ? (i = "valueY", s2 = "vcy") : e2.get("xAxis") == this && (i = "valueX", s2 = "vcx");
          let o2 = i + "Working";
          if (i)
            for (let e3 = t2; e3 < a; e3++) {
              let t3 = 0, a2 = 0;
              m(this.series, (i2) => {
                if (!i2.get("excludeFromTotal")) {
                  let n2 = i2.dataItems[e3];
                  if (n2) {
                    let e4 = n2.get(o2) * i2.get(s2);
                    e(e4) || (t3 += e4, a2 += Math.abs(e4));
                  }
                }
              }), m(this.series, (n2) => {
                if (!n2.get("excludeFromTotal")) {
                  let r = n2.dataItems[e3];
                  if (r) {
                    let e4 = r.get(o2) * n2.get(s2);
                    e(e4) || (r.set(i + "Total", a2), r.set(i + "Sum", t3), r.set(i + "TotalPercent", e4 / a2 * 100));
                  }
                }
              });
            }
  ...
  _getSelectionMinMax() {
    ...
    const l3 = this.get("renderer").gridCount(), h = this.get("strictMinMaxSelection"), d = this.get("strictMinMax");
    if (l(e2) && l(t2)) {
      let c = t2, u2 = e2;
      if (m(this.series, (e3) => {
        ...
        let e3 = this._adjustMinMax(c, u2, l3, d);
        c = e3.min, u2 = e3.max;
      }
      let g2 = c, p = u2;
      c -= (u2 - c) * o2, u2 += (u2 - c) * r;
      let m2 = this._adjustMinMax(c, u2, l3);
      c = m2.min, u2 = m2.max, c = he(c, e2, t2), u2 = he(u2, e2, t2), m2 = this._adjustMinMax(c, u2, l3, true), d || (c = m2.min, u2 = m2.max);
      const _3 = this.get("syncWithAxis");
      _3 && (m2 = this._syncAxes(c, u2, m2.step, _3.getPrivate("selectionMinFinal", _3.getPrivate("minFinal", 0)), _3.getPrivate("selectionMaxFinal", _3.getPrivate("maxFinal", 1)), _3.getPrivate("selectionStepFinal", _3.getPrivate("step", 1))), c = m2.min, u2 = m2.max), d && (l(i) && (c = Math.max(c, i)), l(a) && (u2 = Math.min(u2, a))), h && (c = g2 - (u2 - c) * o2, u2 = p + (u2 - c) * r), this.get("logarithmic") && (c <= 0 && (c = g2 * (1 - Math.min(o2, 0.99))), c < e2 && (c = e2), u2 > t2 && (u2 = t2));
      let x2 = Math.min(20, Math.ceil(Math.log(this.getPrivate("maxZoomFactor", 100) + 1) / Math.LN10) + 2), f = ae(this.valueToFinalPosition(c), x2), v2 = ae(this.valueToFinalPosition(u2), x2);
      this.setPrivateRaw("selectionMinFinal", c), this.setPrivateRaw("selectionMaxFinal", u2), this.setPrivateRaw("selectionStepFinal", m2.step), this.zoom(f, v2);
    }
  }
  _getMinMax() {
    ...
    if (m(this.series, (e3) => {
      if (!e3.get("ignoreMinMax")) {
        ...
        if (e3.get("xAxis") === this ? (t3 = e3.getPrivate("minX"), o3 = e3.getPrivate("maxX")) : e3.get("yAxis") === this && (t3 = e3.getPrivate("minY"), o3 = e3.getPrivate("maxY")), l(t3) && l(o3)) {
          ...
          let e4 = o3 - t3;
          e4 <= 0 && (e4 = Math.abs(o3 / 100)), e4 < l3 && (l3 = e4);
        }
      }
    }), this.axisRanges.each((e3) => {
      if (e3.get("affectsMinMax")) {
    ...
    let m2 = g2;
    l(t2) && (m2 = true);
    let _3 = this.get("renderer").gridCount(), x2 = this._adjustMinMax(i, a, _3, m2);
    i = x2.min, a = x2.max, x2 = this._adjustMinMax(i, a, _3, true), i = x2.min, a = x2.max, g2 && (i = l(e2) ? e2 : this._minReal, a = l(t2) ? t2 : this._maxReal, a - i <= 1e-8 && (i -= this._deltaMinMax, a += this._deltaMinMax), i -= (a - i) * o2, a += (a - i) * r), c = this.adapters.fold("min", i), u2 = this.adapters.fold("max", a), l(c) && (i = c), l(u2) && (a = u2), l3 == 1 / 0 && (l3 = a - i);
  ...
  _adjustMinMax(e2, t2, i, a) {
    ...
    let o2 = e2, r = t2, l3 = t2 - e2;
    0 === l3 && (l3 = Math.abs(t2));
    let h = Math.log(Math.abs(l3)) * Math.LOG10E, d = Math.pow(10, Math.floor(h));
    d /= 10;
    let c = d;
    a && (c = 0), a ? (e2 = Math.floor(e2 / d) * d, t2 = Math.ceil(t2 / d) * d) : (e2 = Math.ceil(e2 / d) * d - c, t2 = Math.floor(t2 / d) * d + c), e2 < 0 && o2 >= 0 && (e2 = 0), t2 > 0 && r <= 0 && (t2 = 0), h = Math.log(Math.abs(l3)) * Math.LOG10E, d = Math.pow(10, Math.floor(h)), d /= 100;
    let u2 = Math.ceil(l3 / i / d) * d, g2 = Math.pow(10, Math.floor(Math.log(Math.abs(u2)) * Math.LOG10E)), p = Math.ceil(u2 / g2);
    ...
    let _3 = 0;
    g2 < 1 && (_3 = Math.round(Math.abs(Math.log(Math.abs(g2)) * Math.LOG10E)) + 1, u2 = ae(u2, _3));
    let b, x2 = Math.floor(e2 / u2);
    return e2 = ae(u2 * x2, _3), b = a ? Math.floor(t2 / u2) : Math.ceil(t2 / u2), b === x2 && b++, (t2 = ae(u2 * b, _3)) < r && (t2 += u2), e2 > o2 && (e2 -= u2), u2 = this.fixSmallStep(u2), { min: e2, max: t2, step: u2 };
  }
  getTooltipText(e2, t2) {
    const i = this.get("tooltipNumberFormat", this.get("numberFormat")), s2 = this.getNumberFormatter(), a = this.get("extraTooltipPrecision", 0), o2 = this.getPrivate("stepDecimalPlaces", 0) + a, r = ae(this.positionToValue(e2), o2);
  ...
  _syncAxes(e2, t2, i, a, o2, n2) {
    if (this.get("syncWithAxis")) {
      let r = Math.round(o2 - a) / n2, l3 = Math.round((t2 - e2) / i), h = this.get("renderer").gridCount();
      if (l(r) && l(l3)) {
        let s2 = false, a2 = 0, o3 = 0.01 * (t2 - e2), n3 = e2, l4 = t2, d = i;
        for (; 1 != s2; )
          if (s2 = this._checkSync(n3, l4, d, r), a2++, a2 > 500 && (s2 = true), s2)
            e2 = n3, t2 = l4, i = d;
          else {
            a2 / 3 == Math.round(a2 / 3) ? (n3 = e2 - o3 * a2, e2 >= 0 && n3 < 0 && (n3 = 0)) : (l4 = t2 + o3 * a2, l4 <= 0 && l4 > 0 && (l4 = 0));
            let i2 = this._adjustMinMax(n3, l4, h, true);
            n3 = i2.min, l4 = i2.max, d = i2.step;
          }
      }
    }
...
var _e = class extends me {
  ...
  updateTick(e2, i, a, o2) {
    if (e2) {
      ...
      const l3 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? (e2.set("y", Y), l3 || (r *= -1)) : (e2.set("y", 0), l3 && (r *= -1)), e2.set("draw", (e3) => {
  ...
  updateBullet(e2, t2, i) {
    if (e2) {
      ...
      if (a) {
        ...
        l(i) && i != t2 && (t2 += (i - t2) * o2);
        let n2 = this.axis.roundAxisPosition(t2, o2), r = this.axis._bullets[n2], l3 = -1;
        if (this.get("opposite") && (l3 = 1), e2.get("stacked"))
          if (r) {
            let e3 = r.get("sprite");
            e3 && a.set("y", e3.y() + e3.height() * l3);
          } else
            a.set("y", 0);
  ...
  updateTooltipBounds(e2) {
    ...
    this.get("opposite") ? t2 ? (l3 = "up", o2 = s2.y, r = i) : (l3 = "down", o2 = s2.y - i, r = i) : t2 ? (l3 = "down", o2 = s2.y - i, r = i) : (l3 = "up", o2 = s2.y, r = i);
    const h = { left: a, right: a + n2, top: o2, bottom: o2 + r }, d = e2.get("bounds");
    Gt(h, d) || (e2.set("bounds", h), e2.set("pointerOrientation", l3));
  }
};
...
var be = class extends me {
  ...
  updateTooltipBounds(e2) {
    ...
    this.get("opposite") ? t2 ? (l3 = "right", o2 = s2.x - i, r = i) : (l3 = "left", o2 = s2.x, r = i) : t2 ? (l3 = "left", o2 = s2.x, r = i) : (l3 = "right", o2 = s2.x - i, r = i);
...
var xe = class extends de {
  ...
  _startSegment(e2) {
    ...
    let d = this.get("xAxis"), c = this.get("yAxis"), u2 = this.get("baseAxis"), g2 = this.get("vcx", 1), p = this.get("vcy", 1), m2 = this._xField, _3 = this._yField, b = this._xOpenField, x2 = this._yOpenField;
    ...
    let I2 = false;
    (y2 || f || v2) && (I2 = true);
    const j = { points: D3, segments: A, stacked: y2, getOpen: I2, basePosX: w2, basePosY: P, fillVisible: F2, xField: m2, yField: _3, xOpenField: b, yOpenField: x2, vcx: g2, vcy: p, baseAxis: u2, xAxis: d, yAxis: c, locationX: C, locationY: S, openLocationX: O, openLocationY: X2, minDistance: Y2 };
    for (L = e2; L < i; L++) {
      this._dindex = L;
      const t3 = this._dataItems[L];
      let n3 = t3.get(m2), r2 = t3.get(_3);
      if (null == n3 || null == r2 ? a || (D3 = [], A.push(D3), j.points = D3) : this._getPoints(t3, j), T) {
      ...
      if (!a) {
        ...
        e3 && u2.shouldGap(t3, e3, s2, k2) && (D3 = [], A.push(D3), j.points = D3);
      }
    }
    o2.setRaw("userData", [e2, L]), l3.setRaw("userData", [e2, L]), L === t2 && this._endLine(D3, A[0][0]), l3 && this._drawStroke(l3, A), o2 && this._drawFill(o2, A), this.axisRanges.each((t3) => {
  ...
  _getPoints(e2, t2) {
    let i = t2.points, s2 = e2.get("locationX", t2.locationX), a = e2.get("locationY", t2.locationY), o2 = t2.xAxis.getDataItemPositionX(e2, t2.xField, s2, t2.vcx), n2 = t2.yAxis.getDataItemPositionY(e2, t2.yField, a, t2.vcy);
    if (this._shouldInclude(o2)) {
      const s3 = this.getPoint(o2, n2), a2 = [s3.x, s3.y];
      if (s3.x += this._x, s3.y += this._y, e2.set("point", s3), t2.fillVisible) {
        let i2 = o2, s4 = n2;
        if (t2.baseAxis === t2.xAxis ? s4 = t2.basePosY : t2.baseAxis === t2.yAxis && (i2 = t2.basePosX), t2.getOpen) {
          let a3 = e2.get(t2.xOpenField), o3 = e2.get(t2.yOpenField);
          if (null != a3 && null != o3) {
            let a4 = e2.get("openLocationX", t2.openLocationX), o4 = e2.get("openLocationY", t2.openLocationY);
            if (t2.stacked) {
              let n3 = e2.get("stackToItemX"), r2 = e2.get("stackToItemY");
              n3 ? (i2 = t2.xAxis.getDataItemPositionX(n3, t2.xField, a4, n3.component.get("vcx")), e(i2) && (i2 = t2.basePosX)) : i2 = t2.yAxis === t2.baseAxis ? t2.basePosX : t2.xAxis.getDataItemPositionX(e2, t2.xOpenField, a4, t2.vcx), r2 ? (s4 = t2.yAxis.getDataItemPositionY(r2, t2.yField, o4, r2.component.get("vcy")), e(s4) && (s4 = t2.basePosY)) : s4 = t2.xAxis === t2.baseAxis ? t2.basePosY : t2.yAxis.getDataItemPositionY(e2, t2.yOpenField, o4, t2.vcy);
            } else
              i2 = t2.xAxis.getDataItemPositionX(e2, t2.xOpenField, a4, t2.vcx), s4 = t2.yAxis.getDataItemPositionY(e2, t2.yOpenField, o4, t2.vcy);
          }
        }
      ...
      if (t2.minDistance > 0) {
        const e3 = a2[0], s4 = a2[1], o3 = a2[2], n3 = a2[3], r = this._previousPoint, l3 = r[0], h = r[1], d = r[2], c = r[3];
        (Math.hypot(e3 - l3, s4 - h) > t2.minDistance || o3 && n3 && Math.hypot(o3 - d, n3 - c) > t2.minDistance) && (i.push(a2), this._previousPoint = a2);
      } else
        i.push(a2);
    }
  }
...
var u = class _u extends de {
  ...
  _updateChildren() {
    ...
    const l3 = e2.get("renderer"), g2 = s2.get("renderer"), d = "cellStartLocation", c = "cellEndLocation", m2 = l3.get(d, 0), p = l3.get(c, 1), x2 = g2.get(d, 0), _3 = g2.get(c, 1);
    if (this._aLocationX0 = m2 + n2 / r * (p - m2), this._aLocationX1 = m2 + (n2 + 1) / r * (p - m2), this._aLocationY0 = x2 + n2 / r * (_3 - x2), this._aLocationY1 = x2 + (n2 + 1) / r * (_3 - x2), e2.inited && s2.inited) {
  ...
  _updateGraphics(t2, e2) {
    ...
    const n2 = this._xField, r = this._yField, h = t2.get(n2), l3 = t2.get(r);
    if (null != h && null != l3) {
      const h2 = this._xOpenField, l4 = this._yOpenField, g2 = this.get("locationX", t2.get("locationX", 0.5)), d = this.get("locationY", t2.get("locationY", 0.5)), c = this.get("openLocationX", t2.get("openLocationX", g2)), m2 = this.get("openLocationY", t2.get("openLocationY", d)), p = a.get("width"), u2 = a.get("height"), x2 = this.get("stacked"), _3 = this.get("xAxis"), I2 = this.get("yAxis"), f = this.get("baseAxis"), y2 = _3.get("start"), P = _3.get("end"), b = I2.get("start"), v2 = I2.get("end");
      let D3, T, A, C, w2 = this.get("vcy", 1), k2 = this.get("vcx", 1), F2 = false, M = false;
      if (I2.isType("CategoryAxis") && _3.isType("CategoryAxis")) {
        let e3 = this._aLocationX0 + c - 0.5, i = this._aLocationX1 + g2 - 0.5;
        if (p instanceof K) {
          let t3 = (i - e3) * (1 - p.value) / 2;
          e3 += t3, i -= t3;
        }
        if (D3 = _3.getDataItemPositionX(t2, h2, e3, k2), T = _3.getDataItemPositionX(t2, n2, i, k2), e3 = this._aLocationY0 + m2 - 0.5, i = this._aLocationY1 + d - 0.5, u2 instanceof K) {
          let t3 = (i - e3) * (1 - u2.value) / 2;
          e3 += t3, i -= t3;
        }
        A = I2.getDataItemPositionY(t2, l4, e3, w2), C = I2.getDataItemPositionY(t2, r, i, w2), t2.setRaw("point", { x: D3 + (T - D3) / 2, y: A + (C - A) / 2 });
      } else if (_3 === f) {
        let e3 = this._aLocationX0 + c - 0.5, i = this._aLocationX1 + g2 - 0.5;
        if (p instanceof K) {
          let t3 = (i - e3) * (1 - p.value) / 2;
        ...
        if (D3 = _3.getDataItemPositionX(t2, h2, e3, k2), T = _3.getDataItemPositionX(t2, n2, i, k2), A = I2.getDataItemPositionY(t2, r, d, w2), this._yOpenField !== this._yField)
          C = I2.getDataItemPositionY(t2, l4, m2, w2);
        else if (x2) {
          let e4 = t2.get("stackToItemY");
          C = e4 ? I2.getDataItemPositionY(e4, r, m2, e4.component.get("vcy")) : I2.basePosition();
        } else
          C = I2.basePosition();
        t2.setRaw("point", { x: D3 + (T - D3) / 2, y: A }), M = true;
      } else if (I2 === f) {
        let e3 = this._aLocationY0 + m2 - 0.5, i = this._aLocationY1 + d - 0.5;
        if (u2 instanceof K) {
          let t3 = (i - e3) * (1 - u2.value) / 2;
          e3 += t3, i -= t3;
        }
        if (A = I2.getDataItemPositionY(t2, l4, e3, w2), C = I2.getDataItemPositionY(t2, r, i, w2), T = _3.getDataItemPositionX(t2, n2, g2, k2), this._xOpenField !== this._xField)
          D3 = _3.getDataItemPositionX(t2, h2, c, k2);
        else if (x2) {
          let e4 = t2.get("stackToItemX");
          D3 = e4 ? _3.getDataItemPositionX(e4, n2, c, e4.component.get("vcx")) : _3.basePosition();
        } else
          D3 = _3.basePosition();
        F2 = true, t2.setRaw("point", { x: T, y: A + (C - A) / 2 });
      }
      this._updateSeriesGraphics(t2, a, D3, T, A, C, F2, M), D3 < y2 && T < y2 || D3 > P && T > P || A < b && C <= b || A >= v2 && C > v2 || e(D3) || e(A) ? this._toggleColumn(t2, false) : this._toggleColumn(t2, true);
      let X2 = t2.get("rangeGraphics");
      X2 && m(X2, (e3) => {
        this._updateSeriesGraphics(t2, e3, D3, T, A, C, F2, M);
      }), this._applyGraphicsStates(t2, e2);
    }
  }
  _updateSeriesGraphics(t2, e2, i, s2, a, o2, r, h) {
    const l3 = e2.get("width"), g2 = e2.get("height"), d = e2.get("maxWidth"), c = e2.get("maxHeight"), m2 = this.getPoint(i, a), p = this.getPoint(s2, o2), u2 = t2.get("point");
    if (u2) {
      const t3 = this.getPoint(u2.x, u2.y);
      u2.x = t3.x + this._x, u2.y = t3.y + this._y;
    }
    if (i = m2.x, s2 = p.x, a = m2.y, o2 = p.y, l(l3)) {
      const t3 = (s2 - i - l3) / 2;
      i += t3, s2 -= t3;
    }
  ...
  _applyGraphicsStates(t2, e2) {
    ...
    if (s2 || o2 || a || r) {
      const i2 = this.get("xAxis"), h = this.get("yAxis"), l3 = this.get("baseAxis");
      let g2, d, c;
      l3 === i2 && h.isType("ValueAxis") ? (g2 = t2.get(this._yOpenField), d = t2.get(this._yField), c = e2.get(this._yField)) : l3 === h && i2.isType("ValueAxis") && (g2 = t2.get(this._xOpenField), d = t2.get(this._xField), c = e2.get(this._xField)), l(g2) && l(d) && (d < g2 ? s2 && s2.apply() : a && a.apply(), l(c) && (d < c ? o2 && o2.apply() : r && r.apply()));
    }
  }
  disposeDataItem(t2) {
  ...
  hideDataItem(t2, e2) {
    ...
    return t(this, void 0, void 0, function* () {
      const a = [s2.hideDataItem.call(this, t2, e2)], o2 = t2.get("graphics");
      o2 && a.push(o2.hide(e2));
      const n2 = t2.get("rangeGraphics");
      n2 && m(n2, (t3) => {
        a.push(t3.hide(e2));
      }), yield Promise.all(a);
    });
  ...
  showDataItem(t2, e2) {
    ...
    return t(this, void 0, void 0, function* () {
      const a = [s2.showDataItem.call(this, t2, e2)], o2 = t2.get("graphics");
...
var x = class _x extends ce {
  ...
  _handleRangeChange() {
    m(this.series, (t2) => {
      ...
      if (o2 instanceof _x && n2 instanceof _x)
        t2._markDirtyAxes();
      else if (a === this) {
        let r, h, l3 = n2;
        if (o2 === a ? (t2.get("categoryXField") && (r = "categoryX"), t2.get("openCategoryXField") && (h = "openCategoryX")) : n2 === a && (t2.get("categoryYField") && (r = "categoryY"), t2.get("openCategoryYField") && (h = "openCategoryY"), l3 = o2), "ValueAxis" == l3.className && (r || h)) {
          let a2, o3;
          ...
          let n3 = 0, l4 = t2.dataItems.length;
          a2 && (n3 = t2.dataItems.indexOf(a2)), o3 && (l4 = t2.dataItems.indexOf(o3) + 1), t2.setPrivate("startIndex", n3), t2.setPrivate("endIndex", l4);
          let g2 = false;
          for (let e3 = n3; e3 < l4; e3++) {
  ...
  _prepareDataItem(t2, e2, i) {
    ...
    let h, l3 = this.indexToPosition(r, a), g2 = t2.get("endCategory");
    g2 ? (h = this.categoryToIndex(g2), l(h) || (h = r)) : h = r;
    let d, c, m2 = this.indexToPosition(h, o2);
    d = t2.get("isRange") ? h : r + this._frequency - 1, c = this.indexToPosition(d, o2), s2.updateLabel(t2.get("label"), l3, m2, i), s2.updateGrid(t2.get("grid"), l3, m2), s2.updateTick(t2.get("tick"), l3, m2, i), s2.updateFill(t2.get("axisFill"), l3, c), this._processBullet(t2), s2.updateBullet(t2.get("bullet"), l3, m2);
  ...
  axisPositionToIndex(t2) {
    ...
    return he(Math.floor(t2 * e2), 0, e2 - 1);
  }
...
Object.defineProperty(_2, "className", { enumerable: true, configurable: true, writable: true, value: "ColumnSeries" }), Object.defineProperty(_2, "classNames", { enumerable: true, configurable: true, writable: true, value: u.classNames.concat([_2.className]) });
export {
  _e as AxisRendererXAm5,
  be as AxisRendererYAm5,
  x as CategoryAxisAm5,
  _2 as ColumnSeriesAm5,
  xe as LineSeriesAm5,
  ue as ValueAxisAm5,
  oe2 as XYChartAm5,
  re as XYCursorAm5
};
//# sourceMappingURL=xyChart-RXURJBAA.js.map
