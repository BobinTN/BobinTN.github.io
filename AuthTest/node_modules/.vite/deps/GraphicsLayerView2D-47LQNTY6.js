...
var n = class extends m(u2) {
  ...
  highlight(i2) {
    let r;
    "number" == typeof i2 ? r = [i2] : i2 instanceof c2 ? r = [i2.uid] : Array.isArray(i2) && i2.length > 0 ? r = "number" == typeof i2[0] ? i2 : i2.map((i3) => i3 && i3.uid) : V.isCollection(i2) && i2.length > 0 && (r = i2.map((i3) => i3 && i3.uid).toArray());
    const a = r == null ? void 0 : r.filter(k);
...
//# sourceMappingURL=GraphicsLayerView2D-47LQNTY6.js.map
