...
function c(t2) {
  ...
  if (d3 = s3(t2, d3, h3), d3 = s3(t2, d3, w3), d3 = s3(t2, d3, g), d3 = s3(t2, d3, p), d3 !== t2.byteLength)
...
function s3(e2, t2, o2) {
  const r2 = [];
  t2 = d(e2, t2, r2);
  const n2 = [];
  for (let i2 = 0; i2 < r2.length; i2++) {
    n2.length = 0, t2 = d(e2, t2, n2);
...
function d(o2, r2, n2) {
  ...
  for (let e2 = 0; e2 < a4; e2++) {
    for (; w3 < s5; )
      h3 |= f3[g] << w3, w3 += 8, g += 1;
    n2[e2] = h3 & p, h3 >>>= s5, w3 -= s5, w3 + s5 > 32 && (h3 |= f3[g - 1] >> 8 - w3);
  }
  return r2 + g;
}
...
function u(t2) {
  ...
  if (d3.lookupMethod <= 2 && 1 === d3.compressionMethod) {
    ...
    for (let e2 = 0; e2 < d3.count; e2++)
      s6[3 * e2] = o2, s6[3 * e2 + 1] = r2, s6[3 * e2 + 2] = c4;
    return s6;
  }
...
function s4(e2, t2) {
  ...
  for (let o2 = 0; o2 < t2.length; o2++) {
    ...
    n2.fields[i2.property] = a4(e2, r2), r2 += h2[u3].BYTES_PER_ELEMENT;
  }
  return n2.byteCount = r2, n2;
}
function c2(e2, t2, n2) {
  return f2(e2, t2, n2).map((e3) => {
...
function w2(e2, t2) {
  ...
  for (const s5 of t2.ordering) {
    if (!t2.vertexAttributes[s5])
      continue;
    const e3 = { ...t2.vertexAttributes[s5], byteOffset: r2, count: u3 }, n3 = C[s5] || "_" + s5;
    o2.vertexAttributes[n3] = e3, r2 += E(e3.valueType) * e3.valuesPerElement * u3;
  }
  ...
  if (t2.faces && a4) {
    ...
    for (const e3 of t2.ordering) {
      if (!t2.faces[e3])
        continue;
      const n3 = { ...t2.faces[e3], byteOffset: r2, count: a4 };
      o2.faces[e3] = n3, r2 += E(n3.valueType) * n3.valuesPerElement * a4;
    }
  }
  ...
  if (t2.featureAttributes && t2.featureAttributeOrder && c3) {
    ...
    for (const e3 of t2.featureAttributeOrder) {
      if (!t2.featureAttributes[e3])
        continue;
      const n3 = { ...t2.featureAttributes[e3], byteOffset: r2, count: c3 };
...
function I(t2, n2, i2) {
  ...
  if (s5) {
    if ("String" === s5.valueType) {
      const e2 = a4.entries.attributeByteCounts, t3 = l2(n2, e2), r2 = d2(n2, s5);
      return s5.timeEncoding ? c2(e2.count, t3, r2) : f2(e2.count, t3, r2);
    }
    return l2(n2, s5);
  }
...
//# sourceMappingURL=chunk-A5EZPHEN.js.map
