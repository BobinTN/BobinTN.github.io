...
var l = class extends W {
  ...
  isUpdating() {
    var _a;
    const e2 = this.layer.sublayers.some((e3) => null != e3.renderer), r = this._commandsQueue.updating, s = null != this._updatingRequiredFieldsPromise, i = !this._proxy || !this._proxy.isReady, t = this._pipelineIsUpdating, a = null == this.tileRenderer || ((_a = this.tileRenderer) == null ? void 0 : _a.updating), n2 = e2 && (r || s || i || t || a);
...
//# sourceMappingURL=SubtypeGroupLayerView2D-3CJS2HIH.js.map
