...
function r(e, o) {
  const r2 = e.toJSON();
  return r2.objectIds && (r2.objectIds = r2.objectIds.join(",")), r2.orderByFields && (r2.orderByFields = r2.orderByFields.join(",")), r2.outFields && !(o == null ? void 0 : o.returnCountOnly) ? r2.outFields.includes("*") ? r2.outFields = "*" : r2.outFields = r2.outFields.join(",") : delete r2.outFields, r2.outSR && (r2.outSR = T(r2.outSR)), r2.dynamicDataSource && (r2.layer = JSON.stringify({ source: r2.dynamicDataSource }), delete r2.dynamicDataSource), r2;
}
async function s(e, t2, o) {
  const r2 = await a(e, t2, o), s2 = r2.data, n3 = s2.geometryType, d3 = s2.spatialReference, c = {};
...
async function a(t2, s2, n3 = {}, a2) {
  ...
  return j(t2.path + "/queryRelatedRecords", { ...n3, query: { ...n3.query, ...d3 } });
}
...
//# sourceMappingURL=executeRelationshipQuery-NB7EMWHX.js.map
