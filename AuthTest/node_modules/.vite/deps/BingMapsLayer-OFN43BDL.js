...
var h;
var d = new t("0/0/0", 0, 0, 0, void 0);
var g = h = class extends a(t2(f2(b))) {
  constructor() {
  ...
  fetchTile(e2, r, o2, s3 = {}) {
    const { signal: i } = s3, a2 = this.getTileUrl(e2, r, o2), p2 = { responseType: "image", signal: i, query: { ...this.refreshParameters } };
    return j(a2 ?? "", p2).then((e3) => e3.data);
  }
  async fetchImageBitmapTile(e2, r, o2, s3 = {}) {
    ...
    const a2 = this.getTileUrl(e2, r, o2) ?? "", p2 = { responseType: "blob", signal: i, query: { ...this.refreshParameters } }, { data: l } = await j(a2, p2);
    return o(l, e2, r, o2, i);
  }
  getTileUrl() {
    throw new s("basetilelayer:gettileurl-not-implemented", "getTileUrl() is not implemented");
  }
};
e([y({ type: j2 })], g.prototype, "tileInfo", void 0), e([y({ type: ["show", "hide"] })], g.prototype, "listMode", void 0), e([y({ readOnly: true, value: "base-tile" })], g.prototype, "type", void 0), e([y({ nonNullable: true })], g.prototype, "fullExtent", void 0), e([y()], g.prototype, "spatialReference", void 0), g = h = e([c("esri.layers.BaseTileLayer")], g);
var j3 = g;
...
var h2 = class extends a(u2(m(j3))) {
  ...
  getTileUrl(e2, t3, r) {
    if (!this.loaded || null == this.bingMetadata)
      return null;
    const o2 = this.bingMetadata.resourceSets[0].resources[0], a2 = o2.imageUrlSubdomains[t3 % o2.imageUrlSubdomains.length], s3 = this._getQuadKey(e2, t3, r);
    return o2.imageUrl.replace("{subdomain}", a2).replace("{quadkey}", s3);
  }
  ...
  _getMetadata() {
    ...
    return j(`${m2}/REST/v1/Imagery/Metadata/${e2}`, { responseType: "json", query: { include: "ImageryProviders", uriScheme: "https", key: this.key, suppressStatus: true, output: "json", culture: this.culture, userRegion: this.region } }).then((e3) => {
      const t3 = e3.data;
