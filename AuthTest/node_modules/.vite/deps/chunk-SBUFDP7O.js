...
async function u(a, n) {
  ...
  try {
    const { data: e } = await j(i2, { ...n, responseType: "image" });
    return e;
  } catch (o2) {
    if (!b(o2))
...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-6Z34IKWL.js");
    if (t3(r))
      return a2(r, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-ZR7R3QJU.js");
    if (t3(r))
      return a2(r, e);
  }
...
async function d(e, r) {
  ...
  const o2 = await j(e, { responseType: "array-buffer", ...r });
...
//# sourceMappingURL=chunk-SBUFDP7O.js.map
