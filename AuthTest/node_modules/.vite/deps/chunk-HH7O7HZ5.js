...
function l2(e2, r, t2) {
  ...
  if (e2)
    for (let a2 = 0, i = e2.length; a2 < i; a2++) {
      if (s2 = e2.at(a2), (s2 == null ? void 0 : s2[r]) === t2)
        return s2;
      if ("group" === (s2 == null ? void 0 : s2.type) && (o = l2(s2.layers, r, t2), o))
        return o;
    }
}
var d = (d2) => {
  let y2 = class extends d2 {
    constructor(...e2) {
      ...
      this.addHandles([this.layers.on("before-add", (e3) => t2(e3.item)), this.layers.on("after-add", (e3) => o(e3.item)), this.layers.on("after-remove", (e3) => a2(e3.item))]);
    }
    destroy() {
    ...
    findLayerById(e2) {
      return l2(this.layers, "id", e2);
    }
    findLayerByUid(e2) {
      return l2(this.layers, "uid", e2);
    }
    remove(e2) {
  ...
  return e([y()], y2.prototype, "layers", null), y2 = e([c("esri.support.LayersMixin")], y2), y2;
};
...
var l3 = (l4) => {
  ...
  return e([y()], n3.prototype, "tables", null), n3 = e([c("esri.support.TablesMixin")], n3), n3;
};
...
//# sourceMappingURL=chunk-HH7O7HZ5.js.map
