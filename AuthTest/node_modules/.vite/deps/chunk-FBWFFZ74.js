...
var i = class extends n {
  ...
  prepareRenderPasses(r) {
    ...
    return n3.push(r.registerRenderPass({ name: "stencil", brushes: [c], drawPhase: T.DEBUG | T.MAP | T.HIGHLIGHT, target: () => this.getStencilTarget() })), has("esri-tiles-debug") && n3.push(r.registerRenderPass({ name: "tileInfo", brushes: [p], drawPhase: T.DEBUG, target: () => this.children })), n3;
  }
  getStencilTarget() {
...
//# sourceMappingURL=chunk-FBWFFZ74.js.map
