...
function nt(t, s2, a3, n3) {
  const o = ot;
  return o[0] = a3[0], o[3] = a3[1], o[6] = a3[2], o[1] = n3[0], o[4] = n3[1], o[7] = n3[2], o[2] = -s2[0], o[5] = -s2[1], o[8] = -s2[2], J(t, S(t, o));
}
var ot = e();
var rt = Object.freeze(Object.defineProperty({ __proto__: null, add: D2, calculateW: z2, conjugate: O, copy: B, dot: R, equals: N, exactEquals: K, fromEuler: T, fromMat3: S, getAxisAngle: x2, identity: P2, invert: L, len: Y2, length: X, lerp: W, mul: F, multiply: y2, normalize: J, random: k, rotateX: A, rotateY: I, rotateZ: _2, rotationTo: Q, scale: G, set: C, setAxes: nt, setAxisAngle: v2, slerp: E2, sqlerp: tt, sqrLen: H, squaredLength: Z, str: w }, Symbol.toStringTag, { value: "Module" }));
...
//# sourceMappingURL=chunk-JYYKU27J.js.map
