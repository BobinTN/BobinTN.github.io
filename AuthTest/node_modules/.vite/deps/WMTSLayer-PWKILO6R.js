...
e([y({ type: M, json: { read: { source: "fullExtent" } } })], n.prototype, "fullExtent", void 0), e([y({ type: String, json: { read: { source: "id" } } })], n.prototype, "id", void 0), e([y({ type: j2, json: { read: { source: "tileInfo" } } })], n.prototype, "tileInfo", void 0), n = l = e([c("esri.layer.support.TileMatrixSet")], n);
var p3 = n;
...
e([y({ json: { read: { source: "id" } } })], i.prototype, "id", void 0), e([y({ json: { read: { source: "title" } } })], i.prototype, "title", void 0), e([y({ json: { read: { source: "abstract" } } })], i.prototype, "description", void 0), e([y({ json: { read: { source: "legendUrl" } } })], i.prototype, "legendUrl", void 0), e([y({ json: { read: { source: "isDefault" } } })], i.prototype, "isDefault", void 0), e([y({ json: { read: { source: "keywords" } } })], i.prototype, "keywords", void 0), i = o5 = e([c("esri.layer.support.WMTSStyle")], i);
var p4 = i;
...
var m2 = p5 = class extends f {
  ...
  clone() {
    var _a, _b, _c;
    const t3 = new p5();
    return this.hasOwnProperty("description") && (t3.description = this.description), this.hasOwnProperty("imageFormats") && (t3.imageFormats = this.imageFormats && this.imageFormats.slice()), this.hasOwnProperty("imageFormat") && (t3.imageFormat = this.imageFormat), this.hasOwnProperty("fullExtent") && (t3.fullExtent = (_a = this.fullExtent) == null ? void 0 : _a.clone()), this.hasOwnProperty("id") && (t3.id = this.id), this.hasOwnProperty("layer") && (t3.layer = this.layer), this.hasOwnProperty("styleId") && (t3.styleId = this.styleId), this.hasOwnProperty("styles") && (t3.styles = (_b = this.styles) == null ? void 0 : _b.clone()), this.hasOwnProperty("tileMatrixSetId") && (t3.tileMatrixSetId = this.tileMatrixSetId), this.hasOwnProperty("tileMatrixSets") && (t3.tileMatrixSets = (_c = this.tileMatrixSets) == null ? void 0 : _c.clone()), this.hasOwnProperty("title") && (t3.title = this.title), t3;
  }
};
e([y()], m2.prototype, "description", void 0), e([y()], m2.prototype, "fullExtent", void 0), e([o("fullExtent", ["fullExtent"])], m2.prototype, "readFullExtent", null), e([y({ readOnly: true })], m2.prototype, "fullExtents", void 0), e([o("fullExtents", ["fullExtents", "tileMatrixSets"])], m2.prototype, "readFullExtents", null), e([y()], m2.prototype, "id", void 0), e([y()], m2.prototype, "imageFormat", null), e([y({ json: { read: { source: "formats" } } })], m2.prototype, "imageFormats", void 0), e([y()], m2.prototype, "layer", void 0), e([y()], m2.prototype, "parent", void 0), e([y()], m2.prototype, "styleId", null), e([y({ type: V.ofType(p4), json: { read: { source: "styles" } } })], m2.prototype, "styles", void 0), e([y({ json: { write: { ignoreOrigin: true } } })], m2.prototype, "title", void 0), e([y()], m2.prototype, "tileMatrixSetId", void 0), e([y({ readOnly: true })], m2.prototype, "tileMatrixSet", null), e([y({ type: V.ofType(p3), json: { read: { source: "tileMatrixSets" } } })], m2.prototype, "tileMatrixSets", void 0), m2 = p5 = e([c("esri.layers.support.WMTSSublayer")], m2);
var u2 = m2;

// node_modules/@arcgis/core/layers/support/wmtsUtils.js
var u3 = 90.71428571428571;
function p6(e3) {
...
function f3(e3, n2) {
  ...
  const i2 = new DOMParser().parseFromString(e3, "text/xml").documentElement, r3 = /* @__PURE__ */ new Map(), l2 = /* @__PURE__ */ new Map(), o6 = g("Contents", i2);
  if (!o6)
    throw new s("wmtslayer:wmts-capabilities-xml-is-not-valid");
  const s2 = g("OperationsMetadata", i2), a4 = s2 == null ? void 0 : s2.querySelector("[name='GetTile']"), c2 = a4 == null ? void 0 : a4.getElementsByTagName("Get"), u4 = c2 && Array.prototype.slice.call(c2), p7 = (_a = n2.url) == null ? void 0 : _a.indexOf("https"), f4 = void 0 !== p7 && p7 > -1;
  let d3, m4, h2 = n2.serviceMode, T2 = n2 == null ? void 0 : n2.url;
  if ((u4 == null ? void 0 : u4.length) && u4.some((e4) => {
    const t3 = g("Constraint", e4);
    return !t3 || C2("AllowedValues", "Value", h2, t3) ? (T2 = e4.attributes[0].nodeValue, true) : (!t3 || C2("AllowedValues", "Value", "RESTful", t3) || C2("AllowedValues", "Value", "REST", t3) ? m4 = e4.attributes[0].nodeValue : t3 && !C2("AllowedValues", "Value", "KVP", t3) || (d3 = e4.attributes[0].nodeValue), false);
  }), !T2)
    if (m4)
      T2 = m4, h2 = "RESTful";
    else if (d3)
  ...
  -1 === y3 && "RESTful" === h2 ? T2 += "/" : y3 > -1 && (T2 = T2.substring(0, y3)), "KVP" === h2 && (T2 += y3 > -1 ? "" : "?"), f4 && (T2 = T2.replace(/^http:/i, "https:"));
  const R2 = w("ServiceIdentification>ServiceTypeVersion", i2), S2 = w("ServiceIdentification>AccessConstraints", i2), A3 = S2 && /^none$/i.test(S2) ? null : S2, V4 = x2("Layer", o6), b3 = x2("TileMatrixSet", o6), E2 = V4.map((e4) => {
    const t3 = w("Identifier", e4);
    return r3.set(t3, e4), M2(t3, e4, b3, f4, R2);
  });
  return { copyright: A3, dimensionMap: l2, layerMap: r3, layers: E2, serviceMode: h2, tileUrl: T2 };
}
function d2(e3) {
  return e3.layers.forEach((e4) => {
    ...
    (_a = e4.tileMatrixSets) == null ? void 0 : _a.forEach((e5) => {
      ...
      t3 && 96 !== t3.dpi && ((_a2 = t3.lods) == null ? void 0 : _a2.forEach((n2) => {
        var _a3;
        n2.scale = 96 * n2.scale / t3.dpi, n2.resolution = j4((_a3 = t3.spatialReference) == null ? void 0 : _a3.wkid, n2.scale * u3 / 96, e5.id);
      }), t3.dpi = 96);
    });
  }), e3;
}
...
function x2(e3, t3) {
  ...
  for (let i2 = 0; i2 < t3.childNodes.length; i2++) {
    ...
    m3(r3) && r3.nodeName === e3 && n2.push(r3);
  }
  return n2;
}
function h(t3, n2) {
  ...
  for (let e3 = 0; e3 < n2.childNodes.length; e3++) {
    ...
    m3(r3) && r3.nodeName === t3 && i2.push(r3);
  }
  return i2.map((e3) => e3.textContent).filter(k);
}
function w(e3, t3) {
...
function C2(e3, t3, n2, i2) {
  ...
  return Array.prototype.slice.call(i2.childNodes).some((i3) => {
    if (i3.nodeName.includes(e3)) {
      const e4 = g(t3, i3), l2 = e4 == null ? void 0 : e4.textContent;
      if (l2 === n2 || n2.split(":") && n2.split(":")[1] === l2)
        return r3 = i3, true;
    }
    return false;
  }), r3;
...
function M2(e3, t3, n2, i2, r3) {
  const l2 = w("Abstract", t3), o6 = h("Format", t3);
  return { id: e3, fullExtent: A2(t3), fullExtents: V2(t3), description: l2, formats: o6, styles: b2(t3, i2), title: w("Title", t3), tileMatrixSets: E(r3, t3, n2) };
}
function T(e3, t3) {
  var _a;
  ...
  if (!i2)
    return null;
  const r3 = x2("ResourceURL", i2), l2 = x2("Dimension", i2);
  let o6, s2, a4, c2;
  return l2.length && (o6 = w("Identifier", l2[0]), s2 = h("Default", l2[0]) || h("Value", l2[0])), l2.length > 1 && (a4 = w("Identifier", l2[1]), c2 = h("Default", l2[1]) || h("Value", l2[1])), e3.dimensionMap.set(t3, { dimensions: s2, dimensions2: c2 }), r3.forEach((e4) => {
    ...
    if ("tile" === e4.getAttribute("resourceType")) {
      ...
      if (a4 && c2.length)
        if (t4.includes("{" + a4 + "}"))
          t4 = t4.replace("{" + a4 + "}", "{dimensionValue2}");
        else {
...
function y2(e3, t3, n2, i2, r3, l2, o6, s2) {
  var _a, _b;
  const a4 = R(e3, t3, i2);
  if (!((a4 == null ? void 0 : a4.length) > 0))
    return "";
  const { dimensionMap: c2 } = e3, u4 = (_a = c2.get(t3).dimensions) == null ? void 0 : _a[0], p7 = (_b = c2.get(t3).dimensions2) == null ? void 0 : _b[0];
  return a4[o6 % a4.length].template.replaceAll(/\{Style\}/gi, r3 ?? "").replaceAll(/\{TileMatrixSet\}/gi, n2 ?? "").replaceAll(/\{TileMatrix\}/gi, l2).replaceAll(/\{TileRow\}/gi, "" + o6).replaceAll(/\{TileCol\}/gi, "" + s2).replaceAll(/\{dimensionValue\}/gi, u4).replaceAll(/\{dimensionValue2\}/gi, p7);
}
function R(e3, t3, n2) {
...
function S(e3, t3, n2, i2) {
  var _a, _b;
  const { dimensionMap: r3 } = e3, l2 = T(e3, t3);
  let o6 = "";
  if (l2 && l2.length > 0) {
    const e4 = (_a = r3.get(t3).dimensions) == null ? void 0 : _a[0], s2 = (_b = r3.get(t3).dimensions2) == null ? void 0 : _b[0];
    o6 = l2[0].template, o6.indexOf(".xxx") === o6.length - 4 && (o6 = o6.slice(0, -4)), o6 = o6.replaceAll(/\{Style\}/gi, i2), o6 = o6.replaceAll(/\{TileMatrixSet\}/gi, n2), o6 = o6.replaceAll(/\{TileMatrix\}/gi, "{level}"), o6 = o6.replaceAll(/\{TileRow\}/gi, "{row}"), o6 = o6.replaceAll(/\{TileCol\}/gi, "{col}"), o6 = o6.replaceAll(/\{dimensionValue\}/gi, e4), o6 = o6.replaceAll(/\{dimensionValue2\}/gi, s2);
  }
  return o6;
}
function A2(e3) {
...
function V2(e3) {
  ...
  return o2(e3, { BoundingBox: (e4) => {
    ...
    o2(e4, { LowerCorner: (e5) => {
      [l2, a4] = e5.textContent.split(" ").map((e6) => Number.parseFloat(e6)), r3 && ([l2, a4] = [a4, l2]);
    }, UpperCorner: (e5) => {
      [c2, u4] = e5.textContent.split(" ").map((e6) => Number.parseFloat(e6)), r3 && ([c2, u4] = [u4, c2]);
    } }), t3.push({ xmin: l2, ymin: a4, xmax: c2, ymax: u4, spatialReference: i2 });
  } }), t3;
}
function b2(e3, t3) {
  return x2("Style", e3).map((e4) => {
    const n2 = g("LegendURL", e4), i2 = g("Keywords", e4), r3 = i2 ? h("Keyword", i2) : [];
    let l2 = n2 && n2.getAttribute("xlink:href");
    t3 && (l2 = l2 && l2.replace(/^http:/i, "https:"));
    return { abstract: w("Abstract", e4), id: w("Identifier", e4), isDefault: "true" === e4.getAttribute("isDefault"), keywords: r3, legendUrl: l2, title: w("Title", e4) };
  });
}
function E(e3, t3, n2) {
  return x2("TileMatrixSetLink", t3).map((t4) => L(e3, t4, n2));
}
function L(e3, t3, n2) {
  const i2 = g("TileMatrixSet", t3).textContent, r3 = h("TileMatrix", t3), l2 = n2.find((e4) => {
    const t4 = g("Identifier", e4), n3 = t4 == null ? void 0 : t4.textContent;
    return !!(n3 === i2 || i2.split(":") && i2.split(":")[1] === n3);
  }), o6 = g("TileMatrixSetLimits", t3), s2 = o6 && x2("TileMatrixLimits", o6), a4 = /* @__PURE__ */ new Map();
  if (s2 == null ? void 0 : s2.length)
    for (const c2 of s2) {
      ...
      a4.set(e4, { minCol: i3, maxCol: r4, minRow: t4, maxRow: n3 });
    }
  const u4 = w("SupportedCRS", l2).toLowerCase(), p7 = N(l2, u4), f4 = p7.spatialReference, d3 = g("TileMatrix", l2), m4 = [parseInt(w("TileWidth", d3), 10), parseInt(w("TileHeight", d3), 10)], M3 = [];
  if (r3.length)
    r3.forEach((e4, t4) => {
      const n3 = C2("TileMatrix", "Identifier", e4, l2);
      M3.push(k2(n3, u4, t4, i2, a4));
    });
  else {
    x2("TileMatrix", l2).forEach((e4, t4) => {
      M3.push(k2(e4, u4, t4, i2, a4));
    });
  }
  const T2 = F(e3, l2, p7, m4, M3[0]).toJSON(), y3 = new j2({ dpi: 96, spatialReference: f4, size: m4, origin: p7, lods: M3 }).toJSON();
...
function v3(e3, t3) {
  const n2 = I3(t3), [i2, l2] = w("TopLeftCorner", e3).split(" ").map((e4) => parseFloat(e4)), s2 = t3.includes("epsg") && o4(n2.wkid);
  return new x(s2 ? { x: l2, y: i2, spatialReference: n2 } : { x: i2, y: l2, spatialReference: n2 });
}
function F(e3, t3, n2, r3, l2) {
  const o6 = g("BoundingBox", t3);
  let s2, a4, c2, u4, p7, f4;
  if (o6 && (s2 = w("LowerCorner", o6).split(" "), a4 = w("UpperCorner", o6).split(" ")), s2 && s2.length > 1 && a4 && a4.length > 1)
    c2 = parseFloat(s2[0]), p7 = parseFloat(s2[1]), u4 = parseFloat(a4[0]), f4 = parseFloat(a4[1]);
  else {
    const e4 = g("TileMatrix", t3), i2 = parseInt(w("MatrixWidth", e4), 10), o7 = parseInt(w("MatrixHeight", e4), 10);
    c2 = n2.x, f4 = n2.y, u4 = c2 + i2 * r3[0] * l2.resolution, p7 = f4 - o7 * r3[1] * l2.resolution;
  }
  return O(e3, n2.spatialReference, n2) ? new M(p7, c2, f4, u4, n2.spatialReference) : new M(c2, p7, u4, f4, n2.spatialReference);
}
function O(e3, t3, n2) {
...
var U;
function D(e3) {
  return e3.includes("crs84") || e3.includes("crs:84") ? U.CRS84 : e3.includes("crs83") || e3.includes("crs:83") ? U.CRS83 : e3.includes("crs27") || e3.includes("crs:27") ? U.CRS27 : null;
}
function k2(e3, t3, n2, i2, r3) {
  const l2 = I3(t3), o6 = w("Identifier", e3);
  let s2 = parseFloat(w("ScaleDenominator", e3));
  const c2 = j4(l2.wkid, s2, i2);
  s2 *= 96 / u3;
  const p7 = +w("MatrixWidth", e3), f4 = +w("MatrixHeight", e3), { maxCol: d3 = p7 - 1, maxRow: m4 = f4 - 1, minCol: g2 = 0, minRow: x3 = 0 } = r3.get(o6) ?? {}, { x: h2, y: C3 } = v3(e3, t3);
  return new p({ cols: [g2, d3], level: n2, levelValue: o6, origin: [h2, C3], scale: s2, resolution: c2, rows: [x3, m4] });
}
function j4(e3, t3, i2) {
  let r3;
  return r3 = r.hasOwnProperty("" + e3) ? r.values[r[e3]] : "default028mm" === i2 ? 6370997 * Math.PI / 180 : A(e3).metersPerDegree, 7 * t3 / 25e3 / r3;
}
!function(e3) {
...
var B = W = class extends a3(f2(t2(u(j3(m(b)))))) {
  constructor(...e3) {
    ...
    }, C), v2(() => this.sublayers, "after-add", ({ item: e4 }) => {
      e4.layer = this, e4.parent = this;
    }, C), v2(() => this.sublayers, "after-remove", ({ item: e4 }) => {
  ...
  load(e3) {
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["WMTS"] }, e3).catch(a2).then(() => this._fetchService(e3)).catch((e4) => {
      throw a2(e4), new s("wmtslayer:unsupported-service-data", "Invalid response from the WMTS service.", { error: e4 });
    })), Promise.resolve(this);
  }
  readActiveLayerFromService(e3, t3, r3) {
    this.activeLayer || (this.activeLayer = new u2());
  ...
  readActiveLayerFromItemOrWebDoc(e3, t3) {
    const { templateUrl: r3, wmtsInfo: i2 } = t3, s2 = r3 ? this._getLowerCasedUrlParams(r3) : null, a4 = i2 == null ? void 0 : i2.layerIdentifier;
    let o6 = null;
    ...
    return new u2({ id: a4, imageFormat: n2, styleId: m4, tileMatrixSetId: o6 });
  }
  ...
  async fetchTile(e3, r3, i2, s2 = {}) {
    const { signal: a4 } = s2, o6 = this.getTileUrl(e3, r3, i2), { data: l2 } = await j(o6, { responseType: "image", signal: a4 });
    return l2;
  }
  async fetchImageBitmapTile(e3, r3, i2, s2 = {}) {
    ...
    if (this.fetchTile !== W.prototype.fetchTile) {
      ...
      return o3(t3, e3, r3, i2, a4);
    }
    const o6 = this.getTileUrl(e3, r3, i2), { data: l2 } = await j(o6, { responseType: "blob", signal: a4 });
    return o3(l2, e3, r3, i2, a4);
  }
  findSublayerById(e3) {
    var _a;
  ...
  getTileUrl(e3, t3, r3) {
    var _a;
    const i2 = this._getTileMatrixSetById(this.activeLayer.tileMatrixSetId), s2 = (_a = i2 == null ? void 0 : i2.tileInfo) == null ? void 0 : _a.lods[e3], a4 = s2 ? s2.levelValue || `${s2.level}` : `${e3}`;
    let o6 = this.resourceInfo ? "" : y2({ dimensionMap: this.dimensionMap, layerMap: this.layerMap }, this.activeLayer.id, this.activeLayer.tileMatrixSetId, this.activeLayer.imageFormat, this.activeLayer.styleId, a4, t3, r3);
    if (!o6) {
  ...
  async _fetchService(e3) {
    ...
    if (this.resourceInfo)
      ...
      try {
        t3 = await this._getCapabilities(this.serviceMode, e3), p6(t3.data);
      } catch {
        const i2 = "KVP" === this.serviceMode ? "RESTful" : "KVP";
        try {
          t3 = await this._getCapabilities(i2, e3), p6(t3.data), this.serviceMode = i2;
        } catch (r3) {
  ...
  _appendParameters(e3, t3) {
    const r3 = I(e3), i2 = { ...r3.query, ...t3 }, s2 = v(i2);
...
e([y()], B.prototype, "dimensionMap", void 0), e([y()], B.prototype, "layerMap", void 0), e([y({ type: u2, json: { origins: { "web-document": { write: { ignoreOrigin: true } } } } })], B.prototype, "activeLayer", void 0), e([o("service", "activeLayer", ["layers"])], B.prototype, "readActiveLayerFromService", null), e([o(["web-document", "portal-item"], "activeLayer", ["wmtsInfo"])], B.prototype, "readActiveLayerFromItemOrWebDoc", null), e([r2(["web-document", "portal-item"], "activeLayer", { templateUrl: { type: String }, tileInfo: { type: j2 }, "wmtsInfo.layerIdentifier": { type: String }, "wmtsInfo.tileMatrixSet": { type: String } })], B.prototype, "writeActiveLayer", null), e([y({ type: String, value: "", json: { write: true } })], B.prototype, "copyright", void 0), e([y({ type: ["show", "hide"] })], B.prototype, "listMode", void 0), e([y({ json: { read: true, write: true } })], B.prototype, "blendMode", void 0), e([y({ json: { origins: { "web-document": { read: { source: ["wmtsInfo.customParameters", "wmtsInfo.url"] }, write: { target: "wmtsInfo.customParameters" } }, "portal-item": { read: { source: ["wmtsInfo.customParameters", "wmtsInfo.url"] }, write: { target: "wmtsInfo.customParameters" } } } } })], B.prototype, "customParameters", void 0), e([o(["portal-item", "web-document"], "customParameters")], B.prototype, "readCustomParameters", null), e([y({ json: { origins: { "web-document": { read: { source: "wmtsInfo.customLayerParameters" }, write: { target: "wmtsInfo.customLayerParameters" } }, "portal-item": { read: { source: "wmtsInfo.customLayerParameters" }, write: { target: "wmtsInfo.customLayerParameters" } } } } })], B.prototype, "customLayerParameters", void 0), e([y({ type: M, json: { write: { ignoreOrigin: true }, origins: { "web-document": { read: { source: "fullExtent" } }, "portal-item": { read: { source: "fullExtent" } } } } })], B.prototype, "fullExtent", void 0), e([y({ readOnly: true })], B.prototype, "fullExtents", null), e([y({ type: ["WebTiledLayer"] })], B.prototype, "operationalLayerType", void 0), e([y()], B.prototype, "resourceInfo", void 0), e([y()], B.prototype, "serviceMode", void 0), e([o(["portal-item", "web-document"], "serviceMode", ["templateUrl"])], B.prototype, "readServiceMode", null), e([y({ type: V.ofType(u2) })], B.prototype, "sublayers", void 0), e([o("service", "sublayers", ["layers"])], B.prototype, "readSublayersFromService", null), e([y({ readOnly: true })], B.prototype, "supportedSpatialReferences", null), e([y({ readOnly: true })], B.prototype, "tilemapCache", null), e([y({ json: { read: { source: "title" } } })], B.prototype, "title", null), e([y({ json: { read: false }, readOnly: true, value: "wmts" })], B.prototype, "type", void 0), e([y({ json: { origins: { service: { read: { source: "tileUrl" } }, "web-document": { read: { source: "wmtsInfo.url" }, write: { target: "wmtsInfo.url" } }, "portal-item": { read: { source: "wmtsInfo.url" }, write: { target: "wmtsInfo.url" } } } } })], B.prototype, "url", null), e([y()], B.prototype, "version", void 0), B = W = e([c("esri.layers.WMTSLayer")], B);
var K = B;
export {
  K as default
};
//# sourceMappingURL=WMTSLayer-PWKILO6R.js.map
