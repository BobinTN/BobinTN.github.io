...
var s2;
var a = { exports: {} };
a.exports, i = a, a.exports, s2 = function() {
  return function(e2) {
    var t = {};
    function r(n2) {
      if (t[n2])
        return t[n2].exports;
      var i2 = t[n2] = { exports: {}, id: n2, loaded: false };
    ...
    function c2(e3) {
      ...
      if (p(t2, function(e4) {
        ...
        return o3;
      var n3 = [], s4 = [], u3 = null, h3 = null, c3 = 0, f2 = new i2.APNG();
      if (p(t2, function(e4, t3, r3, a3) {
        var o4 = new DataView(t3.buffer);
        switch (e4) {
          case "IHDR":
            u3 = t3.subarray(r3 + 8, r3 + 8 + a3), f2.width = o4.getUint32(r3 + 8), f2.height = o4.getUint32(r3 + 12);
            break;
          case "acTL":
            f2.numPlays = o4.getUint32(r3 + 8 + 4);
            break;
          case "fcTL":
            h3 && (f2.frames.push(h3), c3++), (h3 = new i2.Frame()).width = o4.getUint32(r3 + 8 + 4), h3.height = o4.getUint32(r3 + 8 + 8), h3.left = o4.getUint32(r3 + 8 + 12), h3.top = o4.getUint32(r3 + 8 + 16);
            var l3 = o4.getUint16(r3 + 8 + 20), p2 = o4.getUint16(r3 + 8 + 22);
            0 === p2 && (p2 = 100), h3.delay = 1e3 * l3 / p2, h3.delay <= 10 && (h3.delay = 100), f2.playTime += h3.delay, h3.disposeOp = o4.getUint8(r3 + 8 + 24), h3.blendOp = o4.getUint8(r3 + 8 + 25), h3.dataParts = [], 0 === c3 && 2 === h3.disposeOp && (h3.disposeOp = 1);
            break;
          case "fdAT":
      ...
      return f2.frames.forEach(function(e4) {
        var t3 = [];
    ...
    function p(e3, t2) {
      ...
      do {
        s4 = r2.getUint32(n3), a3 = t2(i3 = f(e3, n3 + 4, 4), e3, n3, s4), n3 += 12 + s4;
    ...
    Object.defineProperty(t, "__esModule", { value: true }), t.default = function(e3) {
      for (var t2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n3 = -1, i3 = t2, s4 = t2 + (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : e3.length - t2); i3 < s4; i3++)
        n3 = n3 >>> 8 ^ r[255 & (n3 ^ e3[i3])];
      return -1 ^ n3;
    };
    for (var r = new Uint32Array(256), n2 = 0; n2 < 256; n2++) {
      for (var i2 = n2, s3 = 0; s3 < 8; s3++)
    ...
    t.APNG = function() {
      ...
      return n2(e3, [{ key: "createImages", value: function() {
      ...
      return n2(e3, [{ key: "createImage", value: function() {
        var e4 = this;
    ...
    var u2 = function(e3) {
      ...
      return o3(t2, e3), n2(t2, [{ key: "renderNextFrame", value: function() {
        ...
        var t3 = performance.now() + this.currentFrame.delay / this.playbackRate, r2 = function r3(n3) {
          if (!e4._ended && !e4._paused) {
            if (n3 >= t3) {
              for (; n3 - t3 >= e4._apng.playTime / e4.playbackRate; )
                t3 += e4._apng.playTime / e4.playbackRate, e4._numPlays++;
              do {
    ...
    e2.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function(e3) {
      ...
      if (n2(r2))
        ...
        for (o3 = Array.prototype.slice.call(arguments, 1), i3 = (h2 = r2.slice()).length, u2 = 0; u2 < i3; u2++)
          h2[u2].apply(this, o3);
      return true;
      ...
      if (!this._events || !this._events[e3])
        return this;
      if (a3 = (r2 = this._events[e3]).length, i3 = -1, r2 === t2 || n2(r2.listener) && r2.listener === t2)
        delete this._events[e3], this._events.removeListener && this.emit("removeListener", e3, t2);
      else if (s3(r2)) {
        for (o3 = a3; o3-- > 0; )
          if (r2[o3] === t2 || r2[o3].listener && r2[o3].listener === t2) {
            i3 = o3;
            break;
          }
        if (i3 < 0)
      ...
      if (!this._events.removeListener)
        return 0 === arguments.length ? this._events = {} : this._events[e3] && delete this._events[e3], this;
      if (0 === arguments.length) {
        for (t2 in this._events)
          "removeListener" !== t2 && this.removeAllListeners(t2);
        return this.removeAllListeners("removeListener"), this._events = {}, this;
      }
      if (n2(r2 = this._events[e3]))
        this.removeListener(e3, r2);
      else if (r2)
        for (; r2.length; )
          this.removeListener(e3, r2[r2.length - 1]);
...
async function u(e2, t) {
  ...
  if (i2 instanceof Error)
    throw i2;
  await i2.createImages(), s(t);
  const { frames: s3, width: a2, height: u2 } = i2, h2 = document.createElement("canvas");
  ...
  for (const r of s3) {
    ...
    const s4 = l2.getImageData(0, 0, a2, u2);
    c2.push(s4), 0 === r.disposeOp || (1 === r.disposeOp ? l2.clearRect(r.left, r.top, r.width, r.height) : 2 === r.disposeOp && l2.putImageData(i3, r.left, r.top));
  }
  return { frameCount: s3.length, duration: f, frameDurations: p, getFrame: (e3) => c2[e3], width: a2, height: u2 };
}
var h = [137, 80, 78, 71, 13, 10, 26, 10];
function l(e2) {
  const t = new Uint8Array(e2);
  return !h.some((e3, r) => e3 !== t[r]);
}
function c(e2) {
  if (!l(e2))
    return false;
  ...
  do {
    ...
    if (n2 = String.fromCharCode.apply(String, Array.prototype.slice.call(r.subarray(i2 + 4, i2 + 8))), "acTL" === n2)
      return true;
    i2 += 12 + e3;
...
//# sourceMappingURL=apng-ZR7R3QJU.js.map
