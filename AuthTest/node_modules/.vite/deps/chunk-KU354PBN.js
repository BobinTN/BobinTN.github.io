...
var Popover = proxyCustomElement(class extends H {
  ...
  renderCloseButton() {
    ...
    return closable ? h("div", { class: CSS3.closeButtonContainer, key: CSS3.closeButtonContainer }, h("calcite-action", {
      appearance: "transparent",
      class: CSS3.closeButton,
      onClick: this.hide,
      scale: this.scale,
      text: messages.close,
  ...
  renderHeader() {
    ...
    return headingNode ? h("div", { class: CSS3.header, key: CSS3.header }, headingNode, this.renderCloseButton()) : null;
  }
  render() {
    ...
    return h(Host, { "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", {
      ...
      [CSS3.hasHeader]: !!heading,
      [CSS3.container]: true
    } }, this.renderHeader(), h("div", { class: CSS3.content }, h("slot", null)), !heading ? this.renderCloseButton() : null)));
  }
...
var ActionMenu = proxyCustomElement(class extends H {
  ...
  renderMenuItems() {
    ...
    return h("calcite-popover", { flipPlacements, focusTrapDisabled: true, label, offsetDistance: 0, open, overlayPositioning, placement, pointerDisabled: true, referenceElement: menuButtonEl }, h("div", { "aria-activedescendant": activeDescendantId, "aria-labelledby": menuButtonEl == null ? void 0 : menuButtonEl.id, class: CSS4.menu, id: menuId, onClick: this.handleCalciteActionClick, role: "menu", tabIndex: -1 }, h("slot", { onSlotchange: this.handleDefaultSlotChange })));
  }
  render() {
...
@esri/calcite-components/dist/components/action-menu.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KU354PBN.js.map
