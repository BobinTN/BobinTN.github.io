...
var g = class extends d {
  ...
  async _queryBuddy(e2) {
    var _a;
    const t = new (await import("./FeatureLayer-FEBDRSVN.js")).default({ url: e2 }), { capabilities: r } = await t.load(), s3 = r.query.supportsMaxRecordCountFactor, o4 = r.query.supportsPagination, i2 = r.query.supportsCentroid, n = this._config.maxRecordCountFactor, a = t.capabilities.query.maxRecordCount, l = s3 ? a * n : a, h3 = new b();
...
//# sourceMappingURL=chunk-XJTOSNI5.js.map
