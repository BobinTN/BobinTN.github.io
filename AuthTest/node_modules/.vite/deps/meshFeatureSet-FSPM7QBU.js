...
async function c6(e13, r6, o4) {
  const { source: n6 } = r6, { loadGLTFMesh: i4 } = await h(import("./loadGLTFMesh-ET6BHQ4A.js"), o4), a7 = await m6(n6, o4);
  s3(o4);
...
var Y = J = class extends m.LoadableMixin(n(p)) {
  ...
  static async createFromGLTF(e13, t8, r6) {
    ...
    const { loadGLTFMesh: o4 } = await h(import("./loadGLTFMesh-ET6BHQ4A.js"), r6);
...
//# sourceMappingURL=meshFeatureSet-FSPM7QBU.js.map
