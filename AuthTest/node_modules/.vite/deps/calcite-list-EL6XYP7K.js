import {
  ...
  getLabelText,
  submitForm
} from "./chunk-2I3V6FYJ.js";
import {
  defineCustomElement as defineCustomElement3
} from "./chunk-BVVZR47Z.js";
import {
  Symbol as Symbol2,
  baseGetTag,
  debounce,
...
} from "./chunk-HMMPQ2WU.js";
import {
  connectInteractive,
  disconnectInteractive,
  updateHostInteraction
} from "./chunk-SXSF2NBV.js";
import {
...
var Input = proxyCustomElement(class extends H {
  ...
  render() {
    ...
    const inputClearButton = h("button", { "aria-label": this.messages.clear, class: CSS3.clearButton, disabled: this.disabled || this.readOnly, onClick: this.clearInputValue, tabIndex: -1, type: "button" }, h("calcite-icon", { icon: "x", scale: getIconScale(this.scale) }));
    const iconEl = h("calcite-icon", { class: CSS3.inputIcon, flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) });
    ...
    const childEl = this.type !== "number" ? [
      ...
      this.isTextarea ? h("div", { class: CSS3.resizeIconWrapper }, h("calcite-icon", { icon: "chevron-down", scale: getIconScale(this.scale) })) : null
    ] : null;
...
@esri/calcite-components/dist/components/calcite-list.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-EL6XYP7K.js.map
