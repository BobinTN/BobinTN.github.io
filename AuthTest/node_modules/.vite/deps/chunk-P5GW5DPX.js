...
var r2 = class _r {
  ...
  clone(i) {
    const o2 = new _r(), n2 = this._originStores[e2.DEFAULTS];
    n2 && n2.forEach((s, r3) => {
      o2.set(r3, a(s), e2.DEFAULTS);
    });
    for (let r3 = e2.SERVICE; r3 < r; r3++) {
  ...
  revert(t3, s) {
    for (; s > 0 && !this.has(t3, s); )
      --s;
    const e4 = this._originStores[s], r3 = e4 == null ? void 0 : e4.get(t3), i = this._values.get(t3);
    return this._values.set(t3, r3), this._propertyOriginMap.set(t3, s), i !== r3;
  }
  originOf(t3) {
    return this._propertyOriginMap.get(t3) || e2.DEFAULTS;
  }
  forEach(t3) {
...
var u2 = (t3) => {
  let u3 = class extends t3 {
    ...
    originIdOf(r3) {
      return a2(this).originOf(r3);
    }
    revert(r3, t4) {
      const s = a2(this), o2 = n(t4), i = t(this);
      let c2;
      c2 = "string" == typeof r3 ? "*" === r3 ? s.keys(o2) : [r3] : r3, c2.forEach((r4) => {
        i.invalidate(r4), s.revert(r4, o2), i.commit(r4);
      });
    }
  };
  return u3 = e([c("esri.core.ReadOnlyMultiOriginJSONSupport")], u3), u3;
};
function a2(r3) {
  return t(r3).store;
}
...
f = e([c("esri.core.ReadOnlyMultiOriginJSONSupport")], f);
...
var l = (t3) => {
  let s = class extends t3 {
    ...
    removeOrigin(r3) {
      ...
      for (const o2 of e4)
        t4.originOf(o2) === s2 && t4.set(o2, t4.get(o2, s2), e2.USER);
    }
    updateOrigin(r3, t4) {
      const s2 = O(this), i = n(t4), c2 = o(this, r3);
      for (let e4 = i + 1; e4 < r; ++e4)
        s2.delete(r3, e4);
      s2.set(r3, c2, i);
    }
    toJSON(r3) {
  ...
  return s = e([c("esri.core.WriteableMultiOriginJSONSupport")], s), s.prototype.toJSON.isDefaultToJSON = true, s;
};
function O(r3) {
  return t(r3).store;
}
var m = (t3) => {
  ...
  return e4 = e([c("esri.core.MultiOriginJSONSupport")], e4), e4;
};
var S = class extends m(g) {
};
S = e([c("esri.core.MultiOriginJSONSupport")], S);

export {
  m,
  S
};
//# sourceMappingURL=chunk-P5GW5DPX.js.map
