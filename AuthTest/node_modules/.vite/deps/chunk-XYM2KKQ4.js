...
function a(e, t, r, s) {
  return 2 === r ? u(e, t, 3) : i(e, t, r, s);
}
function h(e, t, r, s) {
  return 3 === r ? u(e, t, 3) : n2(e, t, r, s);
}
function u({ translate: e, scale: t }, r, s) {
  return e[s] + r * t[s];
}
function d({ translate: e, scale: t }, r, s) {
  return e[s] - r * t[s];
}
var l = class {
  constructor(e) {
  ...
  addQueryGeometry(e, t) {
    const { queryGeometry: o3, queryGeometryType: i2 } = t, n4 = It(o3.clone(), o3, false, false, this._transform), a2 = st(n4, i2, false, false);
  ...
  _transformPathLikeValue(e, t) {
    ...
    const s = this._transform;
    return this._applyTransform(s, e, t, r);
  }
...
async function n3(o3, s, n4) {
  const p = f(o3), i2 = { ...n4 }, u2 = b.from(s), m = !u2.quantizationParameters, { data: f3 } = await f2(p, u2, new l({ sourceSpatialReference: u2.sourceSpatialReference, applyTransform: m }), i2);
  return f3;
}
...
//# sourceMappingURL=chunk-XYM2KKQ4.js.map
