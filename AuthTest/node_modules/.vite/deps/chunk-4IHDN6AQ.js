...
var Zt = class _Zt {
  ...
  static fromRGB(t2, e2, i2) {
    return new _Zt((0 | i2) + (e2 << 8) + (t2 << 16));
  }
  static fromString(t2) {
    return new _Zt(Yt(t2));
  }
  static fromCSS(t2) {
    return new _Zt(Xt(t2));
  }
  static fromAny(t2) {
    if (h(t2)) {
      if ("#" == t2[0])
        return _Zt.fromString(t2);
      if ("rgb" == t2.substr(0, 3))
        return _Zt.fromCSS(t2);
    } else {
      if (l(t2))
        return _Zt.fromHex(t2);
      if (t2 instanceof _Zt)
        return _Zt.fromHex(t2.hex);
    }
  ...
  static interpolate(t2, e2, i2, s2 = "rgb") {
    if ("hsl" == s2) {
      ...
      return _Zt.fromHSL(qt(t2, s3.h, r2.h), qt(t2, s3.s, r2.s), qt(t2, s3.l, r2.l));
    }
    return _Zt.fromRGB(qt(t2, e2.r, i2.r), qt(t2, e2.g, i2.g), qt(t2, e2.b, i2.b));
  }
...
var Ie = class _Ie extends N {
  ...
  _on(t2, e2, i2, s2, r2, n2) {
    const a2 = super._on(t2, e2, i2, s2, r2, n2), o2 = _Ie.RENDERER_EVENTS[e2];
...
var Fe = ["fill", "fillOpacity", "stroke", "strokeWidth", "strokeOpacity", "fillPattern", "strokePattern", "fillGradient", "strokeGradient", "strokeDasharray", "strokeDashoffset"];
...
var Qe = class _Qe extends He {
  ...
  walkChildren(t2) {
    this.children.each((e2) => {
      e2 instanceof _Qe && e2.walkChildren(t2), t2(e2);
    });
  }
  eachChildren(t2) {
    const e2 = this.get("background");
...
//# sourceMappingURL=chunk-4IHDN6AQ.js.map
