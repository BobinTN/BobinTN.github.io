 ...
 * v1.10.0
 */
import { r as registerInstance, h, H as Host, a as getElement, f as forceUpdate } from './index-89cd0584.js';
...
const Action = class {
  ...
  renderIconContainer() {
    ...
    const calciteIconNode = icon ? (h("calcite-icon", { flipRtl: iconFlipRtl, icon: icon, scale: getIconScale(this.scale) })) : null;
