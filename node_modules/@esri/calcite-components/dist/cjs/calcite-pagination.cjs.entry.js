...
const responsive = require('./responsive-5b2e13fe.js');
const component = require('./component-75681f41.js');
require('./dom-6172ed4c.js');
require('./guid-67658644.js');
...
const Pagination = class {
  ...
  render() {
    ...
    return (index.h(index.Fragment, null, index.h("button", { "aria-label": messages.previous, class: {
      ...
      }, disabled: prevDisabled, onClick: this.previousClicked }, index.h("calcite-icon", { flipRtl: true, icon: ICONS.previous, scale: component.getIconScale(this.scale) })), this.renderItems(), index.h("button", { "aria-label": messages.next, class: {
        [CSS.next]: true,
        [CSS.disabled]: nextDisabled,
      }, disabled: nextDisabled, onClick: this.nextClicked }, index.h("calcite-icon", { flipRtl: true, icon: ICONS.next, scale: component.getIconScale(this.scale) }))));
  }
