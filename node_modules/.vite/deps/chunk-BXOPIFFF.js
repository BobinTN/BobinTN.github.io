...
function c(e2, s, c2 = "nearest", m2 = false) {
  var _a;
  ...
  return A2.width = s.width, A2.height = s.height, A2.internalFormat = e2.type === n.WEBGL2 && l2 ? P.RGBA32F : G.RGBA, A2.samplingMode = !g2 || "bilinear" !== c2 && "cubic" !== c2 ? L.NEAREST : L.LINEAR, A2.dataType = _2, A2.wrapMode = D.CLAMP_TO_EDGE, new T(e2, A2, p2);
}
function m(e2, s) {
  const { spacing: c2, offsets: m2, coefficients: l2, size: [_2, p2] } = s, g2 = c2[0] > 1, A2 = new e();
...
function h(e2, t) {
  ...
  let o2;
  for (let s = 0; s < i; s++)
    o2 = n2.getActiveUniform(r, s), o2 && a.set(o2.name, { location: n2.getUniformLocation(r, o2.name), info: o2 });
  return a;
}
function E(e2, t, n2) {
...
//# sourceMappingURL=chunk-BXOPIFFF.js.map
