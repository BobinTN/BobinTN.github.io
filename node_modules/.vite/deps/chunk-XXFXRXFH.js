...
var u4;
var p = new s4({ avgRating: "avg-rating", numRatings: "num-ratings", numComments: "num-comments", numViews: "num-views" });
var m2 = u4 = class extends g {
  constructor(t3) {
  ...
  toRequestOptions(t3, r) {
    ...
    let s5 = "";
    if (this.extent) {
      const t4 = g2(this.extent, f2.WGS84);
      null != t4 && (s5 = `${t4.xmin},${t4.ymin},${t4.xmax},${t4.ymax}`);
    }
    let o2 = this.query;
    !this.disableExtraQuery && t3.extraQuery && (o2 = "(" + o2 + ")" + t3.extraQuery);
    const i2 = { categories: e3, bbox: s5, q: o2, filter: this.filter, num: this.num, sortField: null, sortOrder: null, start: this.start };
    return this.sortField && (i2.sortField = this.sortField.split(",").map((t4) => p.toJSON(t4.trim())).join(","), i2.sortOrder = this.sortOrder), { query: { ...r, ...i2 } };
  }
};
e([y()], m2.prototype, "categories", void 0), e([y()], m2.prototype, "disableExtraQuery", void 0), e([y({ type: M })], m2.prototype, "extent", void 0), e([y()], m2.prototype, "filter", void 0), e([y()], m2.prototype, "num", void 0), e([y()], m2.prototype, "query", void 0), e([y()], m2.prototype, "sortField", void 0), e([y()], m2.prototype, "sortOrder", null), e([y()], m2.prototype, "start", void 0), m2 = u4 = e([c2("esri.portal.PortalQueryParams")], m2);
var c5 = m2;
...
var u5 = l2 = class extends f {
  ...
  get thumbnailUrl() {
    ...
    return t3 && r && this.portal ? (_a = this.portal) == null ? void 0 : _a.normalizeUrl(`${t3}/info/${r}?f=json`) : null;
  }
  get url() {
    var _a;
  ...
  static fromJSON(t3) {
    ...
    const r = new l2();
    return r.sourceJSON = t3, r.read(t3), r;
  }
  queryItems(t3, r) {
    let e3 = d(c5, t3);
    const o2 = this.portal;
    return parseFloat(o2.currentVersion) > 5 ? (e3 = e3 || new c5(), o2.queryPortal(`/content/groups/${this.id}/search`, e3, "PortalItem", r)) : (e3 = e3 ? e3.clone() : new c5(), e3.query = "group:" + this.id + (e3.query ? " " + e3.query : ""), o2.queryItems(e3, r));
  }
  _fetchCategorySchemaSet(t3, e3) {
    const o2 = this.portal;
    return o2.fetchSelf(o2.authMode, true, e3).then((t4) => {
      const s5 = t4.contentCategorySetsGroupQuery;
      if (s5) {
        const t5 = new c5();
        return t5.disableExtraQuery = true, t5.num = 1, t5.query = s5, o2.queryGroups(t5, e3);
      }
      throw new s2("portal-group:fetchCategorySchema", "contentCategorySetsGroupQuery value not found");
    }).then((o3) => {
      if (o3.total) {
        const r = o3.results[0], s5 = new c5();
        return s5.num = 1, s5.query = `typekeywords:"${t3}"`, r.queryItems(s5, e3);
      }
      ...
      if (t4.total) {
        return t4.results[0].fetchData("json", e3).then((t5) => {
          const r = t5 == null ? void 0 : t5.categorySchema;
...
e([y()], u5.prototype, "access", void 0), e([y({ type: Date })], u5.prototype, "created", void 0), e([y()], u5.prototype, "description", void 0), e([y()], u5.prototype, "id", void 0), e([y()], u5.prototype, "isInvitationOnly", void 0), e([y({ type: Date })], u5.prototype, "modified", void 0), e([y()], u5.prototype, "owner", void 0), e([y()], u5.prototype, "portal", void 0), e([y()], u5.prototype, "snippet", void 0), e([y()], u5.prototype, "sortField", void 0), e([y()], u5.prototype, "sortOrder", void 0), e([y()], u5.prototype, "sourceJSON", void 0), e([y()], u5.prototype, "tags", void 0), e([y()], u5.prototype, "thumbnail", void 0), e([y({ readOnly: true })], u5.prototype, "thumbnailUrl", null), e([y()], u5.prototype, "title", void 0), e([y({ readOnly: true })], u5.prototype, "url", null), u5 = l2 = e([c2("esri.portal.PortalGroup")], u5);
var a3 = u5;
...
e([y()], e2.prototype, "nextQueryParams", void 0), e([y()], e2.prototype, "queryParams", void 0), e([y()], e2.prototype, "results", void 0), e([y()], e2.prototype, "total", void 0), e2 = e([c2("esri.portal.PortalQueryResult")], e2);
var p2 = e2;
...
e([y({ type: Date })], p3.prototype, "created", void 0), e([y()], p3.prototype, "id", void 0), e([y()], p3.prototype, "portal", void 0), e([y()], p3.prototype, "title", void 0), e([y({ readOnly: true })], p3.prototype, "url", null), e([y()], p3.prototype, "username", void 0), p3 = e([c2("esri.portal.PortalFolder")], p3);
var l3 = p3;
...
var u6 = i = class extends f {
  ...
  get thumbnailUrl() {
    const t3 = this.url, r = this.thumbnail;
    return t3 && r ? this.portal.normalizeUrl(`${t3}/info/${r}?f=json`) : null;
  }
  get userContentUrl() {
    var _a;
    const t3 = (_a = this.portal) == null ? void 0 : _a.restUrl;
  ...
  addItem(t3) {
    const r = t3 && t3.item, e3 = t3 == null ? void 0 : t3.data, o2 = t3 == null ? void 0 : t3.folder, s5 = { method: "post" };
    r && (s5.query = r.createPostQuery(), null != e3 && ("string" == typeof e3 ? s5.query.text = e3 : "object" == typeof e3 && (s5.query.text = JSON.stringify(e3))));
    let l4 = this.userContentUrl;
    return o2 && (l4 += "/" + ("string" == typeof o2 ? o2 : o2.id)), this.portal.request(l4 + "/addItem", s5).then((t4) => (r.id = t4.id, r.portal = this.portal, r.loaded ? r.reload() : r.load()));
  }
  deleteItem(t3) {
    let r = this.userContentUrl;
    return t3.ownerFolder && (r += "/" + t3.ownerFolder), this.portal.request(r + `/items/${t3.id}/delete`, { method: "post" }).then(() => {
      t3.id = null, t3.portal = null;
    });
  }
  deleteItems(t3) {
    const r = this.userContentUrl + "/deleteItems", e3 = t3.map((t4) => t4.id);
    if (e3.length) {
      const o2 = { method: "post", query: { items: e3.join(",") } };
      return this.portal.request(r, o2).then(() => {
        t3.forEach((t4) => {
  ...
  fetchFolders() {
    ...
    return this.portal.request(this.userContentUrl ?? "", t3).then((t4) => {
      let r;
      return r = t4 && t4.folders ? t4.folders.map((t5) => {
        const r2 = l3.fromJSON(t5);
  ...
  fetchGroups() {
    return this.portal.request(this.url ?? "").then((t3) => {
      let r;
      return r = t3 && t3.groups ? t3.groups.map((t4) => {
        const r2 = a3.fromJSON(t4);
        return r2.portal = this.portal, r2;
      }) : [], r;
    });
  }
  fetchItems(t3) {
    ...
    return r.folder && (o2 += "/" + r.folder.id), import("./PortalItem-7RTKQHXU.js").then(({ default: t4 }) => {
      e3 = t4;
      const s5 = { folders: false, num: r.num || 10, start: r.start || 1, sortField: r.sortField || "created", sortOrder: r.sortOrder || "asc" };
      return this.portal.request(o2, { query: s5 });
    }).then((t4) => {
      let r2;
      return (t4 == null ? void 0 : t4.items) ? (r2 = t4.items.map((t5) => {
        const r3 = e3.fromJSON(t5);
        return r3.portal = this.portal, r3;
      }), Promise.all(r2.map((t5) => t5.load())).catch((t5) => t5).then(() => ({ items: r2, nextStart: t4.nextStart, total: t4.total }))) : { items: [], nextStart: -1, total: 0 };
    });
  }
  fetchTags() {
  ...
  queryFavorites(t3) {
    return this.favGroupId ? (this._favGroup || (this._favGroup = new a3({ id: this.favGroupId, portal: this.portal })), this._favGroup.queryItems(t3)) : Promise.reject(new s2("internal:unknown", "Unknown internal error", { internalError: "Unknown favGroupId" }));
  }
  toJSON() {
...
var C = U = class extends u3(m) {
  ...
  readAuthorizedCrossOriginDomains(e3) {
    if (e3)
      for (const r of e3)
        s.request.trustedServers.includes(r) || s.request.trustedServers.push(r);
    return e3;
  }
  ...
  readUser(e3) {
    let t3 = null;
    return e3 && (t3 = p4.fromJSON(e3), t3.portal = this), t3;
  }
  load(e3) {
    const t3 = import("./Basemap-7D24OR64.js").then(({ default: t4 }) => {
      s3(e3), b = t4;
    }).then(() => this.sourceJSON ? this.sourceJSON : this.fetchSelf(this.authMode, false, e3)).then((e4) => {
      var _a;
      if (t) {
        const e5 = t;
        this.credential = e5.findCredential(this.restUrl), this.credential || this.authMode !== U.AUTH_MODE_AUTO || ((_a = this._esriIdCredentialCreateHandle) == null ? void 0 : _a.remove(), this._esriIdCredentialCreateHandle = e5.on("credential-create", w(new WeakRef(this))), q.register(this, this._esriIdCredentialCreateHandle, this));
      }
  ...
  async createElevationLayers() {
    await this.load();
    const e3 = this._getHelperService("defaultElevationLayers"), t3 = (await import("./ElevationLayer-JVKQLVQ3.js")).default;
    return e3 ? e3.map((e4) => new t3({ id: e4.id, url: e4.url })) : [];
  }
  async fetchBasemaps(e3, t3) {
    const r = await this._fetchBasemaps(e3, t3);
  ...
  fetchFeaturedGroups(e3) {
    const t3 = this.featuredGroups, r = new c5();
    if (r.num = 100, r.sortField = "title", t3 && t3.length) {
      const o2 = [];
      for (const e4 of t3)
  ...
  fetchRegions(e3) {
    var _a;
    const t3 = ((_a = this.user) == null ? void 0 : _a.culture) || this.culture || c4();
  ...
  fetchSelf(e3 = this.authMode, t3 = false, r) {
    const o2 = this.restUrl + "/portals/self", s5 = { authMode: e3, query: { culture: c4().toLowerCase() }, ...r };
    return "auto" === s5.authMode && (s5.authMode = "no-prompt"), t3 && (s5.query.default = true), this.request(o2, s5);
  }
  queryPortal(e3, t3, r, o2) {
    const s5 = d(c5, t3), i2 = (t4) => this.request(this.restUrl + e3, { ...s5.toRequestOptions(this), ...o2 }).then((e4) => {
      const r2 = s5.clone();
      return r2.start = e4.nextStart, new p2({ nextQueryParams: r2, queryParams: s5, total: e4.total, results: U._resultsToTypedArray(t4, { portal: this }, e4, o2) });
    }).then((e4) => Promise.all(e4.results.map((t5) => "function" == typeof t5.when ? t5.when() : e4)).then(() => e4, (t5) => (a2(t5), e4)));
    return r && Q[r] ? Q[r]().then(({ default: e4 }) => (s3(o2), i2(e4))) : i2();
  }
  signIn() {
    ...
    return t ? t.getCredential(this.restUrl).then((t3) => e3(t3)) : e3(this.credential);
  }
  normalizeUrl(e3) {
    var _a;
  ...
  requestToTypedArray(e3, t3, r) {
    return this.request(e3, t3).then((e4) => {
      const t4 = U._resultsToTypedArray(r, { portal: this }, e4);
      return Promise.all(t4.map((t5) => "function" == typeof t5.when ? t5.when() : e4)).then(() => t4, () => t4);
    });
  }
  request(e3, t3 = {}) {
    const r = { f: "json", ...t3.query }, { authMode: s5 = this.authMode === U.AUTH_MODE_ANONYMOUS ? "anonymous" : "auto", body: i2 = null, cacheBust: a4 = false, method: l4 = "auto", responseType: u7 = "json", signal: n2 } = t3, p5 = { authMode: s5, body: i2, cacheBust: a4, method: l4, query: r, responseType: u7, timeout: 0, signal: n2 };
    return j(this._normalizeSSL(e3), p5).then((e4) => e4.data);
  }
  toJSON() {
  ...
  async _fetchBasemaps(e3, r) {
    ...
    const s5 = await this.queryGroups(o2, r);
    if (!s5.total)
      return [];
    const i2 = s5.results[0];
    o2.num = 100, o2.query = 'type:"Web Map" -type:"Web Application"', o2.sortField = i2.sortField || "name", o2.sortOrder = i2.sortOrder || "desc";
    const a4 = await i2.queryItems(o2, r);
    if (!a4.total)
      return [];
    return a4.results.filter((e4) => "Web Map" === e4.type).map((e4) => new b({ portalItem: e4 }));
  }
  async _fetchBasemaps3D(e3, t3) {
    const r = e3 || this.basemapGalleryGroupQuery3D;
    if (!r)
      return [];
    const o2 = new c5({ query: r, disableExtraQuery: true }), s5 = await this.queryGroups(o2, t3);
    if (!s5.total)
      return [];
    const i2 = s5.results[0];
    ...
    if (!a4.total)
      return [];
    return a4.results.filter((e4) => "Web Scene" === e4.type).map((e4) => new b({ portalItem: e4 }));
  }
  _normalizeSSL(e3) {
  ...
  static _resultsToTypedArray(e3, t3, r, o2) {
    ...
    if (r) {
      ...
      s5 = r.listings || r.notifications || r.userInvitations || r.tags || r.items || r.groups || r.comments || r.provisions || r.results || r.relatedItems || r, (e3 || t3) && (s5 = s5.map((r2) => {
...
//# sourceMappingURL=chunk-XXFXRXFH.js.map
