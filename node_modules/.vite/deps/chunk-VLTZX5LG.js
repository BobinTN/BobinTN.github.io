...
var L = U = class extends a2(f3(t(u(j3(m(b)))))) {
  ...
  readSpatialReference(e2, t2) {
    var _a;
    return e2 || f2.fromJSON((_a = t2.fullExtent) == null ? void 0 : _a.spatialReference);
  }
  get tileServers() {
    if (!this.urlTemplate)
      return null;
    const e2 = [], { urlTemplate: t2, subDomains: r3 } = this, l = new x(t2), o3 = l.scheme ? l.scheme + "://" : "//", n = o3 + l.authority + "/", a3 = l.authority;
    if (a3 == null ? void 0 : a3.includes("{subDomain}")) {
      if (r3 && r3.length > 0 && a3.split(".").length > 1)
        for (const s2 of r3)
          e2.push(o3 + a3.replaceAll(/\{subDomain\}/gi, s2) + "/");
    } else
      e2.push(n);
    return e2.map(Ct);
  }
  ...
  fetchTile(e2, r3, l, o3 = {}) {
    const { signal: s2 } = o3, i2 = this.getTileUrl(e2, r3, l), n = { responseType: "image", signal: s2, query: { ...this.refreshParameters } };
    return j(i2, n).then((e3) => e3.data);
  }
  async fetchImageBitmapTile(e2, r3, l, o3 = {}) {
    const { signal: s2 } = o3;
    if (this.fetchTile !== U.prototype.fetchTile) {
      const t2 = await this.fetchTile(e2, r3, l, o3);
      return o2(t2, e2, r3, l, s2);
    }
    const i2 = this.getTileUrl(e2, r3, l), n = { responseType: "blob", signal: s2, query: { ...this.refreshParameters } }, { data: a3 } = await j(i2, n);
    return o2(a3, e2, r3, l, s2);
  }
  getTileUrl(e2, t2, r3) {
...
e([y({ type: String, value: "", json: { write: true } })], L.prototype, "copyright", void 0), e([y({ type: M, json: { write: true }, nonNullable: true })], L.prototype, "fullExtent", void 0), e([y({ readOnly: true, json: { read: false, write: false } })], L.prototype, "legendEnabled", void 0), e([y({ type: ["show", "hide"] })], L.prototype, "listMode", void 0), e([y({ json: { read: true, write: true } })], L.prototype, "blendMode", void 0), e([y()], L.prototype, "levelValues", null), e([y({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], L.prototype, "isReference", void 0), e([y({ type: ["WebTiledLayer"], value: "WebTiledLayer" })], L.prototype, "operationalLayerType", void 0), e([y({ readOnly: true, json: { read: false, write: false } })], L.prototype, "popupEnabled", void 0), e([y({ type: f2 })], L.prototype, "spatialReference", void 0), e([o("spatialReference", ["spatialReference", "fullExtent.spatialReference"])], L.prototype, "readSpatialReference", null), e([y({ type: [String], json: { write: true } })], L.prototype, "subDomains", void 0), e([y({ type: j2, json: { write: true } })], L.prototype, "tileInfo", void 0), e([y({ readOnly: true })], L.prototype, "tileServers", null), e([y({ json: { read: false } })], L.prototype, "type", void 0), e([y()], L.prototype, "urlPath", null), e([y({ type: String, json: { origins: { "portal-item": { read: { source: "url" } } } } })], L.prototype, "urlTemplate", void 0), e([o("urlTemplate", ["urlTemplate", "templateUrl"])], L.prototype, "readUrlTemplate", null), e([r2("urlTemplate", { templateUrl: { type: String } })], L.prototype, "writeUrlTemplate", null), e([y({ type: p2, json: { write: true } })], L.prototype, "wmtsInfo", void 0), L = U = e([c("esri.layers.WebTileLayer")], L);
var I = L;
...
//# sourceMappingURL=chunk-VLTZX5LG.js.map
