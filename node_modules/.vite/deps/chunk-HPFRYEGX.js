...
var c3 = (e, t) => t.visibleFieldNames ? t.visibleFieldNames.has(e.name) : q(e, t);
function f(e, t) {
  const n = e;
...
function w(e, n) {
  ...
  return f(e.fields ?? [], (n == null ? void 0 : n.ignoreFieldTypes) || v).map((n2) => new c({ fieldName: n2.name, isEditable: B(n2, e), label: n2.alias, format: g(n2), visible: c3(n2, { ...e, visibleFieldNames: i2 }) }));
}
function g(e) {
  switch (e.type) {
    case "small-integer":
...
//# sourceMappingURL=chunk-HPFRYEGX.js.map
