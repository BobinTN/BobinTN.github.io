...
function d2(e) {
  var _a;
  const o2 = e.folders || [], t3 = o2.slice(), r = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), i2 = /* @__PURE__ */ new Map(), f2 = /* @__PURE__ */ new Map(), a2 = /* @__PURE__ */ new Map(), l = { esriGeometryPoint: n, esriGeometryPolyline: i2, esriGeometryPolygon: f2 };
...
function g(t3, s2, i2, f2) {
  ...
  return j(l, { query: { url: t3, model: "simple", folders: "", refresh: 0 !== i2 || void 0, outSR: JSON.stringify(s2) }, responseType: "json", signal: f2 });
}
...
async function b(e) {
  ...
  for (const t3 of o2) {
    const e2 = await s2.getSymbolAsync(t3);
...
function j2(e) {
  ...
  const o2 = i(C), t3 = i(C);
  for (const r of e) {
    if ((_b = (_a = r.polygons) == null ? void 0 : _a.featureSet) == null ? void 0 : _b.features)
      for (const e2 of r.polygons.featureSet.features)
        m(o2, e2.geometry), o(t3, o2);
    if ((_d = (_c = r.polylines) == null ? void 0 : _c.featureSet) == null ? void 0 : _d.features)
      for (const e2 of r.polylines.featureSet.features)
        m(o2, e2.geometry), o(t3, o2);
    if ((_f = (_e = r.points) == null ? void 0 : _e.featureSet) == null ? void 0 : _f.features)
...
//# sourceMappingURL=chunk-J4M3ZRJI.js.map
