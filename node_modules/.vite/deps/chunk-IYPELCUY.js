  ...
  _afterNew() {
    super._afterNew(), this._data.incrementRef(), this._updateFields(), this._disposers.push(this.data.events.onAll((e) => {
      ...
      if (this.markDirtyValues(), this._markDirtyGroup(), this._dataChanged = true, "clear" === e.type)
        ...
        s.bullets && 0 == s.bullets.length && (s.bullets = void 0), $(i).forEach((e2) => {
...
Object.defineProperty(_2, "className", { enumerable: true, configurable: true, writable: true, value: "Component" }), Object.defineProperty(_2, "classNames", { enumerable: true, configurable: true, writable: true, value: Qe.classNames.concat([_2.className]) });
...
var D = class extends _2 {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_aggregatesCalculated", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_selectionAggregatesCalculated", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_dataProcessed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_psi", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_pei", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "bullets", { enumerable: true, configurable: true, writable: true, value: new F() }), Object.defineProperty(this, "bulletsContainer", { enumerable: true, configurable: true, writable: true, value: Qe.new(this._root, { width: Y, height: Y, position: "absolute" }) });
  }
  _afterNew() {
  ...
  getDataItemById(e) {
    return S(this.dataItems, (t2) => t2.get("id") == e);
  }
  _makeBullets(e) {
      ...
      m(e2.target._entities, (i) => {
        ...
        if (l(a))
          if (e2.customFunction)
            ...
            let l2, n;
            l2 = e2.logarithmic ? (Math.log(a) * Math.LOG10E - Math.log(t2) * Math.LOG10E) / (Math.log(s) * Math.LOG10E - Math.log(t2) * Math.LOG10E) : (a - t2) / (s - t2), !l(a) || l(l2) && Math.abs(l2) != 1 / 0 || (l2 = 0.5), l(e2.min) ? n = e2.min + (e2.max - e2.min) * l2 : e2.min instanceof Zt ? n = Zt.interpolate(l2, e2.min, e2.max) : e2.min instanceof K && (n = te(l2, e2.min, e2.max)), i.set(e2.key, n);
          }
        else
...
var F2 = class {
  constructor(e) {
    this._x0 = this._y0 = this._x1 = this._y1 = null, this._ = "", this._append = null == e ? j : S2(e);
  }
  moveTo(e, t2) {
  ...
  arcTo(e, t2, s, i, a) {
    ...
    if (null === this._x1)
      ...
      if (Math.abs(u * n - o * h) > O && a) {
        let c = s - l2, m2 = i - r, p = n * n + o * o, b = c * c + m2 * m2, f2 = Math.sqrt(p), g2 = Math.sqrt(d), _3 = a * Math.tan((T - Math.acos((p + d - b) / (2 * f2 * g2))) / 2), v2 = _3 / g2, y2 = _3 / f2;
  ...
  arc(e, t2, s, i, a, l2) {
    ...
    null === this._x1 ? this._append`M${o},${h}` : (Math.abs(this._x1 - o) > O || Math.abs(this._y1 - h) > O) && this._append`L${o},${h}`, s && (d < 0 && (d = d % M + M), d > $2 ? this._append`A${s},${s},0,1,${u},${e - r},${t2 - n}A${s},${s},0,1,${u},${this._x1 = o},${this._y1 = h}` : d > O && this._append`A${s},${s},0,${+(d >= T)},${u},${this._x1 = e + s * Math.cos(a)},${this._y1 = t2 + s * Math.sin(a)}`);
  }
  rect(e, t2, s, i) {
...
//# sourceMappingURL=chunk-IYPELCUY.js.map
