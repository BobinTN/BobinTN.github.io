...
var f4;
var h = new s({ esriGeometryPoint: "point", esriGeometryMultipoint: "multipoint", esriGeometryPolyline: "polyline", esriGeometryPolygon: "polygon", esriGeometryEnvelope: "extent", mesh: "mesh", "": null });
var g = f4 = class extends f {
  constructor(e2) {
  ...
  readFeatures(e2, t) {
    var _a;
    const o2 = f2.fromJSON(t.spatialReference), s2 = [];
    for (let n2 = 0; n2 < e2.length; n2++) {
      const t2 = e2[n2], i = c2.fromJSON(t2), l = (_a = t2.geometry) == null ? void 0 : _a.spatialReference;
      null == i.geometry || l || (i.geometry.spatialReference = o2);
      const a2 = t2.aggregateGeometries, p2 = i.aggregateGeometries;
      if (a2 && null != p2)
        for (const e3 in p2) {
          const t3 = p2[e3], r2 = a2[e3], s3 = r2 == null ? void 0 : r2.spatialReference;
  ...
  writeGeometryType(e2, t, r2, o2) {
    ...
    if (s2) {
      for (const n2 of s2)
        if (null != (n2 == null ? void 0 : n2.geometry))
          return void h.write(n2.geometry.type, t, r2, o2);
    }
  }
  ...
  clone() {
    return new f4(this.cloneProperties());
  }
  cloneProperties() {
  ...
  quantize(e2) {
    const { scale: [t, r2], translate: [o2, s2] } = e2, n2 = (e3) => Math.round((e3 - o2) / t), i = (e3) => Math.round((s2 - e3) / r2), l = this.features, a2 = this._getQuantizationFunction(this.geometryType, n2, i);
    for (let p2 = 0, m = l.length; p2 < m; p2++)
      (a2 == null ? void 0 : a2(l[p2].geometry)) || (l.splice(p2, 1), p2--, m--);
  ...
  unquantize() {
    ...
    if (!r2)
      return this;
    const { translate: [o2, s2], scale: [n2, i] } = r2, l = (e3) => e3 * n2 + o2, a2 = (e3) => s2 - e3 * i;
    let p2 = null, m = null;
    ...
    const c3 = this._getHydrationFunction(e2, l, a2, p2, m);
  ...
  _quantizePoints(e2, t, r2) {
    ...
    for (let i = 0, l = e2.length; i < l; i++) {
      ...
      if (i > 0) {
        ...
        o2 = t(l2[0]), s2 = r2(l2[1]), n2.push([o2, s2]);
    }
  ...
  _getQuantizationFunction(e2, t, r2) {
    return "point" === e2 ? (e3) => (e3.x = t(e3.x), e3.y = r2(e3.y), e3) : "polyline" === e2 || "polygon" === e2 ? (e3) => {
      const o2 = f3(e3) ? e3.rings : e3.paths, s2 = [];
      for (let n2 = 0, i = o2.length; n2 < i; n2++) {
        const e4 = o2[n2], i2 = this._quantizePoints(e4, t, r2);
        i2 && s2.push(i2);
      }
      return s2.length > 0 ? (f3(e3) ? e3.rings = s2 : e3.paths = s2, e3) : null;
    } : "multipoint" === e2 ? (e3) => {
  ...
  _getHydrationFunction(e2, t, r2, o2, s2) {
    return "point" === e2 ? (e3) => {
      ...
      const n2 = f3(e3) ? e3.rings : e3.paths;
      let i, l;
      for (let o3 = 0, s3 = n2.length; o3 < s3; o3++) {
        const e4 = n2[o3];
        for (let o4 = 0, s4 = e4.length; o4 < s4; o4++) {
          const s5 = e4[o4];
          o4 > 0 ? (i += s5[0], l += s5[1]) : (i = s5[0], l = s5[1]), s5[0] = t(i), s5[1] = r2(l);
        }
      }
      if (o2 && s2)
...
e([y({ type: String, json: { write: true } })], g.prototype, "displayFieldName", void 0), e([y({ type: Boolean, json: { write: { overridePolicy: (e2) => ({ enabled: e2 }) } } })], g.prototype, "exceededTransferLimit", void 0), e([y({ type: [c2], json: { write: true } })], g.prototype, "features", void 0), e([o("features")], g.prototype, "readFeatures", null), e([y({ type: [y2], json: { write: true } })], g.prototype, "fields", void 0), e([y({ type: ["point", "multipoint", "polyline", "polygon", "extent", "mesh"], json: { read: { reader: h.read } } })], g.prototype, "geometryType", void 0), e([r("geometryType")], g.prototype, "writeGeometryType", null), e([y({ type: Boolean, json: { write: { overridePolicy: (e2) => ({ enabled: e2 }) } } })], g.prototype, "hasM", void 0), e([y({ type: Boolean, json: { write: { overridePolicy: (e2) => ({ enabled: e2 }) } } })], g.prototype, "hasZ", void 0), e([y({ types: n, json: { write: true } })], g.prototype, "queryGeometry", void 0), e([o("queryGeometry")], g.prototype, "readQueryGeometry", null), e([y({ type: f2, json: { write: true } })], g.prototype, "spatialReference", void 0), e([r("spatialReference")], g.prototype, "writeSpatialReference", null), e([y({ json: { write: true } })], g.prototype, "transform", void 0), g = f4 = e([c("esri.rest.support.FeatureSet")], g), g.prototype.toJSON.isDefaultToJSON = true;
var d = g;

export {
  d
};
//# sourceMappingURL=chunk-BYK6DXRK.js.map
