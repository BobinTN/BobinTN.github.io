  ...
  _updateVisualVariables(l, r) {
    ...
    if (v2) {
      if (o2.vvSizeEnabled = true, v2.minMaxValue) {
        ...
        let i2, l2;
        if (z2(t2.minSize) && z2(t2.maxSize))
          if ($(t2.minSize) && $(t2.maxSize))
            i2 = u(t2.minSize), l2 = u(t2.maxSize);
          else {
            const s2 = r.scale;
            i2 = u(n2(s2, t2.minSize.stops)), l2 = u(n2(s2, t2.maxSize.stops));
          }
      ...
      if (v2.scaleStops && (this.vvSizeScaleStopsValue = u(n2(r.scale, v2.scaleStops.stops))), v2.unitValue) {
        const e = z(r.spatialReference) / m[v2.unitValue.unit];
...
var o = class extends i {
  ...
  _processMaterialItemRequest(e, { items: t2, abortOptions: r, resolver: s2 }) {
    const { painter: i2, pixelRatio: o2 } = e, n3 = t2.map((e2) => i2.textureManager.rasterizeItem(e2.symbol, o2, e2.glyphIds, r));
    Promise.all(n3).then((e2) => {
      if (!this.stage)
...
//# sourceMappingURL=chunk-HBFRNOJQ.js.map
