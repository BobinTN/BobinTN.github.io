...
var n = class _n {
  static create(r2, e3, s2 = null) {
    const l2 = G(r2.spatialReference), h2 = e3.origin || o(r2.origin.x, r2.origin.y), a2 = o(r2.size[0] * e3.resolution, r2.size[1] * e3.resolution), u = o(-1 / 0, -1 / 0), m = o(1 / 0, 1 / 0), g = o(1 / 0, 1 / 0);
    ...
    let d, f, F, z;
    return !s2 && w && c && (i(u, w[0], c[0]), i(m, w[1], c[1]), i(g, w[1] - w[0] + 1, c[1] - c[0] + 1)), r2.isWrappable ? (d = o(Math.ceil(Math.round((l2.valid[1] - l2.valid[0]) / e3.resolution) / r2.size[0]), g[1]), f = o(Math.floor((l2.origin[0] - h2[0]) / a2[0]), u[1]), F = o(d[0] + f[0] - 1, m[1]), z = true) : (f = u, F = m, d = g, z = false), new _n(e3.level, e3.resolution, e3.scale, h2, u, m, g, a2, f, F, d, z);
  }
...
var h = class {
  ...
  getTileCoverage(e3, t = 192, l2 = true, i3 = "closest") {
    ...
    for (let o3 = 0; o3 < 4; o3++) {
      ...
      g = Math.min(e4.ymin, g), d = Math.max(e4.ymax, d), void 0 === y[e4.ymin] && (y[e4.ymin] = []), y[e4.ymin].push(e4), _ = o3;
    }
  ...
  normalizeBounds(t, o3, l2) {
    if (t[0] = o3[0], t[1] = o3[1], t[2] = o3[2], t[3] = o3[3], this._wrap) {
      const o4 = G(this.tileInfo.spatialReference), s2 = -l2 * (o4.valid[1] - o4.valid[0]);
      t[0] += s2, t[2] += s2;
    }
    return t;
  }
...
//# sourceMappingURL=chunk-XHP7ONEC.js.map
