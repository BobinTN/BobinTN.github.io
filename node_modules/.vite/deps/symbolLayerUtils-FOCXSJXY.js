...
async function f(e2, o = null) {
  ...
  if (!e2.isPrimitive) {
    ...
    if (void 0 !== s2)
      return s2;
    const { fetch: n2 } = await import("./objectResourceUtils-FU7TFSRT.js"), u3 = await n2(o2, { disableTextures: true }), a2 = F(u3.referenceBoundingBox, n());
...
//# sourceMappingURL=symbolLayerUtils-FOCXSJXY.js.map
