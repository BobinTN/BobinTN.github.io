...
var h3 = 17;
var l3 = class {
  constructor(t8, e5, i5, o5, s5, c6, h5) {
    this._glyphItems = t8, this._maxWidth = e5, this._lineHeight = i5, this._letterSpacing = o5, this._hAnchor = s5, this._vAnchor = c6, this._justify = h5;
  }
  getShaping(s5, c6, h5) {
    const l5 = this._letterSpacing, n5 = this._lineHeight, a4 = this._justify, r8 = this._maxWidth, m3 = [];
    let f3 = 0, p3 = 0;
    for (const t8 of s5) {
    ...
    const y2 = s5.includes("​"), d = [], x2 = m3.length;
    for (let e5 = 0; e5 < x2 - 1; e5++) {
      const o5 = m3[e5].codePoint, s6 = c4(o5);
      if (s(o5) || s6) {
        let t8 = 0;
        if (10 === o5)
          t8 -= 1e4;
        ...
        d.push(this._buildBreak(e5 + 1, m3[e5].x, g2, d, t8, false));
      }
    }
    const u4 = this._optimalBreaks(this._buildBreak(x2, f3, g2, d, 0, true));
    let M = 0;
    const _2 = c6 ? -n5 : n5;
    let I4 = 0;
    for (let t8 = 0; t8 < u4.length; t8++) {
      const i5 = u4[t8];
      let o5 = I4;
      for (; o5 < i5 && a2(m3[o5].codePoint); )
        m3[o5].glyphMosaicItem = null, ++o5;
      let s6 = i5 - 1;
      for (; s6 > o5 && a2(m3[s6].codePoint); )
      ...
      if (o5 <= s6) {
        ...
        let e5 = m3[s6].x;
        m3[s6].glyphMosaicItem && (e5 += m3[s6].glyphMosaicItem.metrics.advance), M = Math.max(e5, M), a4 && this._applyJustification(m3, o5, s6);
      }
      I4 = i5, p3 += _2;
    }
    if (m3.length > 0) {
      const t8 = u4.length - 1, e5 = (a4 - this._hAnchor) * M;
  ...
  static getTextBox(t8, e5) {
    if (!t8.length)
      return null;
    let i5 = 1 / 0, o5 = 1 / 0, s5 = 0, c6 = 0;
    for (const l5 of t8) {
      const t9 = l5.glyphMosaicItem.metrics.advance, n5 = l5.x, a4 = l5.y - h3, r8 = n5 + t9, m3 = a4 + e5;
      i5 = Math.min(i5, n5), s5 = Math.max(s5, r8), o5 = Math.min(o5, a4), c6 = Math.max(c6, m3);
    }
    return { x: i5, y: o5, width: s5 - i5, height: c6 - o5 };
  }
  static getBox(t8) {
    if (!t8.length)
      return null;
    ...
    for (const c6 of t8) {
      const { height: t9, left: h5, top: l5, width: n5 } = c6.glyphMosaicItem.metrics, a4 = c6.x, r8 = c6.y - (t9 - Math.abs(l5)), m3 = a4 + n5 + h5, f3 = r8 + t9;
      e5 = Math.min(e5, a4), o5 = Math.max(o5, m3), i5 = Math.min(i5, r8), s5 = Math.max(s5, f3);
    }
  ...
  static addDecoration(t8, e5) {
    ...
    if (0 === i5)
      return;
    const o5 = 3;
    let c6 = t8[0].x + t8[0].glyphMosaicItem.metrics.left, h5 = t8[0].y;
    for (let n5 = 1; n5 < i5; n5++) {
      const i6 = t8[n5];
      if (i6.y !== h5) {
        const l6 = t8[n5 - 1].x + t8[n5 - 1].glyphMosaicItem.metrics.left + t8[n5 - 1].glyphMosaicItem.metrics.width;
        t8.push({ codePoint: 0, x: c6, y: h5 + e5 - o5, vertical: false, glyphMosaicItem: { sdf: true, rect: new t3(4, 0, 4, 8), metrics: { width: l6 - c6, height: 2 + 2 * o5, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } }), h5 = i6.y, c6 = i6.x + i6.glyphMosaicItem.metrics.left;
      }
    }
    const l5 = t8[i5 - 1].x + t8[i5 - 1].glyphMosaicItem.metrics.left + t8[i5 - 1].glyphMosaicItem.metrics.width;
    t8.push({ codePoint: 0, x: c6, y: h5 + e5 - o5, vertical: false, glyphMosaicItem: { sdf: true, rect: new t3(4, 0, 4, 8), metrics: { width: l5 - c6, height: 2 + 2 * o5, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } });
  }
  _breakScore(t8, e5, i5, o5) {
    const s5 = (t8 - e5) * (t8 - e5);
    return o5 ? t8 < e5 ? s5 / 2 : 2 * s5 : s5 + Math.abs(i5) * i5;
  }
  _buildBreak(t8, e5, i5, o5, s5, c6) {
    let h5 = null, l5 = this._breakScore(e5, i5, s5, c6);
    for (const n5 of o5) {
      const t9 = e5 - n5.x, o6 = this._breakScore(t9, i5, s5, c6) + n5.score;
      o6 <= l5 && (h5 = n5, l5 = o6);
    }
  ...
  _applyJustification(t8, e5, i5) {
    const o5 = t8[i5], s5 = o5.vertical ? c5 : o5.glyphMosaicItem ? o5.glyphMosaicItem.metrics.advance : 0, h5 = (o5.x + s5) * this._justify;
    for (let c6 = e5; c6 <= i5; c6++)
      t8[c6].x -= h5;
  }
};
...
var f2 = class {
  constructor(e5, t8, i5, s5, o5, a4 = w, l5 = n2) {
    this.anchor = e5, this.labelAngle = t8, this.glyphAngle = i5, this.page = s5, this.alternateVerticalGlyph = o5, this.minzoom = a4, this.maxzoom = l5;
  }
};
var I2 = class {
  constructor(e5, t8, i5, n5, s5, o5, a4, l5, h5, r8, c6, g2) {
    this.tl = e5, this.tr = t8, this.bl = i5, this.br = n5, this.mosaicRect = s5, this.labelAngle = o5, this.minAngle = a4, this.maxAngle = l5, this.anchor = h5, this.minzoom = r8, this.maxzoom = c6, this.page = g2;
  }
};
var u2 = class {
  constructor(e5) {
...
var b2 = class {
  getIconPlacement(n5, s5, o5) {
    const a4 = new h(n5.x, n5.y), l5 = o5.rotationAlignment === l.MAP, h5 = o5.keepUpright;
    let r8 = o5.rotate * e2;
    l5 && (r8 += n5.angle);
    const m3 = new u2([]);
    return o5.allowOverlap && o5.ignorePlacement || !o || (m3.iconColliders = []), this._addIconPlacement(m3, a4, s5, o5, r8), l5 && h5 && this._addIconPlacement(m3, a4, s5, o5, r8 + t4), m3;
  }
  _addIconPlacement(t8, i5, s5, o5, a4) {
    ...
    const p3 = s5.rect, T4 = 2 / l5, y2 = x2 - T4, f3 = d - T4, u4 = y2 + p3.width / l5, b4 = f3 + p3.height / l5, P = new h(y2, f3), O = new h(u4, b4), _2 = new h(y2, b4), k = new h(u4, f3);
    if (0 !== a4) {
      const e5 = Math.cos(a4), t9 = Math.sin(a4);
      P.rotate(e5, t9), O.rotate(e5, t9), _2.rotate(e5, t9), k.rotate(e5, t9);
    }
    const M = new I2(P, k, _2, O, p3, a4, 0, 256, i5, w, n2, 0);
    if (t8.shapes.push(M), (!o5.allowOverlap || !o5.ignorePlacement) && o) {
      const e5 = o5.size, s6 = o5.padding, l6 = { xTile: i5.x, yTile: i5.y, dxPixels: x2 * e5 - s6, dyPixels: d * e5 - s6, hard: !o5.optional, partIndex: 0, width: h5 * e5 + 2 * s6, height: r8 * e5 + 2 * s6, angle: a4, minLod: w, maxLod: n2 };
      t8.iconColliders.push(l6);
    }
  }
  getTextPlacement(s5, o5, a4, c6) {
    const x2 = new h(s5.x, s5.y), d = c6.rotate * e2, y2 = c6.rotationAlignment === l.MAP, b4 = c6.keepUpright, P = c6.padding;
    let O = w;
    const _2 = !y2 ? 0 : s5.angle, k = s5.segment >= 0 && y2, M = c6.allowOverlap && c6.ignorePlacement ? null : [], E2 = [], G = 4, N2 = !k;
    ...
    let H, V = 0, j = 0;
    if (!k && B2) {
      const e5 = l3.getTextBox(o5, c6.lineHeight * c5);
      switch (c6.anchor) {
        case m.LEFT:
    ...
    for (const t8 of o5) {
      ...
      if (M && N2) {
        if (void 0 !== H && H !== t8.y) {
          ...
          const a5 = { xTile: s5.x, yTile: s5.y, dxPixels: e5 * R - P, dyPixels: t9 * R - P, hard: !c6.optional, partIndex: 1, width: i5 * R + 2 * P, height: o7 * R + 2 * P, angle: d, minLod: w, maxLod: n2 };
          M.push(a5), A2 = Number.POSITIVE_INFINITY, L2 = Number.NEGATIVE_INFINITY, z = A2, F = L2;
        }
        H = t8.y;
      }
      const m3 = [];
      if (k) {
        ...
        if (O = this._placeGlyph(s5, O, i5, a4, s5.segment, 1, t8.vertical, g2, m3), b4 && (O = this._placeGlyph(s5, O, i5, a4, s5.segment, -1, t8.vertical, g2, m3)), O >= T2)
          break;
      } else
        m3.push(new f2(x2, _2, _2, g2, false)), y2 && b4 && m3.push(new f2(x2, _2 + t4, _2 + t4, g2, false));
      ...
      for (const i5 of m3) {
        ...
        if (i5.alternateVerticalGlyph) {
          ...
          n5 = q, o7 = D, a5 = J, r8 = U;
        const g3 = C3, m4 = Y, x3 = i5.glyphAngle + d;
        if (0 !== x3) {
          const e5 = Math.cos(x3), t9 = Math.sin(x3);
          n5 = n5.clone(), o7 = o7 == null ? void 0 : o7.clone(), a5 = a5 == null ? void 0 : a5.clone(), r8 = r8 == null ? void 0 : r8.clone(), n5.rotate(e5, t9), r8 == null ? void 0 : r8.rotate(e5, t9), o7 == null ? void 0 : o7.rotate(e5, t9), a5 == null ? void 0 : a5.rotate(e5, t9);
        }
        let p3 = 0, w3 = 256;
        if (k && B2 ? t8.vertical ? i5.alternateVerticalGlyph ? (p3 = 32, w3 = 96) : (p3 = 224, w3 = 32) : (p3 = 224, w3 = 96) : (p3 = 192, w3 = 64), E2.push(new I2(n5, a5, o7, r8, l5, i5.labelAngle, p3, w3, i5.anchor, i5.minzoom, i5.maxzoom, i5.page)), M && (!v || this._legible(i5.labelAngle))) {
          if (N2)
            u4 < A2 && (A2 = u4), g3 < z && (z = g3), S > L2 && (L2 = S), m4 > F && (F = m4);
          else if (i5.minzoom < T2) {
            const e5 = { xTile: s5.x, yTile: s5.y, dxPixels: (u4 + V) * R - P, dyPixels: (g3 + V) * R - P, hard: !c6.optional, partIndex: 1, width: (S - u4) * R + 2 * P, height: (m4 - g3) * R + 2 * P, angle: x3, minLod: i5.minzoom, maxLod: i5.maxzoom };
            M.push(e5);
          }
        }
      }
    ...
    if (M && N2) {
      ...
      const a5 = { xTile: s5.x, yTile: s5.y, dxPixels: e5 * R - P, dyPixels: t8 * R - P, hard: !c6.optional, partIndex: 1, width: i5 * R + 2 * P, height: o6 * R + 2 * P, angle: d, minLod: w, maxLod: n2 };
      M.push(a5);
    }
    const C2 = new u2(E2);
  ...
  _placeGlyph(t8, s5, l5, h5, r8, c6, g2, m3, x2) {
    let d = c6;
    const p3 = d < 0 ? f(t8.angle + t4, r3) : t8.angle;
    let w3 = 0;
    l5 < 0 && (d *= -1, l5 *= -1, w3 = t4), d > 0 && ++r8;
    let T4 = new h(t8.x, t8.y), y2 = h5[r8], I4 = n2;
    if (h5.length <= r8)
      return I4;
    for (; ; ) {
      const e5 = y2.x - T4.x, t9 = y2.y - T4.y, i5 = Math.sqrt(e5 * e5 + t9 * t9), n5 = Math.max(l5 / i5, s5), c7 = e5 / i5, u4 = t9 / i5, b4 = f(Math.atan2(u4, c7) + w3, r3);
      if (x2.push(new f2(T4, p3, b4, m3, false, n5, I4)), g2 && x2.push(new f2(T4, p3, b4, m3, true, n5, I4)), n5 <= s5)
        return n5;
      T4 = y2.clone();
      do {
        if (r8 += d, h5.length <= r8 || r8 < 0)
          return n5;
        y2 = h5[r8];
      } while (T4.isEqual(y2));
...
var s2 = class {
    ...
    for (; r8.next(); )
      switch (r8.tag()) {
        ...
        case 2: {
          ...
          for (; !e6.empty(); ) {
            const r9 = e6.getUInt32(), a4 = e6.getUInt32();
            t9[s5[r9]] = o5[a4];
          }
          e6.release();
          break;
  ...
  getGeometry(s5) {
    ...
    let n5, i5 = t6.moveTo, l5 = 0, c6 = 0, h5 = 0;
    for (; !o5.empty(); ) {
      if (0 === l5) {
      ...
      switch (l5--, i5) {
        case t6.moveTo:
          c6 += o5.getSInt32(), h5 += o5.getSInt32(), s5 ? s5.moveTo(c6, h5) : r8 && (a4 && r8.push(a4), a4 = [], a4.push(new h(c6, h5)));
          break;
        case t6.lineTo:
          c6 += o5.getSInt32(), h5 += o5.getSInt32(), s5 ? s5.lineTo(c6, h5) : a4 && a4.push(new h(c6, h5));
          break;
        case t6.close:
          s5 ? s5.close() : a4 && !a4[0].equals(c6, h5) && a4.push(a4[0].clone());
          break;
        default:
          throw o5.release(), new Error("Invalid path operation");
      }
    }
    return s5 ? n5 = s5.result() : r8 && (a4 && r8.push(a4), n5 = r8), o5.release(), this._geometry = n5, n5;
  }
};
...
var o3 = class extends t5 {
  ...
  add(t8, o5, r8, u4, h5, a4, n5, d, e5, p3, i5, c6) {
    const M = this.array;
    let l5 = t5.i1616to32(t8, o5);
    M.push(l5);
    const m3 = 31;
    l5 = t5.i8888to32(Math.round(m3 * r8), Math.round(m3 * u4), Math.round(m3 * h5), Math.round(m3 * a4)), M.push(l5), l5 = t5.i8888to32(Math.round(m3 * n5), Math.round(m3 * d), Math.round(m3 * e5), Math.round(m3 * p3)), M.push(l5), l5 = t5.i1616to32(i5, 0), M.push(l5), c6 && M.push(...c6);
  }
};
...
var u3 = class extends t5 {
  ...
  add(t8, o5, r8, u4, h5, a4, n5) {
    const d = this.array, e5 = this.index;
    let p3 = t5.i1616to32(t8, o5);
    d.push(p3);
    const i5 = 15;
    return p3 = t5.i8888to32(Math.round(i5 * r8), Math.round(i5 * u4), h5, a4), d.push(p3), n5 && d.push(...n5), e5;
  }
};
var h4 = class extends t5 {
  ...
  add(o5, r8, u4, h5, a4, n5, d, e5, p3, i5, c6, M) {
    const l5 = this.array;
    let m3 = t5.i1616to32(o5, r8);
    l5.push(m3), m3 = t5.i1616to32(Math.round(8 * u4), Math.round(8 * h5)), l5.push(m3), m3 = t5.i8888to32(a4 / 4, n5 / 4, e5, p3), l5.push(m3), m3 = t5.i8888to32(0, i2(d), 10 * i5, Math.min(10 * c6, 255)), l5.push(m3), M && l5.push(...M);
  }
};
var a3 = class extends t5 {
  constructor(t8) {
    super(t8);
  }
  add(t8, o5, r8, u4, h5) {
    const a4 = this.array, n5 = t5.i1616to32(2 * t8 + r8, 2 * o5 + u4);
    a4.push(n5), h5 && a4.push(...h5);
  }
};
...
var r6 = class extends t7 {
  constructor(t8, r8, i5, c6, s5) {
    super(t8, r8, i5), this.type = E.CIRCLE, this._circleVertexBuffer = c6, this._circleIndexBuffer = s5;
  }
...
var s3 = class _s extends t7 {
  ...
  processFeatures(t8) {
    ...
    const o5 = e5.getPaintProperty("fill-pattern"), a4 = o5 == null ? void 0 : o5.isDataDriven;
    ...
    if (a4) {
      const n6 = [];
      for (const a5 of u4) {
        const u5 = o5.getValue(i5, a5), h5 = this._spriteInfo[u5];
        if (!(h5 == null ? void 0 : h5.rect))
          continue;
        const x2 = r8.encodeAttributes(a5, i5, e5, h5), c6 = f3 && s5 ? l5.encodeAttributes(a5, i5, e5) : [], _2 = a5.getGeometry(t8);
        n6.push({ ddFillAttributes: x2, ddOutlineAttributes: c6, page: h5.page, geometry: _2 }), n6.sort((t9, e6) => t9.page - e6.page);
        for (const { ddFillAttributes: t9, ddOutlineAttributes: i6, page: r9, geometry: l6 } of n6)
          this._processFeature(l6, f3, e5.outlineUsesFillColor, t9, i6, d, r9);
      }
    } else
      for (const h5 of u4) {
        const o6 = n5 ? r8.encodeAttributes(h5, i5, e5) : null, a5 = f3 && s5 ? l5.encodeAttributes(h5, i5, e5) : null, u5 = h5.getGeometry(t8);
        this._processFeature(u5, f3, e5.outlineUsesFillColor, o6, a5, d);
      }
  }
  serialize() {
    let t8 = 10;
    ...
    if (e5[r8++] = n5, n5 > 0)
      for (const [s5, [o5, a4]] of l5)
        e5[r8++] = s5, e5[r8++] = o5, e5[r8++] = a4;
  ...
  _processFeature(t8, e5, i5, r8, l5, n5, o5) {
    if (!t8)
      return;
    const a4 = t8.length, f3 = !l5 || 0 === l5.length;
    if (e5 && (!i5 || f3))
      for (let s5 = 0; s5 < a4; s5++)
        this._processOutline(t8[s5], l5);
    const u4 = 32;
    let d;
    for (let h5 = 0; h5 < a4; h5++) {
      const e6 = _s._area(t8[h5]);
      e6 > u4 ? (void 0 !== d && this._processFill(t8, d, r8, n5, o5), d = [h5]) : e6 < -u4 && void 0 !== d && d.push(h5);
    }
    void 0 !== d && this._processFill(t8, d, r8, n5, o5);
  }
  _processOutline(t8, e5) {
    ...
    if (!(I4 - p3 < 2)) {
      for (let r8 = p3; r8 < I4; ++r8) {
        r8 === p3 ? (s5 = t8[I4 - 1], o5 = t8[p3], a4 = t8[p3 + 1], f3.assignSub(o5, s5), f3.normalize(), f3.rightPerpendicular()) : (s5 = o5, o5 = a4, a4 = r8 !== I4 - 1 ? t8[r8 + 1] : t8[p3], f3.assign(u4));
        const n6 = this._isClipEdge(s5, o5);
        -1 === _2 && (g2 = n6), u4.assignSub(a4, o5), u4.normalize(), u4.rightPerpendicular();
        const B3 = f3.x * u4.y - f3.y * u4.x;
        d.assignAdd(f3, u4), d.normalize();
        const m4 = -d.x * -f3.x + -d.y * -f3.y;
        let V = Math.abs(0 !== m4 ? 1 / m4 : 1);
        V > 8 && (V = 8), B3 >= 0 ? (c6 = i5.add(o5.x, o5.y, f3.x, f3.y, 0, 1, e5), -1 === _2 && (_2 = c6), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6), x2 = i5.add(o5.x, o5.y, V * -d.x, V * -d.y, 0, -1, e5), -1 === y2 && (y2 = x2), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6), h5 = x2, x2 = c6, c6 = i5.add(o5.x, o5.y, d.x, d.y, 0, 1, e5), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6), x2 = i5.add(o5.x, o5.y, u4.x, u4.y, 0, 1, e5), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6)) : (c6 = i5.add(o5.x, o5.y, V * d.x, V * d.y, 0, 1, e5), -1 === _2 && (_2 = c6), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6), x2 = i5.add(o5.x, o5.y, -f3.x, -f3.y, 0, -1, e5), -1 === y2 && (y2 = x2), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6), h5 = x2, x2 = c6, c6 = i5.add(o5.x, o5.y, -d.x, -d.y, 0, -1, e5), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6), h5 = i5.add(o5.x, o5.y, -u4.x, -u4.y, 0, -1, e5), h5 >= 0 && x2 >= 0 && c6 >= 0 && !n6 && l5.add(h5, x2, c6));
      }
  ...
  _processFill(r8, l5, n5, s5, o5) {
    ...
    let f3 = 0;
    for (const t8 of l5)
      0 !== f3 && a4.push(f3), f3 += r8[t8].length;
    ...
    const h5 = i3(d, a4, 2);
    if (s5 && i3.deviation(d, a4, 2, h5) > 0) {
      const t8 = l5.map((t9) => r8[t9].length), { buffer: e5, vertexCount: s6 } = r2(d, t8);
      if (s6 > 0) {
      ...
      if (t8 > 0) {
        ...
        let i5 = 0;
        for (; i5 < u4; )
          this._fillVertexBuffer.add(d[i5++], d[i5++], n5);
        let r9 = 0;
        for (; r9 < t8; )
...
var n4 = class extends t7 {
  ...
  getResources(e5, t8, i5) {
    const s5 = this.layer, n5 = this.zoom, r8 = s5.getPaintProperty("line-pattern"), l5 = s5.getPaintProperty("line-dasharray"), a4 = s5.getLayoutProperty("line-cap");
    if (!r8 && !l5)
      return;
    const o5 = (a4 == null ? void 0 : a4.getValue(n5)) || 0, u4 = a4 == null ? void 0 : a4.isDataDriven, f3 = r8 == null ? void 0 : r8.isDataDriven, h5 = l5 == null ? void 0 : l5.isDataDriven;
    if (f3 || h5)
      for (const p3 of this._features)
        t8(f3 ? r8.getValue(n5, p3) : this._getDashArrayKey(p3, n5, s5, l5, u4, a4, o5));
    else if (r8)
      t8(r8.getValue(n5));
    else if (l5) {
  ...
  processFeatures(e5) {
    ...
    e5 && e5.setExtent(this.layerExtent);
    const a4 = t8.getPaintProperty("line-pattern"), o5 = t8.getPaintProperty("line-dasharray"), u4 = a4 == null ? void 0 : a4.isDataDriven, f3 = o5 == null ? void 0 : o5.isDataDriven;
    let h5;
    h5 = t8.getLayoutProperty("line-cap");
    const p3 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, g2 = p3 ? null : t8.getLayoutValue("line-cap", i5), y2 = g2 || 0, d = !!p3;
    h5 = t8.getLayoutProperty("line-join");
    const c6 = (h5 == null ? void 0 : h5.isDataDriven) ? h5 : null, _2 = c6 ? null : t8.getLayoutValue("line-join", i5);
    ...
    if (u4 || f3) {
      const r9 = [];
      for (const n6 of s5) {
        const s6 = u4 ? a4.getValue(i5, n6) : this._getDashArrayKey(n6, i5, t8, o5, d, p3, y2), f4 = this._spriteInfo[s6];
        if (!(f4 == null ? void 0 : f4.rect))
          continue;
        const h6 = l5.encodeAttributes(n6, i5, t8, f4), v = n6.getGeometry(e5);
        r9.push({ ddAttributes: h6, page: f4.page, cap: p3 ? p3.getValue(i5, n6) : g2, join: c6 ? c6.getValue(i5, n6) : _2, miterLimit: x2 ? x2.getValue(i5, n6) : V, roundLimit: m3 ? m3.getValue(i5, n6) : D, halfWidth: 0.5 * (P ? P.getValue(i5, n6) : I4), offset: L2 ? L2.getValue(i5, n6) : B2, geometry: v });
      }
      r9.sort((e6, t9) => e6.page - t9.page), n5.textured = true;
      for (const { ddAttributes: e6, page: t9, cap: i6, join: s6, miterLimit: l6, roundLimit: a5, halfWidth: o6, offset: u5, geometry: f4 } of r9)
        n5.capType = i6, n5.joinType = s6, n5.miterLimit = l6, n5.roundLimit = a5, n5.halfWidth = o6, n5.offset = u5, this._processFeature(f4, e6, t9);
    } else {
      if (a4) {
        const e6 = a4.getValue(i5), t9 = this._spriteInfo[e6];
        if (!(t9 == null ? void 0 : t9.rect))
          return;
      }
      n5.textured = !(!a4 && !o5), n5.capType = g2, n5.joinType = _2, n5.miterLimit = V, n5.roundLimit = D, n5.halfWidth = 0.5 * I4, n5.offset = B2;
      for (const a5 of s5) {
        const s6 = r8 ? l5.encodeAttributes(a5, i5, t8) : null;
        p3 && (n5.capType = p3.getValue(i5, a5)), c6 && (n5.joinType = c6.getValue(i5, a5)), x2 && (n5.miterLimit = x2.getValue(i5, a5)), m3 && (n5.roundLimit = m3.getValue(i5, a5)), P && (n5.halfWidth = 0.5 * P.getValue(i5, a5)), L2 && (n5.offset = L2.getValue(i5, a5));
        const o6 = a5.getGeometry(e5);
  ...
  serialize() {
    ...
    if (t8[s5++] = r8, r8 > 0)
      for (const [l5, [a4, o5]] of n5)
        t8[s5++] = l5, t8[s5++] = a4, t8[s5++] = o5;
  ...
  _processGeometry(e5, t8, i5) {
    if (e5.length < 2)
      return;
    const n5 = 1e-3;
    let r8, l5, a4 = e5[0], o5 = 1;
    for (; o5 < e5.length; )
      r8 = e5[o5].x - a4.x, l5 = e5[o5].y - a4.y, r8 * r8 + l5 * l5 < n5 * n5 ? e5.splice(o5, 1) : (a4 = e5[o5], ++o5);
    if (e5.length < 2)
      return;
  ...
  _getDashArrayKey(e5, t8, i5, s5, n5, r8, l5) {
    const a4 = n5 ? r8.getValue(t8, e5) : l5, o5 = s5.getValue(t8, e5);
    return i5.getDashKey(o5, a4);
  }
};
var r7 = (e5) => (t8, i5, s5, n5, r8, l5, a4, o5, u4, f3, h5) => (e5._lineVertexBuffer.add(t8, i5, a4, o5, s5, n5, r8, l5, u4, f3, h5, e5._ddValues), e5._lineVertexBuffer.index - 1);
var l4 = (e5) => (t8, i5, s5) => {
...
var L = class _L extends t7 {
  ...
  getResources(e5, t8, i5) {
    ...
    e5 && e5.setExtent(this.layerExtent);
    const a4 = s5.getLayoutProperty("icon-image"), r8 = s5.getLayoutProperty("text-field");
    let l5 = s5.getLayoutProperty("text-transform"), h5 = s5.getLayoutProperty("text-font");
    const x2 = [];
    let c6, d, f3, g2;
    a4 && !a4.isDataDriven && (c6 = a4.getValue(o5)), r8 && !r8.isDataDriven && (d = r8.getValue(o5)), l5 && l5.isDataDriven || (f3 = s5.getLayoutValue("text-transform", o5), l5 = null), h5 && h5.isDataDriven || (g2 = s5.getLayoutValue("text-font", o5), h5 = null);
    for (const m3 of this._features) {
      const u4 = m3.getGeometry(e5);
      if (!u4 || 0 === u4.length)
        continue;
      let p3, _2;
      a4 && (p3 = a4.isDataDriven ? a4.getValue(o5, m3) : this._replaceKeys(c6, m3.values), p3 && t8(p3));
      let M = false;
      if (r8 && (_2 = r8.isDataDriven ? r8.getValue(o5, m3) : this._replaceKeys(d, m3.values), _2)) {
  ...
  processFeatures(e5) {
    e5 && e5.setExtent(this.layerExtent);
    const n5 = this.layer, s5 = this.zoom, o5 = n5.getLayoutValue("symbol-placement", s5), r8 = o5 !== n3.POINT, l5 = n5.getLayoutValue("symbol-spacing", s5) * p2, g2 = n5.getLayoutProperty("icon-image"), y2 = n5.getLayoutProperty("text-field"), b4 = g2 ? new T(n5, s5, r8) : null, V = y2 ? new m2(n5, s5, r8) : null, T4 = this._workerTileHandler;
    let w3;
    ...
    const B2 = [];
    let C2 = 1;
    V && V.size && (C2 = V.size / c5);
    const R = V ? V.maxAngle * e2 : 0, D = V ? V.size * p2 : 0;
    for (const a4 of this._symbolFeatures) {
      let e6;
      b4 && w3 && a4.sprite && (e6 = w3[a4.sprite], e6 && e6.sdf && (this._isIconSDF = true));
      let n6;
      !!e6 && b4.update(s5, a4.feature);
      let g3 = 0;
      const y3 = a4.label;
      if (y3) {
        n(V), V.update(s5, a4.feature);
        ...
        const x2 = V.letterSpacing * c5, c6 = r8 ? 0 : V.maxWidth * c5, m3 = V.lineHeight * c5, P = a4.textFont.map((e8) => T4.getGlyphItems(e8));
        if (n6 = new l3(P, c6, m3, x2, i5, o6, l6).getShaping(y3, a4.rtl, e7), n6 && n6.length > 0) {
          let e8 = 1e30, t8 = -1e30;
          for (const i6 of n6)
      ...
      for (let t8 of a4.geometry) {
        ...
        if (o5 === n3.LINE) {
          ...
          o5 === n3.LINE_CENTER ? _L._pushCenterAnchor(s6, t8) : a4.feature.type === t2.Polygon ? _L._pushCentroid(s6, t8) : s6.push(new y(t8[0].x, t8[0].y));
        for (const i5 of s6) {
          if (i5.x < 0 || i5.x > x || i5.y < 0 || i5.y > x)
            continue;
          if (r8 && g3 > 0 && (V == null ? void 0 : V.rotationAlignment) === l.MAP && !_L._honorsTextMaxAngle(t8, i5, g3, R, D))
            continue;
          const s7 = { shaping: n6, line: t8, iconMosaicItem: e6, anchor: i5, symbolFeature: a4, textColliders: [], iconColliders: [], textVertexRanges: [], iconVertexRanges: [] };
          B2.push(s7), this._processFeature(s7, b4, V);
        }
      }
    }
  ...
  serialize() {
    ...
    for (const [o5, [a4, r8]] of this.markerPageMap)
      t8[s5++] = o5, t8[s5++] = a4, t8[s5++] = r8;
    t8[s5++] = this.glyphsPageMap.size;
    for (const [o5, [a4, r8]] of this.glyphsPageMap)
      t8[s5++] = o5, t8[s5++] = a4, t8[s5++] = r8;
  ...
  _processFeature(e5, t8, n5) {
    const { line: i5, iconMosaicItem: s5, shaping: o5, anchor: a4 } = e5, l5 = this.zoom, h5 = this.layer, x2 = !!s5;
    let c6 = true;
    x2 && (c6 = (t8 == null ? void 0 : t8.optional) || !s5);
    const d = o5 && o5.length > 0, f3 = !d || (n5 == null ? void 0 : n5.optional);
    let g2, y2;
    if (x2 && (g2 = this._placementEngine.getIconPlacement(a4, s5, t8)), (g2 || c6) && (d && (y2 = this._placementEngine.getTextPlacement(a4, o5, i5, n5)), y2 || f3)) {
      if (g2 && y2 || (f3 || c6 ? f3 || y2 ? c6 || g2 || (y2 = null) : g2 = null : (g2 = null, y2 = null)), y2) {
        ...
        if (this._storePlacedGlyphs(e5, y2.shapes, l5, n5.rotationAlignment, t9), y2.textColliders) {
          ...
          for (const e6 of y2.textColliders) {
            ...
            const t10 = e6.angle;
            if (t10) {
              const n6 = Math.cos(t10), i6 = Math.sin(t10), s6 = e6.dxPixels * n6 - e6.dyPixels * i6, o6 = e6.dxPixels * i6 + e6.dyPixels * n6, a5 = (e6.dxPixels + e6.width) * n6 - e6.dyPixels * i6, r8 = (e6.dxPixels + e6.width) * i6 + e6.dyPixels * n6, l6 = e6.dxPixels * n6 - (e6.dyPixels + e6.height) * i6, h6 = e6.dxPixels * i6 + (e6.dyPixels + e6.height) * n6, x3 = (e6.dxPixels + e6.width) * n6 - (e6.dyPixels + e6.height) * i6, c7 = (e6.dxPixels + e6.width) * i6 + (e6.dyPixels + e6.height) * n6, d2 = Math.min(s6, a5, l6, x3), f4 = Math.max(s6, a5, l6, x3), g3 = Math.min(o6, r8, h6, c7), y3 = Math.max(o6, r8, h6, c7);
              e6.dxPixels = d2, e6.dyPixels = g3, e6.width = f4 - d2, e6.height = y3 - g3;
            }
          }
        }
      }
      if (g2) {
        ...
        if (this._addPlacedIcons(e5, g2.shapes, l5, s5.page, t8.rotationAlignment === l.VIEWPORT, n6), g2.iconColliders) {
          ...
          for (const e6 of g2.iconColliders) {
            ...
            const t9 = e6.angle;
            if (t9) {
              const n7 = Math.cos(t9), i6 = Math.sin(t9), s6 = e6.dxPixels * n7 - e6.dyPixels * i6, o6 = e6.dxPixels * i6 + e6.dyPixels * n7, a5 = (e6.dxPixels + e6.width) * n7 - e6.dyPixels * i6, r8 = (e6.dxPixels + e6.width) * i6 + e6.dyPixels * n7, l6 = e6.dxPixels * n7 - (e6.dyPixels + e6.height) * i6, h6 = e6.dxPixels * i6 + (e6.dyPixels + e6.height) * n7, x3 = (e6.dxPixels + e6.width) * n7 - (e6.dyPixels + e6.height) * i6, c7 = (e6.dxPixels + e6.width) * i6 + (e6.dyPixels + e6.height) * n7, d2 = Math.min(s6, a5, l6, x3), f4 = Math.max(s6, a5, l6, x3), g3 = Math.min(o6, r8, h6, c7), y3 = Math.max(o6, r8, h6, c7);
              e6.dxPixels = d2, e6.dyPixels = g3, e6.width = f4 - d2, e6.height = y3 - g3;
            }
          }
        }
  ...
  _addPlacedIcons(e5, t8, n5, i5, s5, o5) {
    const a4 = Math.max(n5 - 1, 0), l5 = this._iconVertexBuffer, h5 = this._iconIndexBuffer, x2 = this._markerMap;
    for (const c6 of t8) {
      const t9 = s5 ? 0 : Math.max(n5 + N(c6.minzoom), a4), d = s5 ? 25 : Math.min(n5 + N(c6.maxzoom), 25);
      if (d <= t9)
        continue;
      const f3 = c6.tl, g2 = c6.tr, y2 = c6.bl, m3 = c6.br, u4 = c6.mosaicRect, p3 = c6.labelAngle, _2 = c6.minAngle, M = c6.maxAngle, P = c6.anchor, I4 = l5.index, b4 = u4.x, A2 = u4.y, L2 = b4 + u4.width, V = A2 + u4.height, T4 = l5.index;
      l5.add(P.x, P.y, f3.x, f3.y, b4, A2, p3, _2, M, t9, d, o5), l5.add(P.x, P.y, g2.x, g2.y, L2, A2, p3, _2, M, t9, d, o5), l5.add(P.x, P.y, y2.x, y2.y, b4, V, p3, _2, M, t9, d, o5), l5.add(P.x, P.y, m3.x, m3.y, L2, V, p3, _2, M, t9, d, o5), e5.iconVertexRanges.length > 0 && e5.iconVertexRanges[0][0] + e5.iconVertexRanges[0][1] === T4 ? e5.iconVertexRanges[0][1] += 4 : e5.iconVertexRanges.push([T4, 4]), h5.add(I4, I4 + 1, I4 + 2), h5.add(I4 + 1, I4 + 2, I4 + 3), x2.has(i5) ? x2.get(i5)[1] += 6 : x2.set(i5, [this._iconIndexStart + this._iconIndexCount, 6]), this._iconIndexCount += 6;
    }
  }
  _addPlacedGlyphs() {
    ...
    for (const [i5, s5] of this._glyphBufferDataStorage)
      for (const o5 of s5) {
        const s6 = e5.index, a4 = o5.symbolInstance, r8 = o5.ddAttributes, l5 = e5.index;
        e5.add(o5.glyphAnchor[0], o5.glyphAnchor[1], o5.tl[0], o5.tl[1], o5.xmin, o5.ymin, o5.labelAngle, o5.minAngle, o5.maxAngle, o5.minLod, o5.maxLod, r8), e5.add(o5.glyphAnchor[0], o5.glyphAnchor[1], o5.tr[0], o5.tr[1], o5.xmax, o5.ymin, o5.labelAngle, o5.minAngle, o5.maxAngle, o5.minLod, o5.maxLod, r8), e5.add(o5.glyphAnchor[0], o5.glyphAnchor[1], o5.bl[0], o5.bl[1], o5.xmin, o5.ymax, o5.labelAngle, o5.minAngle, o5.maxAngle, o5.minLod, o5.maxLod, r8), e5.add(o5.glyphAnchor[0], o5.glyphAnchor[1], o5.br[0], o5.br[1], o5.xmax, o5.ymax, o5.labelAngle, o5.minAngle, o5.maxAngle, o5.minLod, o5.maxLod, r8), a4.textVertexRanges.length > 0 && a4.textVertexRanges[0][0] + a4.textVertexRanges[0][1] === l5 ? a4.textVertexRanges[0][1] += 4 : a4.textVertexRanges.push([l5, 4]), t8.add(s6, s6 + 1, s6 + 2), t8.add(s6 + 1, s6 + 2, s6 + 3), n5.has(i5) ? n5.get(i5)[1] += 6 : n5.set(i5, [this._textIndexStart + this._textIndexCount, 6]), this._textIndexCount += 6;
      }
    this._glyphBufferDataStorage.clear();
  }
  _storePlacedGlyphs(e5, t8, n5, i5, s5) {
    const o5 = Math.max(n5 - 1, 0), a4 = i5 === l.VIEWPORT;
    let l5, h5, x2, c6, d, f3, g2, y2, m3, p3, _2;
    for (const u4 of t8) {
      if (l5 = a4 ? 0 : Math.max(n5 + N(u4.minzoom), o5), h5 = a4 ? 25 : Math.min(n5 + N(u4.maxzoom), 25), h5 <= l5)
        continue;
      x2 = u4.tl, c6 = u4.tr, d = u4.bl, f3 = u4.br, g2 = u4.labelAngle, y2 = u4.minAngle, m3 = u4.maxAngle, p3 = u4.anchor, _2 = u4.mosaicRect, this._glyphBufferDataStorage.has(u4.page) || this._glyphBufferDataStorage.set(u4.page, []);
      this._glyphBufferDataStorage.get(u4.page).push({ glyphAnchor: [p3.x, p3.y], tl: [x2.x, x2.y], tr: [c6.x, c6.y], bl: [d.x, d.y], br: [f3.x, f3.y], xmin: _2.x, ymin: _2.y, xmax: _2.x + _2.width, ymax: _2.y + _2.height, labelAngle: g2, minAngle: y2, maxAngle: m3, minLod: l5, maxLod: h5, placementLod: o5, symbolInstance: e5, ddAttributes: s5 });
    }
  }
  static _pushAnchors(e5, t8, n5, i5) {
    n5 += i5;
    let o5 = 0;
    const a4 = t8.length - 1;
    ...
    if (r8 *= 0.5, o5 <= r8)
      return;
    const h5 = r8 / o5;
    let c6 = 0, d = -(n5 = o5 / Math.max(Math.round(o5 / n5), 1)) / 2;
    const f3 = t8.length - 1;
    for (let s5 = 0; s5 < f3; s5++) {
      const i6 = t8[s5], o6 = t8[s5 + 1], a5 = o6.x - i6.x, r9 = o6.y - i6.y, f4 = Math.sqrt(a5 * a5 + r9 * r9);
      let g2;
      for (; d + n5 < c6 + f4; ) {
        d += n5;
        const t9 = (d - c6) / f4, y2 = h2(i6.x, o6.x, t9), m3 = h2(i6.y, o6.y, t9);
        void 0 === g2 && (g2 = Math.atan2(r9, a5)), e5.push(new y(y2, m3, g2, s5, h5));
      }
      c6 += f4;
    }
  }
  static _pushCenterAnchor(e5, t8) {
    ...
    for (let s5 = 0; s5 < r8; s5++) {
      const n6 = t8[s5], i6 = t8[s5 + 1], r9 = i6.x - n6.x, h5 = i6.y - n6.y, c6 = Math.sqrt(r9 * r9 + h5 * h5);
      if (o5 < a4 + c6) {
        const t9 = (o5 - a4) / c6, d = h2(n6.x, i6.x, t9), f3 = h2(n6.y, i6.y, t9), g2 = Math.atan2(h5, r9);
        return void e5.push(new y(d, f3, g2, s5, 0));
      }
      a4 += c6;
    }
  }
  ...
  static _honorsTextMaxAngle(e5, t8, n5, i5, o5) {
    ...
    for (; a4 > -r8; ) {
      if (--h5, h5 < 0)
        return false;
      a4 -= h.distance(e5[h5], l5), l5 = e5[h5];
    }
    a4 += h.distance(e5[h5], e5[h5 + 1]);
    const x2 = [];
    let c6 = 0;
    const d = e5.length;
    for (; a4 < r8; ) {
      ...
      for (x2.push({ deviation: g2, distToAnchor: a4 }), c6 += g2; a4 - x2[0].distToAnchor > o5; )
        c6 -= x2.shift().deviation;
      if (Math.abs(c6) > i5)
        return false;
      a4 += h.distance(n6, l6), h5 = r9;
    }
    return true;
  }
  static _smoothVertices(e5, t8) {
    ...
    for (let y2 = 1; y2 < n5; y2++) {
      ...
      t9 > 0 && (o5 += t9, i5.push(o5), a4++, a4 !== y2 && (e5[a4] = e5[y2]));
    }
    if (n5 = a4 + 1, n5 < 3)
      return e5;
    t8 = Math.min(t8, 0.2 * o5);
    const r8 = e5[0].x, l5 = e5[0].y, h5 = e5[n5 - 1].x, x2 = e5[n5 - 1].y, c6 = h.sub(e5[0], e5[1]);
    c6.normalize(), e5[0].x += t8 * c6.x, e5[0].y += t8 * c6.y, c6.assignSub(e5[n5 - 1], e5[n5 - 2]), c6.normalize(), e5[n5 - 1].x += t8 * c6.x, e5[n5 - 1].y += t8 * c6.y, i5[0] -= t8, i5[n5 - 1] += t8;
    const d = [];
    d.push(new h(r8, l5));
    ...
    for (let y2 = 1; y2 < n5 - 1; y2++) {
      ...
      for (let n6 = y2 - 1; n6 >= 0; n6--) {
        ...
        if (h6 < f3)
          break;
        const x3 = h6 * h6, c7 = h6 * s5 - 0.5 * x3 * l6, d2 = h6 * l6 / t8, m3 = e5[n6 + 1], u4 = e5[n6].x - m3.x, p3 = e5[n6].y - m3.y;
        o6 += d2 / c7 * (m3.x * h6 * s5 + 0.5 * x3 * (s5 * u4 - l6 * m3.x) - x3 * h6 * l6 * u4 / 3), a5 += d2 / c7 * (m3.y * h6 * s5 + 0.5 * x3 * (s5 * p3 - l6 * m3.y) - x3 * h6 * l6 * p3 / 3), r9 += d2;
      }
      for (let s5 = y2 + 1; s5 < n5; s5++) {
        ...
        if (h6 < f3)
          break;
        const x3 = h6 * h6, c7 = h6 * n6 - 0.5 * x3 * l6, d2 = h6 * l6 / t8, m3 = e5[s5 - 1], u4 = e5[s5].x - m3.x, p3 = e5[s5].y - m3.y;
        o6 += d2 / c7 * (m3.x * h6 * n6 + 0.5 * x3 * (n6 * u4 - l6 * m3.x) - x3 * h6 * l6 * u4 / 3), a5 += d2 / c7 * (m3.y * h6 * n6 + 0.5 * x3 * (n6 * p3 - l6 * m3.y) - x3 * h6 * l6 * p3 / 3), r9 += d2;
      }
      d.push(new h(o6 / r9, a5 / r9));
    }
    return d.push(new h(h5, x2)), e5[0].x = r8, e5[0].y = l5, e5[n5 - 1].x = h5, e5[n5 - 1].y = x2, d;
  }
  static _pushCentroid(e5, t8) {
    const n5 = 0, i5 = 0, s5 = 4096, o5 = 4096, a4 = t8.length - 1;
    let r8 = 0, l5 = 0, h5 = 0, c6 = t8[0].x, d = t8[0].y;
    c6 > s5 && (c6 = s5), c6 < n5 && (c6 = n5), d > o5 && (d = o5), d < i5 && (d = i5);
    for (let x2 = 1; x2 < a4; x2++) {
      let e6 = t8[x2].x, a5 = t8[x2].y, f3 = t8[x2 + 1].x, g2 = t8[x2 + 1].y;
      e6 > s5 && (e6 = s5), e6 < n5 && (e6 = n5), a5 > o5 && (a5 = o5), a5 < i5 && (a5 = i5), f3 > s5 && (f3 = s5), f3 < n5 && (f3 = n5), g2 > o5 && (g2 = o5), g2 < i5 && (g2 = i5);
      const y2 = (e6 - c6) * (g2 - d) - (f3 - c6) * (a5 - d);
      r8 += y2 * (c6 + e6 + f3), l5 += y2 * (d + a5 + g2), h5 += y2;
    }
...
var w2 = 16;
var B = class {
  constructor(t8, r8, o5, n5, c6) {
    var _a;
    if (this._pbfTiles = {}, this._tileClippers = {}, this._client = o5, this._tile = r8, c6) {
    ...
    const [l5, a4, u4] = r8.tileKey.split("/").map(parseFloat);
    this._level = l5;
    const f3 = T3 + Math.max((this._level - g) * w2, 0);
    for (const p3 of Object.keys(t8)) {
      const r9 = t8[p3];
      this._pbfTiles[p3] = new r(new Uint8Array(r9.protobuff), new DataView(r9.protobuff));
      if (r9.refKey) {
        const [e5] = r9.refKey.split("/").map(parseFloat), t9 = l5 - e5;
        if (t9 > 0) {
          const e6 = (1 << t9) - 1, r10 = a4 & e6, i5 = u4 & e6;
  ...
  async parse(e5) {
    ...
    const o5 = [], n5 = /* @__PURE__ */ new Set(), c6 = (e6, t9) => {
      n5.has(e6) || (o5.push({ name: e6, repeat: t9 }), n5.add(e6));
    }, l5 = {};
    for (const r8 of i5)
      r8.getResources(r8.tileClipper, c6, l5);
    if (this._tile.status === I3.INVALID)
      return [];
    const a4 = this._fetchResources(o5, l5, e5);
    return Promise.all([...a4, t8]).then(() => this._processFeatures(s5.returnedBuckets));
  }
  _initialize(e5) {
  ...
  _processLayers(e5) {
    const { sourceNameToTileData: t8, layers: r8, zoom: s5, sourceNameToTileClipper: i5, sourceNameToUniqueSourceLayerBuckets: o5, sourceNameToUniqueSourceLayers: n5, returnedBuckets: c6, layerIdToBucket: l5, referencerUIDToReferencedId: a4 } = e5;
      ...
      if (m3) {
        ...
        if (t9 || (t9 = n5[e6.source] = /* @__PURE__ */ new Set()), t9.add(e6.sourceLayer), e6.refLayerId)
          ...
          if (t10) {
            ...
            r9 || (r9 = o5[e6.source] = {});
            let s6 = r9[h5];
            s6 || (s6 = r9[h5] = []), s6.push(t10), c6.push(t10), l5[e6.id] = t10;
          }
        }
      }
    }
  ...
  _filterFeatures(e5) {
    const { signal: r8, sourceNameToTileData: s5, sourceNameToUniqueSourceLayerBuckets: i5, sourceNameToUniqueSourceLayers: n5 } = e5, c6 = 10 * this._level, l5 = 10 * (this._level + 1), a4 = [], u4 = [];
    for (const t8 of Object.keys(n5)) {
      n5[t8].forEach((e6) => {
        a4.push(e6), u4.push(t8);
      });
    }
    for (let f3 = 0; f3 < a4.length; f3++) {
      const e6 = u4[f3], n6 = a4[f3];
      if (!s5[e6] || !i5[e6])
        continue;
  ...
  _fetchResources(e5, t8, r8) {
    ...
    for (const c6 in t8) {
      const e6 = t8[c6];
      e6.size > 0 && (n5 = i5.fetchGlyphs(this._tile.tileKey, c6, e6, this._client, r8), s5.push(n5));
    }
    return s5;
  }
  _processFeatures(e5) {
  ...
  _createCircleBucket(e5) {
    return new r6(e5, this._level, this._tile.getWorkerTileHandler().getSpriteItems(), new a3(e5.circleMaterial.getStride()), new r4());
  }
...
var i4 = class {
  constructor(t8, s5, i5, a4) {
    this.status = I3.INITIALIZED, this.placementEngine = new b2(), this.tileKey = t8, this.refKeys = s5, this._workerTileHandler = i5, this._styleRepository = a4;
  }
  release() {
    this.tileKey = "", this.refKeys = null, this.status = I3.INITIALIZED, this._workerTileHandler = null;
  }
  async parse(e5, s5) {
    const i5 = s5 == null ? void 0 : s5.signal;
    if (null != i5) {
      const t8 = () => {
...
var o4 = class {
  ...
  async createTileAndParse(t8, r8) {
    ...
    try {
      ...
      if (n5.setObsolete(), n5.release(), !b(l5))
        throw l5;
      return null;
    }
  }
  ...
  fetchSprites(e5, t8, s5) {
    ...
    return 0 === r8.length ? Promise.resolve() : t8.invoke("getSprites", r8, { signal: s5 == null ? void 0 : s5.signal }).then((e6) => {
      for (const t9 in e6) {
        const s6 = e6[t9];
        o5[t9] = s6;
      }
...
//# sourceMappingURL=WorkerTileHandler-MH2GCKTM.js.map
