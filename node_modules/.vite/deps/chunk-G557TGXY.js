...
var h = class _h {
  static blendColors(t, r2, s2, i2 = new _h()) {
  ...
  static fromHex(t, r2 = new _h()) {
    ...
    switch (t.length) {
      case 4:
      case 5: {
        const s2 = parseInt(t.substring(1, 2), 16), i2 = parseInt(t.substring(2, 3), 16), n = parseInt(t.substring(3, 4), 16), a2 = 5 === t.length ? 15 : parseInt(t.substring(4), 16);
        return _h.fromArray([s2 + 16 * s2, i2 + 16 * i2, n + 16 * n, (a2 + 16 * a2) / 255], r2);
      }
      case 7:
      case 9: {
        const s2 = parseInt(t.substring(1, 3), 16), i2 = parseInt(t.substring(3, 5), 16), n = parseInt(t.substring(5, 7), 16), a2 = 7 === t.length ? 255 : parseInt(t.substring(7), 16);
        return _h.fromArray([s2, i2, n, a2 / 255], r2);
      }
      default:
        return null;
    }
  ...
  static fromString(t, i2) {
    ...
    return n && _h.fromArray(n, i2) || _h.fromRgb(t, i2) || _h.fromHex(t, i2);
  }
  static fromJSON(t) {
  ...
  toHex(t) {
    const r2 = (t == null ? void 0 : t.capitalize) ?? false, s2 = (t == null ? void 0 : t.digits) ?? 6, i2 = 3 === s2 || 4 === s2, n = 4 === s2 || 8 === s2, a2 = `#${o2(this.r, i2)}${o2(this.g, i2)}${o2(this.b, i2)}${n ? o2(Math.round(255 * this.a), i2) : ""}`;
  ...
  toArray(t = _h.AlphaMode.ALWAYS) {
    ...
    return t === _h.AlphaMode.ALWAYS || 1 !== this.a ? [r2, s2, i2, a(255 * this.a)] : [r2, s2, i2];
  }
  clone() {
...
//# sourceMappingURL=chunk-G557TGXY.js.map
