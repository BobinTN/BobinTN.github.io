...
var e = class {
  constructor(t2) {
    this._rctx = t2, this._store = new t();
  }
  dispose() {
    this._store.forEach((r) => r.forEach((r2) => r2.dispose())), this._store.clear();
  }
  acquire(r, e3, s, o) {
    const c = this._store.get(r, e3);
    if (null != c)
      return c.ref(), c;
    const h = new m(this._rctx, r, e3, s, o);
    return h.ref(), this._store.set(r, e3, h), h;
  }
  get test() {
    let r = 0;
    return this._store.forEach((t2) => t2.forEach((t3) => r += t3.hasGLName ? 2 : 1)), { cachedWebGLProgramObjects: r };
  }
};
...
//# sourceMappingURL=chunk-FUZOO24T.js.map
