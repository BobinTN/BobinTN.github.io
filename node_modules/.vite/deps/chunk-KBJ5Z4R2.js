...
function d(t) {
  const o3 = DateTime.local().setZone(t), r2 = Math.min(o3.set({ month: 1, day: 1 }).offset, o3.set({ month: 5 }).offset);
  if (0 === r2)
    return "Etc/UTC";
  return `Etc/GMT${FixedOffsetZone.instance(-r2).formatOffset(0, "narrow")}`;
}
function g(t, e, n, o3, s3) {
  if (e && "date" === s3)
    return { timeZone: i, timeZoneName: void 0 };
  const m2 = o3.timeStyle || o3.hour, u3 = n === r;
  return { timeZone: u3 ? "timestamp-offset" === s3 ? void 0 : t ?? i : n, timeZoneName: u3 && m2 ? a2 : void 0 };
}
...
function v(t) {
  let e = w.get(t);
  if (!e) {
    const n = c(), a3 = Z2[n] || n, m2 = F(t.timeZone ?? o2), h2 = { ...t, timeZone: m2 };
...
function x(t, e = p) {
  ...
  const r2 = DateTime.fromISO(t, { setZone: true }), a3 = c(), m2 = Z2[a3] ?? a3, h2 = 0 === r2.offset ? i : e.timeZone, s3 = { ...e, timeZone: h2 };
...
//# sourceMappingURL=chunk-KBJ5Z4R2.js.map
