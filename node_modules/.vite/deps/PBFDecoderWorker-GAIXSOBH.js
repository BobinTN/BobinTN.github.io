...
var m = class {
  ...
  addQueryGeometry(t4, e2) {
    const { queryGeometry: r, queryGeometryType: s2 } = e2, o3 = It(r.clone(), r, false, false, this._transform), i = st(o3, s2, false, false);
    let h2 = null;
    switch (s2) {
    ...
    i.type = h2, t4.queryGeometryType = s2, t4.queryGeometry = i;
  }
  prepareFeatures(e2) {
  ...
  _dehydratedAddPointsCoordinate(t4, e2, r) {
    ...
    const s2 = this._transformPathLikeValue(e2, r), o3 = t4[t4.length - 1], i = this._coordinateBuffer;
    if (i) {
      if (0 === r) {
        const t5 = this._coordinateBufferPtr * Float64Array.BYTES_PER_ELEMENT;
        o3.push(new Float64Array(i.buffer, t5, this._vertexDimension));
      }
...
var t3 = class {
  _parseFeatureQuery(t4) {
    var _a;
    const s2 = t(t4.buffer, new m(t4.options)), o3 = { ...s2, spatialReference: (_a = s2.spatialReference) == null ? void 0 : _a.toJSON(), fields: s2.fields ? s2.fields.map((e2) => e2.toJSON()) : void 0 };
...
//# sourceMappingURL=PBFDecoderWorker-GAIXSOBH.js.map
