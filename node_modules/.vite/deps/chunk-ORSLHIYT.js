...
var a = o()({ esriDOTComplete: "complete", esriDOTCompleteNoEvents: "complete-no-events", esriDOTFeatureSets: "featuresets", esriDOTInstructionsOnly: "instructions-only", esriDOTStandard: "standard", esriDOTSummaryOnly: "summary-only" });
...
var l = o()({ esriNFSBAllowBacktrack: "allow-backtrack", esriNFSBAtDeadEndsOnly: "at-dead-ends-only", esriNFSBNoBacktrack: "no-backtrack", esriNFSBAtDeadEndsAndIntersections: "at-dead-ends-and-intersections" });
var d = o()({ esriNATravelDirectionFromFacility: "from-facility", esriNATravelDirectionToFacility: "to-facility" });
var c3 = o()({ esriNATimeOfDayNotUsed: "not-used", esriNATimeOfDayUseAsStartTime: "start", esriNATimeOfDayUseAsEndTime: "end" });
...
var h = o()({ 0: "stop", 1: "waypoint", 2: "break" }, { useNumericKeys: true });
...
var A = o()({ 0: "restriction", 1: "scaled-cost", 2: "added-cost" }, { useNumericKeys: true });
...
var f2 = o()({ Kilometers: "kilometers", Miles: "miles", Meters: "meters" }, { ignoreUnknown: false });
...
h2.fields = [{ name: "ObjectID", alias: "ObjectID", type: "esriFieldTypeOID", editable: false, nullable: false, domain: null }, { name: "BarrierType", alias: "Barrier Type", type: "esriFieldTypeInteger", editable: true, nullable: true, visible: true, domain: { type: "codedValue", name: "esriNABarrierType", codedValues: [{ name: "Restriction", code: 0 }, { name: "Scaled Cost", code: 1 }, { name: "Added Cost", code: 2 }] } }, { name: "Costs", alias: "Costs", type: "esriFieldTypeString", length: 1048576, editable: true, nullable: true, visible: false, domain: null }, { name: "Name", alias: "Name", type: "esriFieldTypeString", length: 255, editable: true, nullable: true, visible: true }, { name: "ScaleFactor", alias: "Scale Factor", type: "esriFieldTypeDouble", editable: true, nullable: true, visible: true }], h2.popupInfo = { title: "Polygon Barriers", fieldInfos: [{ fieldName: "Name", label: "Name", isEditable: true, tooltip: "", visible: true, stringFieldOption: "textbox" }, { fieldName: "BarrierType", label: "Barrier Type", isEditable: true, tooltip: "", visible: true, stringFieldOption: "textbox" }, { fieldName: "ScaleFactor", isEditable: true, tooltip: "", visible: true, format: { places: 3, digitSeparator: true }, stringFieldOption: "textbox" }, { fieldName: "Costs", label: "Costs", isEditable: true, tooltip: "", visible: false, stringFieldOption: "textbox" }], description: null, showAttachments: false, mediaInfos: [] }, e([y({ type: A.apiValues, json: { name: "attributes.BarrierType", read: { reader: A.read }, write: { writer: A.write } } })], h2.prototype, "barrierType", void 0), e([y()], h2.prototype, "costs", void 0), e([o2("costs", ["attributes"])], h2.prototype, "readCosts", null), e([r("costs")], h2.prototype, "writeCosts", null), e([y({ type: j, json: { write: true } })], h2.prototype, "geometry", void 0), e([y({ json: { name: "attributes.Name" } })], h2.prototype, "name", void 0), e([y({ json: { name: "attributes.ObjectID" } })], h2.prototype, "objectId", void 0), e([y({ type: k })], h2.prototype, "popupTemplate", void 0), e([y()], h2.prototype, "scaleFactor", void 0), e([y({ types: j2 })], h2.prototype, "symbol", void 0), e([y({ readOnly: true, json: { read: false } })], h2.prototype, "type", void 0), h2 = j3 = e([c("esri.rest.support.PolygonBarrier")], h2);
var T3 = h2;

// node_modules/@arcgis/core/rest/support/PolylineBarrier.js
var d3;
var y3 = d3 = class extends i(f) {
  constructor(e3) {
...
//# sourceMappingURL=chunk-ORSLHIYT.js.map
