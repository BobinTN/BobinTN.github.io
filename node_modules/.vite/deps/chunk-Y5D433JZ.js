...
function u(n2, t2) {
  const { xmin: r3, ymin: u4, zmin: i3, xmax: o3, ymax: f5, zmax: c4 } = t2;
  return n2.hasZ && t2.hasZ ? e2(n2, r3, u4, i3) && e2(n2, r3, f5, i3) && e2(n2, o3, f5, i3) && e2(n2, o3, u4, i3) && e2(n2, r3, u4, c4) && e2(n2, r3, f5, c4) && e2(n2, o3, f5, c4) && e2(n2, o3, u4, c4) : e2(n2, r3, u4) && e2(n2, r3, f5) && e2(n2, o3, f5) && e2(n2, o3, u4);
}
function i(n2, t2) {
...
var m2 = [0, 0];
var l = [s2, u2, c3, m2];
var a = [[c3, s2], [s2, u2], [u2, m2], [m2, c3]];
function x4(n2, t2) {
  return y2(n2, t2.rings);
}
function y2(n2, r3) {
  s2[0] = n2.xmin, s2[1] = n2.ymax, u2[0] = n2.xmax, u2[1] = n2.ymax, c3[0] = n2.xmin, c3[1] = n2.ymin, m2[0] = n2.xmax, m2[1] = n2.ymin;
  for (const e3 of l)
    if (s(r3, e3))
      return true;
  for (const t2 of r3) {
    ...
    for (let i3 = 0; i3 < e3.length - 1; i3++) {
      ...
      for (let e4 = t2 + 1; e4 < n2.length; e4++)
        for (let t3 = 0; t3 < n2[e4].length - 1; t3++) {
          ...
          if (G2(r4, o3, i4, f5, g) && !(g[0] === r4[0] && g[1] === r4[1] || g[0] === i4[0] && g[1] === i4[1] || g[0] === o3[0] && g[1] === o3[1] || g[0] === f5[0] && g[1] === f5[1]))
            return true;
        }
    }
    const r3 = e3.length;
    if (!(r3 <= 4))
      for (let n3 = 0; n3 < r3 - 3; n3++) {
        ...
        for (let r4 = n3 + 2; r4 < t3; r4++) {
          ...
          if (G2(i3, o3, n4, t4, g) && !(g[0] === i3[0] && g[1] === i3[1] || g[0] === n4[0] && g[1] === n4[1] || g[0] === o3[0] && g[1] === o3[1] || g[0] === t4[0] && g[1] === t4[1]))
            return true;
        }
      }
  }
...
function z(n2, t2, e3) {
  for (let r3 = 0; r3 < e3.length; r3++)
    if (G2(n2, t2, e3[r3][0], e3[r3][1]))
      return true;
  return false;
}
function G2(n2, t2, e3, r3, i3) {
  const [o3, f5] = n2, [s3, u4] = t2, [c4, m3] = e3, [l2, a2] = r3, x5 = l2 - c4, y3 = o3 - c4, h2 = s3 - o3, g2 = a2 - m3, p3 = f5 - m3, z3 = u4 - f5, G3 = g2 * h2 - x5 * z3;
  if (0 === G3)
    return false;
  const Z2 = (x5 * p3 - g2 * y3) / G3, P = (h2 * p3 - z3 * y3) / G3;
...
var z2 = u3 = class extends p {
  ...
  intersects(t2) {
    ...
    const i3 = this.spatialReference, e3 = t2.spatialReference;
    i3 && e3 && !d(i3, e3) && x(i3, e3) && (t2 = i3.isWebMercator ? d2(t2) : R(t2, true));
  ...
  _normalize(t2, i3, e3) {
    ...
    return m3.forEach((t3) => {
      t3.hasZ || (r3 = false), t3.hasM || (a2 = false);
    }), { rings: m3.map((t3) => {
      ...
      return i4;
    }), hasZ: r3, hasM: a2, spatialReference: s3 };
  }
  _getParts(t2) {
    let i3 = this.cache._parts;
    if (!i3) {
      i3 = [];
      const { ymin: e4, ymax: s4, spatialReference: n2 } = this, m3 = this.width, r3 = this.xmin, a2 = this.xmax;
      let h2;
      t2 = t2 || G(n2);
      const [o3, x5] = t2.valid;
      h2 = this._normalizeX(this.xmin, t2);
      const p3 = h2.x, c4 = h2.frameId;
      h2 = this._normalizeX(this.xmax, t2);
      const y3 = h2.x, f5 = h2.frameId, d4 = p3 === y3 && m3 > 0;
      if (m3 > 2 * x5) {
        const t3 = new u3(r3 < a2 ? p3 : y3, e4, x5, s4, n2), m4 = new u3(o3, e4, r3 < a2 ? y3 : p3, s4, n2), h3 = new u3(0, e4, x5, s4, n2), l2 = new u3(o3, e4, 0, s4, n2), d5 = [], z3 = [];
        t3.contains(h3) && d5.push(c4), t3.contains(l2) && z3.push(c4), m4.contains(h3) && d5.push(f5), m4.contains(l2) && z3.push(f5);
        for (let i4 = c4 + 1; i4 < f5; i4++)
          d5.push(i4), z3.push(i4);
        i3.push({ extent: t3, frameIds: [c4] }, { extent: m4, frameIds: [f5] }, { extent: h3, frameIds: d5 }, { extent: l2, frameIds: z3 });
      } else
        p3 > y3 || d4 ? i3.push({ extent: new u3(p3, e4, x5, s4, n2), frameIds: [c4] }, { extent: new u3(o3, e4, y3, s4, n2), frameIds: [f5] }) : i3.push({ extent: new u3(p3, e4, y3, s4, n2), frameIds: [c4] });
...
e([y({ readOnly: true })], z2.prototype, "cache", null), e([y({ readOnly: true })], z2.prototype, "center", null), e([y({ readOnly: true })], z2.prototype, "extent", null), e([y({ readOnly: true, json: { write: { enabled: false, overridePolicy: null } } })], z2.prototype, "hasM", null), e([y({ readOnly: true, json: { write: { enabled: false, overridePolicy: null } } })], z2.prototype, "hasZ", null), e([y({ readOnly: true })], z2.prototype, "height", null), e([y({ readOnly: true })], z2.prototype, "width", null), e([y({ type: Number, json: { type: [Number, String], write: { enabled: true, allowNull: true } } })], z2.prototype, "xmin", void 0), e([y({ type: Number, json: { write: true } })], z2.prototype, "ymin", void 0), e([y({ type: Number, json: { origins: { "web-scene": { write: false } }, write: { overridePolicy() {
  ...
  return { enabled: this.hasZ };
} } } })], z2.prototype, "zmax", void 0), z2 = u3 = e([c("esri.geometry.Extent")], z2), z2.prototype.toJSON.isDefaultToJSON = true;
var M = z2;
...
//# sourceMappingURL=chunk-Y5D433JZ.js.map
