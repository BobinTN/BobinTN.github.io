    ...
    async setupPopup() {
      ...
      if ((_a = this._popupSetupTask) == null ? void 0 : _a.abort(), this.popup && !d8(this.popup))
        return this._popupSetupTask = d2(async (e22) => {
          const { default: p22 } = await import("./Popup-DFZBTJE6.js");
...
async function c12(r24) {
  s12 || (s12 = import("./geometryServiceUtils-J5FRJBIM.js").then((e22) => n18 = e22)), await s12, s3(r24);
}
...
function r13() {
  return Promise.all([import("./webglDeps-5SSGCC46.js"), import("./mapViewDeps-WMQOGTTQ.js")]);
}
var a11 = () => r13().then(() => import("./TileLayerView2D-HBKLJUQZ.js"));
var t12 = () => r13().then(() => import("./FeatureLayerView2D-WPAQMJQQ.js"));
var s13 = { "base-dynamic": () => r13().then(() => import("./BaseDynamicLayerView2D-KZAKXT65.js")), "base-tile": a11, "bing-maps": a11, csv: t12, "geo-rss": () => r13().then(() => import("./GeoRSSLayerView2D-MWIXY5CG.js")), feature: t12, geojson: t12, graphics: () => r13().then(() => import("./GraphicsLayerView2D-BQ6L7AN6.js")), group: () => r13().then(() => import("./GroupLayerView2D-MO4BE2BV.js")), imagery: () => r13().then(() => import("./ImageryLayerView2D-S2KFOQJF.js")), "imagery-tile": () => r13().then(() => import("./ImageryTileLayerView2D-UFZSLQFM.js")), kml: () => r13().then(() => import("./KMLLayerView2D-4NABV4ND.js")), "knowledge-graph": () => r13().then(() => import("./KnowledgeGraphLayerView2D-6FPKWQIL.js")), "link-chart": () => r13().then(() => import("./KnowledgeGraphLayerView2D-6FPKWQIL.js")), "knowledge-graph-sublayer": t12, "map-image": () => r13().then(() => import("./MapImageLayerView2D-Q4F43TZG.js")), "map-notes": () => r13().then(() => import("./MapNotesLayerView2D-WOOU2DWA.js")), media: () => r13().then(() => import("./MediaLayerView2D-7WU4I6MV.js")), "ogc-feature": () => r13().then(() => import("./OGCFeatureLayerView2D-X3XHCVE5.js")), "open-street-map": a11, "oriented-imagery": t12, route: () => r13().then(() => import("./RouteLayerView2D-LVP2PFG5.js")), stream: () => r13().then(() => import("./StreamLayerView2D-QATQVKXC.js")), "subtype-group": () => r13().then(() => import("./SubtypeGroupLayerView2D-7A2PUJDS.js")), tile: a11, "vector-tile": () => r13().then(() => import("./VectorTileLayerView2D-DPLMLZSQ.js")), video: () => r13().then(() => import("./VideoLayerView2D-P7QFJZ3D.js")), wcs: () => r13().then(() => import("./ImageryTileLayerView2D-UFZSLQFM.js")), "web-tile": a11, wfs: t12, wms: () => r13().then(() => import("./WMSLayerView2D-3D6EMNEA.js")), wmts: () => r13().then(() => import("./WMTSLayerView2D-Q3C32DO6.js")), "line-of-sight": null, "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "integrated-mesh": null, "point-cloud": null, voxel: null, scene: null, unknown: null, unsupported: null };
function i18(r24) {
...
var J;
async function K() {
  const [, { GraphicsView2D: e22, GraphicContainer: t22, LabelManager: i23, MapViewNavigation: r24, MagnifierView2D: s19, Stage: a23 }] = await Promise.all([import("./webglDeps-5SSGCC46.js"), import("./mapViewDeps-WMQOGTTQ.js")]);
