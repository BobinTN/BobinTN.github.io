...
var U2 = new y2({ name: "OBJECTID", alias: "OBJECTID", type: "oid", nullable: false, editable: false });
var W = new y2({ name: "title", alias: "Title", type: "string", nullable: true, editable: true, length: 255 });
var A = class extends h {
  ...
  get fullExtent() {
    ...
    return e2 ? null == t2 ? U(z(), e2).geometry : c2(t2, e2) : null;
  }
  get fullBounds() {
    var _a;
    ...
    return this.graphics.forEach((r2) => {
      const o3 = null != r2.geometry ? U(r2.geometry, e2).geometry : null;
...
var $ = [{ geometryType: "polygon", geometryTypeJSON: "esriGeometryPolygon", id: "polygonLayer", layerId: 0, title: "Polygons", identifyingSymbol: new S().toJSON() }, { geometryType: "polyline", geometryTypeJSON: "esriGeometryPolyline", id: "polylineLayer", layerId: 1, title: "Polylines", identifyingSymbol: new m3().toJSON() }, { geometryType: "multipoint", geometryTypeJSON: "esriGeometryMultipoint", id: "multipointLayer", layerId: 2, title: "Multipoints", identifyingSymbol: new y3().toJSON() }, { geometryType: "point", geometryTypeJSON: "esriGeometryPoint", id: "pointLayer", layerId: 3, title: "Points", identifyingSymbol: new y3().toJSON() }, { geometryType: "point", geometryTypeJSON: "esriGeometryPoint", id: "textLayer", layerId: 4, title: "Text", identifyingSymbol: new m4().toJSON() }];
var q = class extends a2(t(u(j(m2(b2))))) {
  constructor(e2) {
  ...
  get fullExtent() {
    ...
    if (null != this.sublayers)
      ...
      this.featureCollectionJSON.layers.forEach((r2) => {
        const o3 = U(r2.layerDefinition.extent, e2).geometry;
        null != o3 && m(t2, o3, t2);
      });
    }
    return I(t2, K) ? U(z(), e2).geometry : c2(t2, e2);
  }
  readMinScale(e2, t2) {
  ...
  readSublayers(e2, o3, i) {
    if (B(o3))
      return null;
    const l = [];
    let n2 = o3.layers.reduce((e3, t2) => Math.max(e3, t2.layerDefinition.id ?? -1), -1) + 1;
    for (const r2 of o3.layers) {
      const { layerDefinition: e3, featureSet: o4 } = r2, i2 = e3.id ?? n2++, a3 = k(r2);
      if (null != a3) {
        const r3 = new A({ id: a3.id, title: e3.name, layerId: i2, layer: this, graphics: o4.features.map(({ geometry: e4, symbol: r4, attributes: o5, popupInfo: i3 }) => c3.fromJSON({ attributes: o5, geometry: e4, symbol: r4, popupTemplate: i3 })) });
        l.push(r3);
      }
    }
    return new V(l);
  ...
  writeSublayers(e2, t2, r2, i) {
    var _a;
    const { minScale: l, maxScale: a3 } = this;
    if (null == e2)
      return;
    ...
    for (const o3 of $) {
      ...
      this._writeMapNoteSublayer(p, t3, o3, l, a3, y4, i);
    }
    ...
    for (const o3 of this.sublayers)
      for (const r3 of o3.graphics)
        if (null != r3.geometry) {
          ...
          e2 ? d(o4.spatialReference, e2) || (D2(o4.spatialReference, e2) || E() || await _(), r3.geometry = b(o4, e2)) : e2 = o4.spatialReference, t2.push(r3);
        }
  ...
  _writeMapNoteSublayer(e2, t2, r2, o3, l, n2, a3) {
    const s3 = [];
    if (null != t2) {
      for (const e3 of t2.graphics)
        this._writeMapNote(s3, e3, r2.geometryType, a3);
      this._normalizeObjectIds(s3, U2), e2.push({ layerDefinition: { name: t2.title, drawingInfo: { renderer: { type: "simple", symbol: a(r2.identifyingSymbol) } }, id: t2.layerId, geometryType: r2.geometryTypeJSON, minScale: o3, maxScale: l, objectIdField: "OBJECTID", fields: [U2.toJSON(), W.toJSON()], spatialReference: n2 }, featureSet: { features: s3, geometryType: r2.geometryTypeJSON } });
    }
  }
  _writeMapNote(e2, t2, r2, o3) {
    ...
    null != n2 && (s3.popupInfo = n2.toJSON()), e2.push(s3);
  }
