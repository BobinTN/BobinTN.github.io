...
import {
  debounce
} from "./chunk-WLO3BTIW.js";
import "./chunk-7WQ3K36N.js";
import {
  defineCustomElement as defineCustomElement3
} from "./chunk-5FNHRUND.js";
import "./chunk-SXSF2NBV.js";
import {
...
var ActionBar = proxyCustomElement(class extends H {
  ...
  renderBottomActionGroup() {
    ...
    return h("calcite-action-group", { class: CSS.actionGroupEnd, hidden: this.expandDisabled && !(this.hasActionsEnd || this.hasBottomActions), label: actionsEndGroupLabel, layout, scale }, h("slot", { name: SLOTS3.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }), h("slot", { name: SLOTS3.bottomActions, onSlotchange: this.handleBottomActionsSlotChange }), h("slot", { name: SLOTS3.expandTooltip, onSlotchange: this.handleTooltipSlotChange }), expandToggleNode);
  }
  render() {
...
@esri/calcite-components/dist/components/calcite-action-bar.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-action-bar-QNECQ5JB.js.map
