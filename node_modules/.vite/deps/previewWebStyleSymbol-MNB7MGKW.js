...
function h(e, i, h2) {
  ...
  return s ? j(s, { responseType: "image" }).then((t2) => {
    ...
    return (h2 == null ? void 0 : h2.node) ? (h2.node.appendChild(e2), h2.node) : e2;
  }) : N(e).then((t2) => t2 ? i(t2, h2) : null);
}
function r(t2, n) {
  const h2 = !/\\.svg$/i.test(t2.src) && n && n.disableUpsampling, r2 = Math.max(t2.width, t2.height);
  let s = null != (n == null ? void 0 : n.maxSize) ? u(n.maxSize) : t.maxSize;
  h2 && (s = Math.min(r2, s));
...
//# sourceMappingURL=previewWebStyleSymbol-MNB7MGKW.js.map
