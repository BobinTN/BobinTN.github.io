...
function t(t2) {
  ...
  let i2 = true, f = true;
  return t2.some((r, n) => (i2 = i2 && 0 === r, f = f && r === n, !i2 && !f)), i2 ? A(t2.length) : f ? l(t2.length) : y(t2) || t2.BYTES_PER_ELEMENT !== Uint16Array.BYTES_PER_ELEMENT ? e(t2) : t2;
}
function e(n) {
  let t2 = true;
  for (const e2 of n) {
...
//# sourceMappingURL=chunk-VHDTZ7JB.js.map
