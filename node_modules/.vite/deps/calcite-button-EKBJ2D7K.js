...
var allowedGlobalAttributes = ["lang", "role", "aria-expanded"];
var elementToComponentAndObserverOptionsMap = /* @__PURE__ */ new Map();
...
function updateGlobalAttributes(component, attributeFilter, reuseAttributes = false) {
  ...
  attributeFilter.filter((attr) => !!allowedGlobalAttributes.includes(attr) && !!el.hasAttribute(attr)).forEach((attr) => {
...
var defineCustomElement4 = defineCustomElement3;
export {
  CalciteButton,
...
@esri/calcite-components/dist/components/globalAttributes.js:
  (*!
...
@esri/calcite-components/dist/components/calcite-button.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-button-EKBJ2D7K.js.map
