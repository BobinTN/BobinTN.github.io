...
async function O(e3) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-FOCXSJXY.js"), o = await t(e3, 10), { width: n2, height: r, depth: l4 } = e3, i2 = [n2, l4, r];
  let c2 = 1;
  for (let s = 0; s < 3; s++) {
    const e4 = i2[s];
    if (null != e4) {
...
//# sourceMappingURL=chunk-6JCSK7BN.js.map
